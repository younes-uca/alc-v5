...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/actuator/info").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/teacher/").hasAnyAuthority(AuthoritiesConstants.TEACHER);
            http.authorizeRequests().antMatchers("/api/student/").hasAnyAuthority(AuthoritiesConstants.STUDENT);
