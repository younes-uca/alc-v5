...
public class HomeWorkRestStudent  extends AbstractController<HomeWork, HomeWorkDto, HomeWorkHistory, HomeWorkCriteria, HomeWorkHistoryCriteria, HomeWorkStudentService, HomeWorkConverter> {
    ...
    public HomeWorkRestStudent (HomeWorkStudentService service, HomeWorkConverter converter) {
