...
@RestController
@RequestMapping("/api/student/faq/")
public class FaqRestStudent  extends AbstractController<Faq, FaqDto, FaqHistory, FaqCriteria, FaqHistoryCriteria, FaqStudentService, FaqConverter> {
    ...
    public FaqRestStudent (FaqStudentService service, FaqConverter converter) {
