...
@RestController
@RequestMapping("/api/student/etatCours/")
public class EtatCoursRestStudent  extends AbstractController<EtatCours, EtatCoursDto, EtatCoursHistory, EtatCoursCriteria, EtatCoursHistoryCriteria, EtatCoursStudentService, EtatCoursConverter> {
    ...
    public EtatCoursRestStudent (EtatCoursStudentService service, EtatCoursConverter converter) {
