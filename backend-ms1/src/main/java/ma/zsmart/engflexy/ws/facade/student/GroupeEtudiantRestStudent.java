...
@RestController
@RequestMapping("/api/student/groupeEtudiant/")
public class GroupeEtudiantRestStudent  extends AbstractController<GroupeEtudiant, GroupeEtudiantDto, GroupeEtudiantHistory, GroupeEtudiantCriteria, GroupeEtudiantHistoryCriteria, GroupeEtudiantStudentService, GroupeEtudiantConverter> {
    ...
    public GroupeEtudiantRestStudent (GroupeEtudiantStudentService service, GroupeEtudiantConverter converter) {
