...
@RestController
@RequestMapping("/api/student/typeHomeWork/")
public class TypeHomeWorkRestStudent  extends AbstractController<TypeHomeWork, TypeHomeWorkDto, TypeHomeWorkHistory, TypeHomeWorkCriteria, TypeHomeWorkHistoryCriteria, TypeHomeWorkStudentService, TypeHomeWorkConverter> {
    ...
    public TypeHomeWorkRestStudent (TypeHomeWorkStudentService service, TypeHomeWorkConverter converter) {
