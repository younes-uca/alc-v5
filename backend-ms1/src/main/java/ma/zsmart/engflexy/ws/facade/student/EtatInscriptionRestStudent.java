...
@RestController
@RequestMapping("/api/student/etatInscription/")
public class EtatInscriptionRestStudent  extends AbstractController<EtatInscription, EtatInscriptionDto, EtatInscriptionHistory, EtatInscriptionCriteria, EtatInscriptionHistoryCriteria, EtatInscriptionStudentService, EtatInscriptionConverter> {
    ...
    public EtatInscriptionRestStudent (EtatInscriptionStudentService service, EtatInscriptionConverter converter) {
