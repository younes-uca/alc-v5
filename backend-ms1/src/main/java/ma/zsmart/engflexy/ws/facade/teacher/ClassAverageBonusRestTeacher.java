...
@RestController
@RequestMapping("/api/teacher/classAverageBonus/")
public class ClassAverageBonusRestTeacher  extends AbstractController<ClassAverageBonus, ClassAverageBonusDto, ClassAverageBonusHistory, ClassAverageBonusCriteria, ClassAverageBonusHistoryCriteria, ClassAverageBonusTeacherService, ClassAverageBonusConverter> {
    ...
    public ClassAverageBonusRestTeacher (ClassAverageBonusTeacherService service, ClassAverageBonusConverter converter) {
