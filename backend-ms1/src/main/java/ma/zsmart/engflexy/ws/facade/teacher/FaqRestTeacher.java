...
@RestController
@RequestMapping("/api/teacher/faq/")
public class FaqRestTeacher  extends AbstractController<Faq, FaqDto, FaqHistory, FaqCriteria, FaqHistoryCriteria, FaqTeacherService, FaqConverter> {
    ...
    public FaqRestTeacher (FaqTeacherService service, FaqConverter converter) {
