...
import ma.zsmart.engflexy.service.facade.student.EtudiantReviewStudentService;
...
@RestController
@RequestMapping("/api/student/etudiantReview/")
public class EtudiantReviewRestStudent  extends AbstractController<EtudiantReview, EtudiantReviewDto, EtudiantReviewHistory, EtudiantReviewCriteria, EtudiantReviewHistoryCriteria, EtudiantReviewStudentService, EtudiantReviewConverter> {
    ...
    public EtudiantReviewRestStudent (EtudiantReviewStudentService service, EtudiantReviewConverter converter) {
