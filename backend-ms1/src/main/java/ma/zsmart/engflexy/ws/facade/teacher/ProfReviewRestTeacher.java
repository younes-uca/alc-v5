...
@RestController
@RequestMapping("/api/teacher/profReview/")
public class ProfReviewRestTeacher  extends AbstractController<ProfReview, ProfReviewDto, ProfReviewHistory, ProfReviewCriteria, ProfReviewHistoryCriteria, ProfReviewTeacherService, ProfReviewConverter> {
    ...
    public ProfReviewRestTeacher (ProfReviewTeacherService service, ProfReviewConverter converter) {
