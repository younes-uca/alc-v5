...
import ma.zsmart.engflexy.service.facade.student.CategorieSectionStudentService;
...
@RestController
@RequestMapping("/api/student/categorieSection/")
public class CategorieSectionRestStudent  extends AbstractController<CategorieSection, CategorieSectionDto, CategorieSectionHistory, CategorieSectionCriteria, CategorieSectionHistoryCriteria, CategorieSectionStudentService, CategorieSectionConverter> {
    ...
    public CategorieSectionRestStudent (CategorieSectionStudentService service, CategorieSectionConverter converter) {
