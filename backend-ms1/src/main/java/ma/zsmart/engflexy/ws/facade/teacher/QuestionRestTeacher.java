...
public class QuestionRestTeacher  extends AbstractController<Question, QuestionDto, QuestionHistory, QuestionCriteria, QuestionHistoryCriteria, QuestionTeacherService, QuestionConverter> {
    ...
    public QuestionRestTeacher (QuestionTeacherService service, QuestionConverter converter) {
