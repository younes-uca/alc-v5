...
@RestController
@RequestMapping("/api/student/freeTrial/")
public class FreeTrialRestStudent  extends AbstractController<FreeTrial, FreeTrialDto, FreeTrialHistory, FreeTrialCriteria, FreeTrialHistoryCriteria, FreeTrialStudentService, FreeTrialConverter> {
    ...
    public FreeTrialRestStudent (FreeTrialStudentService service, FreeTrialConverter converter) {
