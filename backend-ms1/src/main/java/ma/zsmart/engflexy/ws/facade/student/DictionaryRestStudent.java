...
public class DictionaryRestStudent  extends AbstractController<Dictionary, DictionaryDto, DictionaryHistory, DictionaryCriteria, DictionaryHistoryCriteria, DictionaryStudentService, DictionaryConverter> {
    ...
    public DictionaryRestStudent (DictionaryStudentService service, DictionaryConverter converter) {
