...
@RestController
@RequestMapping("/api/student/faqType/")
public class FaqTypeRestStudent  extends AbstractController<FaqType, FaqTypeDto, FaqTypeHistory, FaqTypeCriteria, FaqTypeHistoryCriteria, FaqTypeStudentService, FaqTypeConverter> {
    ...
    public FaqTypeRestStudent (FaqTypeStudentService service, FaqTypeConverter converter) {
