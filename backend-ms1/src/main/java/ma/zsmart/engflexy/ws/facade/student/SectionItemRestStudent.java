...
@RestController
@RequestMapping("/api/student/sectionItem/")
public class SectionItemRestStudent  extends AbstractController<SectionItem, SectionItemDto, SectionItemHistory, SectionItemCriteria, SectionItemHistoryCriteria, SectionItemStudentService, SectionItemConverter> {
    ...
    public SectionItemRestStudent (SectionItemStudentService service, SectionItemConverter converter) {
