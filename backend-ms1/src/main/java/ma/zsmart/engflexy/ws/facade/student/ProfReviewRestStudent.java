...
@RestController
@RequestMapping("/api/student/profReview/")
public class ProfReviewRestStudent  extends AbstractController<ProfReview, ProfReviewDto, ProfReviewHistory, ProfReviewCriteria, ProfReviewHistoryCriteria, ProfReviewStudentService, ProfReviewConverter> {
    ...
    public ProfReviewRestStudent (ProfReviewStudentService service, ProfReviewConverter converter) {
