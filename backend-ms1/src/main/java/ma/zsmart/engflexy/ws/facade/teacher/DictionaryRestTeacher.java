...
import ma.zsmart.engflexy.service.facade.teacher.DictionaryTeacherService;
...
@RestController
@RequestMapping("/api/teacher/dictionary/")
public class DictionaryRestTeacher  extends AbstractController<Dictionary, DictionaryDto, DictionaryHistory, DictionaryCriteria, DictionaryHistoryCriteria, DictionaryTeacherService, DictionaryConverter> {
    ...
    public DictionaryRestTeacher (DictionaryTeacherService service, DictionaryConverter converter) {
