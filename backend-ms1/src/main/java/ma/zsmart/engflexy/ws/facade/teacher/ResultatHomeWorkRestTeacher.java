...
@RestController
@RequestMapping("/api/teacher/resultatHomeWork/")
public class ResultatHomeWorkRestTeacher  extends AbstractController<ResultatHomeWork, ResultatHomeWorkDto, ResultatHomeWorkHistory, ResultatHomeWorkCriteria, ResultatHomeWorkHistoryCriteria, ResultatHomeWorkTeacherService, ResultatHomeWorkConverter> {
    ...
    public ResultatHomeWorkRestTeacher (ResultatHomeWorkTeacherService service, ResultatHomeWorkConverter converter) {
