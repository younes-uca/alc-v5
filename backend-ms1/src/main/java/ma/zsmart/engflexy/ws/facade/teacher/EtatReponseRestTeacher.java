...
@RestController
@RequestMapping("/api/teacher/etatReponse/")
public class EtatReponseRestTeacher  extends AbstractController<EtatReponse, EtatReponseDto, EtatReponseHistory, EtatReponseCriteria, EtatReponseHistoryCriteria, EtatReponseTeacherService, EtatReponseConverter> {
    ...
    public EtatReponseRestTeacher (EtatReponseTeacherService service, EtatReponseConverter converter) {
