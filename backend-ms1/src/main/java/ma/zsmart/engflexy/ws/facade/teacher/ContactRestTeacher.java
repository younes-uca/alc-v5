...
@RestController
@RequestMapping("/api/teacher/contact/")
public class ContactRestTeacher  extends AbstractController<Contact, ContactDto, ContactHistory, ContactCriteria, ContactHistoryCriteria, ContactTeacherService, ContactConverter> {
    ...
    public ContactRestTeacher (ContactTeacherService service, ContactConverter converter) {
