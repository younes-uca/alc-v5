...
@RestController
@RequestMapping("/api/teacher/trancheHoraireProf/")
public class TrancheHoraireProfRestTeacher  extends AbstractController<TrancheHoraireProf, TrancheHoraireProfDto, TrancheHoraireProfHistory, TrancheHoraireProfCriteria, TrancheHoraireProfHistoryCriteria, TrancheHoraireProfTeacherService, TrancheHoraireProfConverter> {
    ...
    public TrancheHoraireProfRestTeacher (TrancheHoraireProfTeacherService service, TrancheHoraireProfConverter converter) {
