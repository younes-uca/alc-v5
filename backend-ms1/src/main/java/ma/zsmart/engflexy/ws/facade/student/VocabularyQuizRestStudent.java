...
@RestController
@RequestMapping("/api/student/vocabularyQuiz/")
public class VocabularyQuizRestStudent  extends AbstractController<VocabularyQuiz, VocabularyQuizDto, VocabularyQuizHistory, VocabularyQuizCriteria, VocabularyQuizHistoryCriteria, VocabularyQuizStudentService, VocabularyQuizConverter> {
    ...
    public VocabularyQuizRestStudent (VocabularyQuizStudentService service, VocabularyQuizConverter converter) {
