...
public class NewsRestStudent  extends AbstractController<News, NewsDto, NewsHistory, NewsCriteria, NewsHistoryCriteria, NewsStudentService, NewsConverter> {
    ...
    public NewsRestStudent (NewsStudentService service, NewsConverter converter) {
