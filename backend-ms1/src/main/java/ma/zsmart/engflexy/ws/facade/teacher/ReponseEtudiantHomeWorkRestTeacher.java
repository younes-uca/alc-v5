...
@RestController
@RequestMapping("/api/teacher/reponseEtudiantHomeWork/")
public class ReponseEtudiantHomeWorkRestTeacher  extends AbstractController<ReponseEtudiantHomeWork, ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkHistory, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkHistoryCriteria, ReponseEtudiantHomeWorkTeacherService, ReponseEtudiantHomeWorkConverter> {
    ...
    public ReponseEtudiantHomeWorkRestTeacher (ReponseEtudiantHomeWorkTeacherService service, ReponseEtudiantHomeWorkConverter converter) {
