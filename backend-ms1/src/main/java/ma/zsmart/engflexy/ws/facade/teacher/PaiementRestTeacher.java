...
import ma.zsmart.engflexy.service.facade.teacher.PaiementTeacherService;
...
@RestController
@RequestMapping("/api/teacher/paiement/")
public class PaiementRestTeacher  extends AbstractController<Paiement, PaiementDto, PaiementHistory, PaiementCriteria, PaiementHistoryCriteria, PaiementTeacherService, PaiementConverter> {
    ...
    public PaiementRestTeacher (PaiementTeacherService service, PaiementConverter converter) {
