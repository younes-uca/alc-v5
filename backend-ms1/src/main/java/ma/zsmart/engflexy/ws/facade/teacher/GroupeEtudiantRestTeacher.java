...
@RestController
@RequestMapping("/api/teacher/groupeEtudiant/")
public class GroupeEtudiantRestTeacher  extends AbstractController<GroupeEtudiant, GroupeEtudiantDto, GroupeEtudiantHistory, GroupeEtudiantCriteria, GroupeEtudiantHistoryCriteria, GroupeEtudiantTeacherService, GroupeEtudiantConverter> {
    ...
    public GroupeEtudiantRestTeacher (GroupeEtudiantTeacherService service, GroupeEtudiantConverter converter) {
