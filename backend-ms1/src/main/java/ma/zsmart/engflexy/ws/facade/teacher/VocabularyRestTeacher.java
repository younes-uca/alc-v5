...
public class VocabularyRestTeacher  extends AbstractController<Vocabulary, VocabularyDto, VocabularyHistory, VocabularyCriteria, VocabularyHistoryCriteria, VocabularyTeacherService, VocabularyConverter> {
    ...
    public VocabularyRestTeacher (VocabularyTeacherService service, VocabularyConverter converter) {
