...
@RestController
@RequestMapping("/api/student/quizEtudiant/")
public class QuizEtudiantRestStudent  extends AbstractController<QuizEtudiant, QuizEtudiantDto, QuizEtudiantHistory, QuizEtudiantCriteria, QuizEtudiantHistoryCriteria, QuizEtudiantStudentService, QuizEtudiantConverter> {
    ...
    public QuizEtudiantRestStudent (QuizEtudiantStudentService service, QuizEtudiantConverter converter) {
