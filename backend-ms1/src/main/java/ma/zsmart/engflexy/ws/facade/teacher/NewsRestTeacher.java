...
@RestController
@RequestMapping("/api/teacher/news/")
public class NewsRestTeacher  extends AbstractController<News, NewsDto, NewsHistory, NewsCriteria, NewsHistoryCriteria, NewsTeacherService, NewsConverter> {
    ...
    public NewsRestTeacher (NewsTeacherService service, NewsConverter converter) {
