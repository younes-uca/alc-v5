...
@RestController
@RequestMapping("/api/teacher/quizEtudiant/")
public class QuizEtudiantRestTeacher  extends AbstractController<QuizEtudiant, QuizEtudiantDto, QuizEtudiantHistory, QuizEtudiantCriteria, QuizEtudiantHistoryCriteria, QuizEtudiantTeacherService, QuizEtudiantConverter> {
    ...
    public QuizEtudiantRestTeacher (QuizEtudiantTeacherService service, QuizEtudiantConverter converter) {
