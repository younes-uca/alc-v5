...
@RestController
@RequestMapping("/api/teacher/etudiantReview/")
public class EtudiantReviewRestTeacher  extends AbstractController<EtudiantReview, EtudiantReviewDto, EtudiantReviewHistory, EtudiantReviewCriteria, EtudiantReviewHistoryCriteria, EtudiantReviewTeacherService, EtudiantReviewConverter> {
    ...
    public EtudiantReviewRestTeacher (EtudiantReviewTeacherService service, EtudiantReviewConverter converter) {
