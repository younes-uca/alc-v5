...
@RestController
@RequestMapping("/api/teacher/scheduleProf/")
public class ScheduleProfRestTeacher  extends AbstractController<ScheduleProf, ScheduleProfDto, ScheduleProfHistory, ScheduleProfCriteria, ScheduleProfHistoryCriteria, ScheduleProfTeacherService, ScheduleProfConverter> {
    ...
    public ScheduleProfRestTeacher (ScheduleProfTeacherService service, ScheduleProfConverter converter) {
