...
@RestController
@RequestMapping("/api/student/reponseEtudiant/")
public class ReponseEtudiantRestStudent  extends AbstractController<ReponseEtudiant, ReponseEtudiantDto, ReponseEtudiantHistory, ReponseEtudiantCriteria, ReponseEtudiantHistoryCriteria, ReponseEtudiantStudentService, ReponseEtudiantConverter> {
    ...
    public ReponseEtudiantRestStudent (ReponseEtudiantStudentService service, ReponseEtudiantConverter converter) {
