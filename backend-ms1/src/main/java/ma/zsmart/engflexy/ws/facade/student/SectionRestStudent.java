...
public class SectionRestStudent  extends AbstractController<Section, SectionDto, SectionHistory, SectionCriteria, SectionHistoryCriteria, SectionStudentService, SectionConverter> {
    ...
    public SectionRestStudent (SectionStudentService service, SectionConverter converter) {
