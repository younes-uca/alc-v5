...
@RestController
@RequestMapping("/api/student/typeReclamationEtudiant/")
public class TypeReclamationEtudiantRestStudent  extends AbstractController<TypeReclamationEtudiant, TypeReclamationEtudiantDto, TypeReclamationEtudiantHistory, TypeReclamationEtudiantCriteria, TypeReclamationEtudiantHistoryCriteria, TypeReclamationEtudiantStudentService, TypeReclamationEtudiantConverter> {
    ...
    public TypeReclamationEtudiantRestStudent (TypeReclamationEtudiantStudentService service, TypeReclamationEtudiantConverter converter) {
