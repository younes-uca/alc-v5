...
@RestController
@RequestMapping("/api/teacher/classAverageBonusProf/")
public class ClassAverageBonusProfRestTeacher  extends AbstractController<ClassAverageBonusProf, ClassAverageBonusProfDto, ClassAverageBonusProfHistory, ClassAverageBonusProfCriteria, ClassAverageBonusProfHistoryCriteria, ClassAverageBonusProfTeacherService, ClassAverageBonusProfConverter> {
    ...
    public ClassAverageBonusProfRestTeacher (ClassAverageBonusProfTeacherService service, ClassAverageBonusProfConverter converter) {
