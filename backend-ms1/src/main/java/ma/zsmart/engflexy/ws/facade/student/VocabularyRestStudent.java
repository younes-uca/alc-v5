...
public class VocabularyRestStudent  extends AbstractController<Vocabulary, VocabularyDto, VocabularyHistory, VocabularyCriteria, VocabularyHistoryCriteria, VocabularyStudentService, VocabularyConverter> {
    ...
    public VocabularyRestStudent (VocabularyStudentService service, VocabularyConverter converter) {
