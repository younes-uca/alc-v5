...
@RestController
@RequestMapping("/api/teacher/homeWorkQuestion/")
public class HomeWorkQuestionRestTeacher  extends AbstractController<HomeWorkQuestion, HomeWorkQuestionDto, HomeWorkQuestionHistory, HomeWorkQuestionCriteria, HomeWorkQuestionHistoryCriteria, HomeWorkQuestionTeacherService, HomeWorkQuestionConverter> {
    ...
    public HomeWorkQuestionRestTeacher (HomeWorkQuestionTeacherService service, HomeWorkQuestionConverter converter) {
