...
@RestController
@RequestMapping("/api/student/inscription/")
public class InscriptionRestStudent  extends AbstractController<Inscription, InscriptionDto, InscriptionHistory, InscriptionCriteria, InscriptionHistoryCriteria, InscriptionStudentService, InscriptionConverter> {
    ...
    public InscriptionRestStudent (InscriptionStudentService service, InscriptionConverter converter) {
