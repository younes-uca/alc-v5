...
@RestController
@RequestMapping("/api/teacher/homeWorkEtudiant/")
public class HomeWorkEtudiantRestTeacher  extends AbstractController<HomeWorkEtudiant, HomeWorkEtudiantDto, HomeWorkEtudiantHistory, HomeWorkEtudiantCriteria, HomeWorkEtudiantHistoryCriteria, HomeWorkEtudiantTeacherService, HomeWorkEtudiantConverter> {
    ...
    public HomeWorkEtudiantRestTeacher (HomeWorkEtudiantTeacherService service, HomeWorkEtudiantConverter converter) {
