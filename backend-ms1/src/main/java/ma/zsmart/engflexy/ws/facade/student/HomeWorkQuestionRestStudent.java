...
@RestController
@RequestMapping("/api/student/homeWorkQuestion/")
public class HomeWorkQuestionRestStudent  extends AbstractController<HomeWorkQuestion, HomeWorkQuestionDto, HomeWorkQuestionHistory, HomeWorkQuestionCriteria, HomeWorkQuestionHistoryCriteria, HomeWorkQuestionStudentService, HomeWorkQuestionConverter> {
    ...
    public HomeWorkQuestionRestStudent (HomeWorkQuestionStudentService service, HomeWorkQuestionConverter converter) {
