...
@RestController
@RequestMapping("/api/student/cours/")
public class CoursRestStudent  extends AbstractController<Cours, CoursDto, CoursHistory, CoursCriteria, CoursHistoryCriteria, CoursStudentService, CoursConverter> {
    ...
    public CoursRestStudent (CoursStudentService service, CoursConverter converter) {
