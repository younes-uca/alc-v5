...
@RestController
@RequestMapping("/api/teacher/categorieSection/")
public class CategorieSectionRestTeacher  extends AbstractController<CategorieSection, CategorieSectionDto, CategorieSectionHistory, CategorieSectionCriteria, CategorieSectionHistoryCriteria, CategorieSectionTeacherService, CategorieSectionConverter> {
    ...
    public CategorieSectionRestTeacher (CategorieSectionTeacherService service, CategorieSectionConverter converter) {
