...
@RestController
@RequestMapping("/api/teacher/sessionCours/")
public class SessionCoursRestTeacher  extends AbstractController<SessionCours, SessionCoursDto, SessionCoursHistory, SessionCoursCriteria, SessionCoursHistoryCriteria, SessionCoursTeacherService, SessionCoursConverter> {
    ...
    public SessionCoursRestTeacher (SessionCoursTeacherService service, SessionCoursConverter converter) {
