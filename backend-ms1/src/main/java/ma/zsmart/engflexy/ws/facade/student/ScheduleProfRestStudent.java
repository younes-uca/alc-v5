...
@RestController
@RequestMapping("/api/student/scheduleProf/")
public class ScheduleProfRestStudent  extends AbstractController<ScheduleProf, ScheduleProfDto, ScheduleProfHistory, ScheduleProfCriteria, ScheduleProfHistoryCriteria, ScheduleProfStudentService, ScheduleProfConverter> {
    ...
    public ScheduleProfRestStudent (ScheduleProfStudentService service, ScheduleProfConverter converter) {
