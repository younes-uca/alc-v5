...
@RestController
@RequestMapping("/api/student/reponseEtudiantHomeWork/")
public class ReponseEtudiantHomeWorkRestStudent  extends AbstractController<ReponseEtudiantHomeWork, ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkHistory, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkHistoryCriteria, ReponseEtudiantHomeWorkStudentService, ReponseEtudiantHomeWorkConverter> {
    ...
    public ReponseEtudiantHomeWorkRestStudent (ReponseEtudiantHomeWorkStudentService service, ReponseEtudiantHomeWorkConverter converter) {
