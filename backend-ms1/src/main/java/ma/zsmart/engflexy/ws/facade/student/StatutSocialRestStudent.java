...
@RestController
@RequestMapping("/api/student/statutSocial/")
public class StatutSocialRestStudent  extends AbstractController<StatutSocial, StatutSocialDto, StatutSocialHistory, StatutSocialCriteria, StatutSocialHistoryCriteria, StatutSocialStudentService, StatutSocialConverter> {
    ...
    public StatutSocialRestStudent (StatutSocialStudentService service, StatutSocialConverter converter) {
