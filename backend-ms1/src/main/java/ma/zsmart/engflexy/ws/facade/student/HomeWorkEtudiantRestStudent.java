...
@RestController
@RequestMapping("/api/student/homeWorkEtudiant/")
public class HomeWorkEtudiantRestStudent  extends AbstractController<HomeWorkEtudiant, HomeWorkEtudiantDto, HomeWorkEtudiantHistory, HomeWorkEtudiantCriteria, HomeWorkEtudiantHistoryCriteria, HomeWorkEtudiantStudentService, HomeWorkEtudiantConverter> {
    ...
    public HomeWorkEtudiantRestStudent (HomeWorkEtudiantStudentService service, HomeWorkEtudiantConverter converter) {
