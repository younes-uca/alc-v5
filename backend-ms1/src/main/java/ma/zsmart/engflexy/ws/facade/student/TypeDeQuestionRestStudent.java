...
@RestController
@RequestMapping("/api/student/typeDeQuestion/")
public class TypeDeQuestionRestStudent  extends AbstractController<TypeDeQuestion, TypeDeQuestionDto, TypeDeQuestionHistory, TypeDeQuestionCriteria, TypeDeQuestionHistoryCriteria, TypeDeQuestionStudentService, TypeDeQuestionConverter> {
    ...
    public TypeDeQuestionRestStudent (TypeDeQuestionStudentService service, TypeDeQuestionConverter converter) {
