...
public class SalaryRestTeacher  extends AbstractController<Salary, SalaryDto, SalaryHistory, SalaryCriteria, SalaryHistoryCriteria, SalaryTeacherService, SalaryConverter> {
    ...
    public SalaryRestTeacher (SalaryTeacherService service, SalaryConverter converter) {
