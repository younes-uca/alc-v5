...
import ma.zsmart.engflexy.service.facade.student.ContactStudentService;
...
@RestController
@RequestMapping("/api/student/contact/")
public class ContactRestStudent  extends AbstractController<Contact, ContactDto, ContactHistory, ContactCriteria, ContactHistoryCriteria, ContactStudentService, ContactConverter> {
    ...
    public ContactRestStudent (ContactStudentService service, ContactConverter converter) {
