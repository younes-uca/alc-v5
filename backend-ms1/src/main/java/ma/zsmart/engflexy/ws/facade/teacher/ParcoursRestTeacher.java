...
@RestController
@RequestMapping("/api/teacher/parcours/")
public class ParcoursRestTeacher  extends AbstractController<Parcours, ParcoursDto, ParcoursHistory, ParcoursCriteria, ParcoursHistoryCriteria, ParcoursTeacherService, ParcoursConverter> {
    ...
    public ParcoursRestTeacher (ParcoursTeacherService service, ParcoursConverter converter) {
