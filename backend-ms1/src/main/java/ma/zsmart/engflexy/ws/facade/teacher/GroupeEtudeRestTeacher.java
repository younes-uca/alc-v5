...
@RestController
@RequestMapping("/api/teacher/groupeEtude/")
public class GroupeEtudeRestTeacher  extends AbstractController<GroupeEtude, GroupeEtudeDto, GroupeEtudeHistory, GroupeEtudeCriteria, GroupeEtudeHistoryCriteria, GroupeEtudeTeacherService, GroupeEtudeConverter> {
    ...
    public GroupeEtudeRestTeacher (GroupeEtudeTeacherService service, GroupeEtudeConverter converter) {
