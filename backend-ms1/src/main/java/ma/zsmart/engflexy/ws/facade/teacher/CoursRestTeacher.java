...
public class CoursRestTeacher  extends AbstractController<Cours, CoursDto, CoursHistory, CoursCriteria, CoursHistoryCriteria, CoursTeacherService, CoursConverter> {
    ...
    public CoursRestTeacher (CoursTeacherService service, CoursConverter converter) {
