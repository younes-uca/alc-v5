...
public class QuizRestStudent  extends AbstractController<Quiz, QuizDto, QuizHistory, QuizCriteria, QuizHistoryCriteria, QuizStudentService, QuizConverter> {
    ...
    public QuizRestStudent (QuizStudentService service, QuizConverter converter) {
