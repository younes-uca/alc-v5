...
@RestController
@RequestMapping("/api/teacher/vocabularyQuiz/")
public class VocabularyQuizRestTeacher  extends AbstractController<VocabularyQuiz, VocabularyQuizDto, VocabularyQuizHistory, VocabularyQuizCriteria, VocabularyQuizHistoryCriteria, VocabularyQuizTeacherService, VocabularyQuizConverter> {
    ...
    public VocabularyQuizRestTeacher (VocabularyQuizTeacherService service, VocabularyQuizConverter converter) {
