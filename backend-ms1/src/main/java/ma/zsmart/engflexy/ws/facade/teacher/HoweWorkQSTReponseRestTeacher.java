...
@RestController
@RequestMapping("/api/teacher/howeWorkQSTReponse/")
public class HoweWorkQSTReponseRestTeacher  extends AbstractController<HoweWorkQSTReponse, HoweWorkQSTReponseDto, HoweWorkQSTReponseHistory, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseHistoryCriteria, HoweWorkQSTReponseTeacherService, HoweWorkQSTReponseConverter> {
    ...
    public HoweWorkQSTReponseRestTeacher (HoweWorkQSTReponseTeacherService service, HoweWorkQSTReponseConverter converter) {
