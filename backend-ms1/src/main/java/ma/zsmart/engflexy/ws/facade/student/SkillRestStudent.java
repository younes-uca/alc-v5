...
@RestController
@RequestMapping("/api/student/skill/")
public class SkillRestStudent  extends AbstractController<Skill, SkillDto, SkillHistory, SkillCriteria, SkillHistoryCriteria, SkillStudentService, SkillConverter> {
    ...
    public SkillRestStudent (SkillStudentService service, SkillConverter converter) {
