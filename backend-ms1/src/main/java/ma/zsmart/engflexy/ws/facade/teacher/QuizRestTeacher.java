...
public class QuizRestTeacher  extends AbstractController<Quiz, QuizDto, QuizHistory, QuizCriteria, QuizHistoryCriteria, QuizTeacherService, QuizConverter> {
    ...
    public QuizRestTeacher (QuizTeacherService service, QuizConverter converter) {
