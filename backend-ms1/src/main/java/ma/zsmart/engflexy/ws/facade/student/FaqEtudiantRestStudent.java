...
@RestController
@RequestMapping("/api/student/faqEtudiant/")
public class FaqEtudiantRestStudent  extends AbstractController<FaqEtudiant, FaqEtudiantDto, FaqEtudiantHistory, FaqEtudiantCriteria, FaqEtudiantHistoryCriteria, FaqEtudiantStudentService, FaqEtudiantConverter> {
    ...
    public FaqEtudiantRestStudent (FaqEtudiantStudentService service, FaqEtudiantConverter converter) {
