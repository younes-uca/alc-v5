...
import java.util.List;
@Service
public class TypeDeQuestionTeacherServiceImpl extends AbstractServiceImpl<TypeDeQuestion,TypeDeQuestionHistory, TypeDeQuestionCriteria, TypeDeQuestionHistoryCriteria, TypeDeQuestionDao,
TypeDeQuestionHistoryDao> implements TypeDeQuestionTeacherService {
    ...
    public TypeDeQuestionTeacherServiceImpl(TypeDeQuestionDao dao, TypeDeQuestionHistoryDao historyDao) {
