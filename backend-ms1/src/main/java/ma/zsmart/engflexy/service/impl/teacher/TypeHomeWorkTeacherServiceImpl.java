...
import java.util.List;
@Service
public class TypeHomeWorkTeacherServiceImpl extends AbstractServiceImpl<TypeHomeWork,TypeHomeWorkHistory, TypeHomeWorkCriteria, TypeHomeWorkHistoryCriteria, TypeHomeWorkDao,
TypeHomeWorkHistoryDao> implements TypeHomeWorkTeacherService {
    ...
    public TypeHomeWorkTeacherServiceImpl(TypeHomeWorkDao dao, TypeHomeWorkHistoryDao historyDao) {
