...
import java.util.List;
@Service
public class PaiementTeacherServiceImpl extends AbstractServiceImpl<Paiement,PaiementHistory, PaiementCriteria, PaiementHistoryCriteria, PaiementDao,
PaiementHistoryDao> implements PaiementTeacherService {
    ...
    public PaiementTeacherServiceImpl(PaiementDao dao, PaiementHistoryDao historyDao) {
