...
import java.util.List;
@Service
public class CategorieSectionTeacherServiceImpl extends AbstractServiceImpl<CategorieSection,CategorieSectionHistory, CategorieSectionCriteria, CategorieSectionHistoryCriteria, CategorieSectionDao,
CategorieSectionHistoryDao> implements CategorieSectionTeacherService {
    ...
    public CategorieSectionTeacherServiceImpl(CategorieSectionDao dao, CategorieSectionHistoryDao historyDao) {
