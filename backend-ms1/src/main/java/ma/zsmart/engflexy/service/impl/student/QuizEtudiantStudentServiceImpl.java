...
import java.util.List;
@Service
public class QuizEtudiantStudentServiceImpl extends AbstractServiceImpl<QuizEtudiant,QuizEtudiantHistory, QuizEtudiantCriteria, QuizEtudiantHistoryCriteria, QuizEtudiantDao,
QuizEtudiantHistoryDao> implements QuizEtudiantStudentService {
    ...
    @Autowired
    private ReponseEtudiantStudentService reponseEtudiantService ;
    public QuizEtudiantStudentServiceImpl(QuizEtudiantDao dao, QuizEtudiantHistoryDao historyDao) {
