...
import java.util.List;
@Service
public class CategorieSectionStudentServiceImpl extends AbstractServiceImpl<CategorieSection,CategorieSectionHistory, CategorieSectionCriteria, CategorieSectionHistoryCriteria, CategorieSectionDao,
CategorieSectionHistoryDao> implements CategorieSectionStudentService {
    ...
    public CategorieSectionStudentServiceImpl(CategorieSectionDao dao, CategorieSectionHistoryDao historyDao) {
