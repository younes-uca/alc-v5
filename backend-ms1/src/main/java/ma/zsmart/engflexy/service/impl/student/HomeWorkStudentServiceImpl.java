...
import java.util.List;
@Service
public class HomeWorkStudentServiceImpl extends AbstractServiceImpl<HomeWork,HomeWorkHistory, HomeWorkCriteria, HomeWorkHistoryCriteria, HomeWorkDao,
HomeWorkHistoryDao> implements HomeWorkStudentService {
    ...
    @Autowired
    private TypeHomeWorkStudentService typeHomeWorkService ;
    @Autowired
    private HomeWorkEtudiantStudentService homeWorkEtudiantService ;
    public HomeWorkStudentServiceImpl(HomeWorkDao dao, HomeWorkHistoryDao historyDao) {
