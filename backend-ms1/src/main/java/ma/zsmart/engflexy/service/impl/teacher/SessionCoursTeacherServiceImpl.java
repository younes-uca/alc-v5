...
import java.util.List;
@Service
public class SessionCoursTeacherServiceImpl extends AbstractServiceImpl<SessionCours,SessionCoursHistory, SessionCoursCriteria, SessionCoursHistoryCriteria, SessionCoursDao,
SessionCoursHistoryDao> implements SessionCoursTeacherService {
    ...
    public SessionCoursTeacherServiceImpl(SessionCoursDao dao, SessionCoursHistoryDao historyDao) {
