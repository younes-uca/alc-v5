...
import java.util.List;
@Service
public class HomeWorkTeacherServiceImpl extends AbstractServiceImpl<HomeWork,HomeWorkHistory, HomeWorkCriteria, HomeWorkHistoryCriteria, HomeWorkDao,
HomeWorkHistoryDao> implements HomeWorkTeacherService {
    ...
    @Autowired
    private TypeHomeWorkTeacherService typeHomeWorkService ;
    @Autowired
    private HomeWorkEtudiantTeacherService homeWorkEtudiantService ;
    public HomeWorkTeacherServiceImpl(HomeWorkDao dao, HomeWorkHistoryDao historyDao) {
