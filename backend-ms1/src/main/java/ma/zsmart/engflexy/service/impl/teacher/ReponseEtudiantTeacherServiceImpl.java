...
import java.util.List;
@Service
public class ReponseEtudiantTeacherServiceImpl extends AbstractServiceImpl<ReponseEtudiant,ReponseEtudiantHistory, ReponseEtudiantCriteria, ReponseEtudiantHistoryCriteria, ReponseEtudiantDao,
ReponseEtudiantHistoryDao> implements ReponseEtudiantTeacherService {
    ...
    public ReponseEtudiantTeacherServiceImpl(ReponseEtudiantDao dao, ReponseEtudiantHistoryDao historyDao) {
