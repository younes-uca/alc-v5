...
import java.util.List;
@Service
public class SectionStudentServiceImpl extends AbstractServiceImpl<Section,SectionHistory, SectionCriteria, SectionHistoryCriteria, SectionDao,
SectionHistoryDao> implements SectionStudentService {
    ...
    @Autowired
    private SectionItemStudentService sectionItemService ;
    @Autowired
    private CoursStudentService coursService ;
    @Autowired
    private CategorieSectionStudentService categorieSectionService ;
    public SectionStudentServiceImpl(SectionDao dao, SectionHistoryDao historyDao) {
