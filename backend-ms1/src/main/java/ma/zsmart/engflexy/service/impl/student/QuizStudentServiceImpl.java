...
import java.util.List;
@Service
public class QuizStudentServiceImpl extends AbstractServiceImpl<Quiz,QuizHistory, QuizCriteria, QuizHistoryCriteria, QuizDao,
QuizHistoryDao> implements QuizStudentService {
    ...
    public QuizStudentServiceImpl(QuizDao dao, QuizHistoryDao historyDao) {
