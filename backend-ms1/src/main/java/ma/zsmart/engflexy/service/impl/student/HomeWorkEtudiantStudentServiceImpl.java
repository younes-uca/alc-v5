...
import java.util.List;
@Service
public class HomeWorkEtudiantStudentServiceImpl extends AbstractServiceImpl<HomeWorkEtudiant,HomeWorkEtudiantHistory, HomeWorkEtudiantCriteria, HomeWorkEtudiantHistoryCriteria, HomeWorkEtudiantDao,
HomeWorkEtudiantHistoryDao> implements HomeWorkEtudiantStudentService {
    ...
    @Autowired
    private ResultatHomeWorkStudentService resultatHomeWorkService ;
    @Autowired
    private HomeWorkStudentService homeWorkService ;
    @Autowired
    private ReponseEtudiantHomeWorkStudentService reponseEtudiantHomeWorkService ;
    public HomeWorkEtudiantStudentServiceImpl(HomeWorkEtudiantDao dao, HomeWorkEtudiantHistoryDao historyDao) {
