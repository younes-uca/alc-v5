...
import java.util.List;
@Service
public class HoweWorkQSTReponseTeacherServiceImpl extends AbstractServiceImpl<HoweWorkQSTReponse,HoweWorkQSTReponseHistory, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseHistoryCriteria, HoweWorkQSTReponseDao,
HoweWorkQSTReponseHistoryDao> implements HoweWorkQSTReponseTeacherService {
    ...
    @Autowired
    private EtatReponseTeacherService etatReponseService ;
    @Autowired
    private HomeWorkQuestionTeacherService homeWorkQuestionService ;
    public HoweWorkQSTReponseTeacherServiceImpl(HoweWorkQSTReponseDao dao, HoweWorkQSTReponseHistoryDao historyDao) {
