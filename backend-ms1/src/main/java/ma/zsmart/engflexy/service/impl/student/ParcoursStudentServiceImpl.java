...
import java.util.List;
@Service
public class ParcoursStudentServiceImpl extends AbstractServiceImpl<Parcours,ParcoursHistory, ParcoursCriteria, ParcoursHistoryCriteria, ParcoursDao,
ParcoursHistoryDao> implements ParcoursStudentService {
    ...
    public ParcoursStudentServiceImpl(ParcoursDao dao, ParcoursHistoryDao historyDao) {
