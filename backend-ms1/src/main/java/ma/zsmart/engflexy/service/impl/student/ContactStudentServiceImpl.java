...
import java.util.List;
@Service
public class ContactStudentServiceImpl extends AbstractServiceImpl<Contact,ContactHistory, ContactCriteria, ContactHistoryCriteria, ContactDao,
ContactHistoryDao> implements ContactStudentService {
    ...
    public ContactStudentServiceImpl(ContactDao dao, ContactHistoryDao historyDao) {
