...
import java.util.List;
@Service
public class DictionaryTeacherServiceImpl extends AbstractServiceImpl<Dictionary,DictionaryHistory, DictionaryCriteria, DictionaryHistoryCriteria, DictionaryDao,
DictionaryHistoryDao> implements DictionaryTeacherService {
    ...
    public DictionaryTeacherServiceImpl(DictionaryDao dao, DictionaryHistoryDao historyDao) {
