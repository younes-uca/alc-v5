...
import java.util.List;
@Service
public class ParcoursTeacherServiceImpl extends AbstractServiceImpl<Parcours,ParcoursHistory, ParcoursCriteria, ParcoursHistoryCriteria, ParcoursDao,
ParcoursHistoryDao> implements ParcoursTeacherService {
    ...
    public ParcoursTeacherServiceImpl(ParcoursDao dao, ParcoursHistoryDao historyDao) {
