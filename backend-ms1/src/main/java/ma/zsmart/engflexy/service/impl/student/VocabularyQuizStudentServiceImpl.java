...
import java.util.List;
@Service
public class VocabularyQuizStudentServiceImpl extends AbstractServiceImpl<VocabularyQuiz,VocabularyQuizHistory, VocabularyQuizCriteria, VocabularyQuizHistoryCriteria, VocabularyQuizDao,
VocabularyQuizHistoryDao> implements VocabularyQuizStudentService {
    ...
    @Autowired
    private VocabularyStudentService vocabularyService ;
    @Autowired
    private SectionStudentService sectionService ;
    public VocabularyQuizStudentServiceImpl(VocabularyQuizDao dao, VocabularyQuizHistoryDao historyDao) {
