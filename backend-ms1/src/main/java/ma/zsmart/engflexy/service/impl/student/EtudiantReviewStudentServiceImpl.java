...
import java.util.List;
@Service
public class EtudiantReviewStudentServiceImpl extends AbstractServiceImpl<EtudiantReview,EtudiantReviewHistory, EtudiantReviewCriteria, EtudiantReviewHistoryCriteria, EtudiantReviewDao,
EtudiantReviewHistoryDao> implements EtudiantReviewStudentService {
    ...
    public EtudiantReviewStudentServiceImpl(EtudiantReviewDao dao, EtudiantReviewHistoryDao historyDao) {
