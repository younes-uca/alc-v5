...
import java.util.List;
@Service
public class GroupeEtudiantStudentServiceImpl extends AbstractServiceImpl<GroupeEtudiant,GroupeEtudiantHistory, GroupeEtudiantCriteria, GroupeEtudiantHistoryCriteria, GroupeEtudiantDao,
GroupeEtudiantHistoryDao> implements GroupeEtudiantStudentService {
    ...
    @Autowired
    private GroupeEtudiantDetailStudentService groupeEtudiantDetailService ;
    @Autowired
    private ParcoursStudentService parcoursService ;
    @Autowired
    private GroupeEtudeStudentService groupeEtudeService ;
    public GroupeEtudiantStudentServiceImpl(GroupeEtudiantDao dao, GroupeEtudiantHistoryDao historyDao) {
