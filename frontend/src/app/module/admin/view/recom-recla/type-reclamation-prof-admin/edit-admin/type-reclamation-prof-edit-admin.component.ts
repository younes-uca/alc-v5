...
export class TypeReclamationProfEditAdminComponent extends AbstractEditController<TypeReclamationProfDto, TypeReclamationProfCriteria, TypeReclamationProfService>   implements OnInit {
