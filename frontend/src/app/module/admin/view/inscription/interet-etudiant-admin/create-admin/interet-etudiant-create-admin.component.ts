...
export class InteretEtudiantCreateAdminComponent extends AbstractCreateController<InteretEtudiantDto, InteretEtudiantCriteria, InteretEtudiantService>  implements OnInit {
