...
@Component({
  selector: 'app-admin-list-teacher',
  templateUrl: './admin-list-teacher.component.html'
})
export class AdminListTeacherComponent extends AbstractListController<AdminDto, AdminCriteria, AdminService>  implements OnInit {
