...
@Component({
  selector: 'app-free-trial-create-teacher',
  templateUrl: './free-trial-create-teacher.component.html'
})
export class FreeTrialCreateTeacherComponent extends AbstractCreateController<FreeTrialDto, FreeTrialCriteria, FreeTrialService>  implements OnInit {
