...
@Component({
  selector: 'app-free-trial-list-teacher',
  templateUrl: './free-trial-list-teacher.component.html'
})
export class FreeTrialListTeacherComponent extends AbstractListController<FreeTrialDto, FreeTrialCriteria, FreeTrialService>  implements OnInit {
