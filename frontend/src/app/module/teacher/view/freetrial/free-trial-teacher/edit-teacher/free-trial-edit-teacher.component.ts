...
@Component({
  selector: 'app-free-trial-edit-teacher',
  templateUrl: './free-trial-edit-teacher.component.html'
})
export class FreeTrialEditTeacherComponent extends AbstractEditController<FreeTrialDto, FreeTrialCriteria, FreeTrialService>   implements OnInit {
