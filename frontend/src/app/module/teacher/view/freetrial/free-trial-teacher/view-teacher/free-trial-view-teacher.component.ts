...
@Component({
  selector: 'app-free-trial-view-teacher',
  templateUrl: './free-trial-view-teacher.component.html'
})
export class FreeTrialViewTeacherComponent extends AbstractViewController<FreeTrialDto, FreeTrialCriteria, FreeTrialService> implements OnInit {
