...
@Component({
  selector: 'app-free-trial-teacher-whats-template-list-teacher',
  templateUrl: './free-trial-teacher-whats-template-list-teacher.component.html'
})
export class FreeTrialTeacherWhatsTemplateListTeacherComponent extends AbstractListController<FreeTrialTeacherWhatsTemplateDto, FreeTrialTeacherWhatsTemplateCriteria, FreeTrialTeacherWhatsTemplateService>  implements OnInit {
