...
@Component({
  selector: 'app-free-trialformule-list-teacher',
  templateUrl: './free-trialformule-list-teacher.component.html'
})
export class FreeTrialformuleListTeacherComponent extends AbstractListController<FreeTrialformuleDto, FreeTrialformuleCriteria, FreeTrialformuleService>  implements OnInit {
    ...
    constructor(freeTrialformuleService: FreeTrialformuleService, private inscriptionService: InscriptionService) {
