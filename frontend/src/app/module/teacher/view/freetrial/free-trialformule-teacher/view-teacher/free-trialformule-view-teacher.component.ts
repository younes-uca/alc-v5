...
@Component({
  selector: 'app-free-trialformule-view-teacher',
  templateUrl: './free-trialformule-view-teacher.component.html'
})
export class FreeTrialformuleViewTeacherComponent extends AbstractViewController<FreeTrialformuleDto, FreeTrialformuleCriteria, FreeTrialformuleService> implements OnInit {
