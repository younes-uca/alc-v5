...
@Component({
  selector: 'app-free-trialformule-create-teacher',
  templateUrl: './free-trialformule-create-teacher.component.html'
})
export class FreeTrialformuleCreateTeacherComponent extends AbstractCreateController<FreeTrialformuleDto, FreeTrialformuleCriteria, FreeTrialformuleService>  implements OnInit {
