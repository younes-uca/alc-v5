...
@Component({
  selector: 'app-free-trialformule-edit-teacher',
  templateUrl: './free-trialformule-edit-teacher.component.html'
})
export class FreeTrialformuleEditTeacherComponent extends AbstractEditController<FreeTrialformuleDto, FreeTrialformuleCriteria, FreeTrialformuleService>   implements OnInit {
