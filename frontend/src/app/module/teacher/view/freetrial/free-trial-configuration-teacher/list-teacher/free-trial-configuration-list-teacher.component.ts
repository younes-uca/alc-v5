...
@Component({
  selector: 'app-free-trial-configuration-list-teacher',
  templateUrl: './free-trial-configuration-list-teacher.component.html'
})
export class FreeTrialConfigurationListTeacherComponent extends AbstractListController<FreeTrialConfigurationDto, FreeTrialConfigurationCriteria, FreeTrialConfigurationService>  implements OnInit {
