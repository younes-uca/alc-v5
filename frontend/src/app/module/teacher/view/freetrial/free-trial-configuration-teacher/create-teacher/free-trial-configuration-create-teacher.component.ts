...
@Component({
  selector: 'app-free-trial-configuration-create-teacher',
  templateUrl: './free-trial-configuration-create-teacher.component.html'
})
export class FreeTrialConfigurationCreateTeacherComponent extends AbstractCreateController<FreeTrialConfigurationDto, FreeTrialConfigurationCriteria, FreeTrialConfigurationService>  implements OnInit {
