...
@Component({
  selector: 'app-free-trial-configuration-edit-teacher',
  templateUrl: './free-trial-configuration-edit-teacher.component.html'
})
export class FreeTrialConfigurationEditTeacherComponent extends AbstractEditController<FreeTrialConfigurationDto, FreeTrialConfigurationCriteria, FreeTrialConfigurationService>   implements OnInit {
