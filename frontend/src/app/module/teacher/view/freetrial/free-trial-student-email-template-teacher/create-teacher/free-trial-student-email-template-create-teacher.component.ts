...
@Component({
  selector: 'app-free-trial-student-email-template-create-teacher',
  templateUrl: './free-trial-student-email-template-create-teacher.component.html'
})
export class FreeTrialStudentEmailTemplateCreateTeacherComponent extends AbstractCreateController<FreeTrialStudentEmailTemplateDto, FreeTrialStudentEmailTemplateCriteria, FreeTrialStudentEmailTemplateService>  implements OnInit {
