...
@Component({
  selector: 'app-free-trial-student-email-template-list-teacher',
  templateUrl: './free-trial-student-email-template-list-teacher.component.html'
})
export class FreeTrialStudentEmailTemplateListTeacherComponent extends AbstractListController<FreeTrialStudentEmailTemplateDto, FreeTrialStudentEmailTemplateCriteria, FreeTrialStudentEmailTemplateService>  implements OnInit {
