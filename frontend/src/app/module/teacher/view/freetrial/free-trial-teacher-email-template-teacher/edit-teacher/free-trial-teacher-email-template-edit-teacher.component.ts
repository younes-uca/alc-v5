...
@Component({
  selector: 'app-free-trial-teacher-email-template-edit-teacher',
  templateUrl: './free-trial-teacher-email-template-edit-teacher.component.html'
})
export class FreeTrialTeacherEmailTemplateEditTeacherComponent extends AbstractEditController<FreeTrialTeacherEmailTemplateDto, FreeTrialTeacherEmailTemplateCriteria, FreeTrialTeacherEmailTemplateService>   implements OnInit {
