...
@Component({
  selector: 'app-free-trial-teacher-email-template-list-teacher',
  templateUrl: './free-trial-teacher-email-template-list-teacher.component.html'
})
export class FreeTrialTeacherEmailTemplateListTeacherComponent extends AbstractListController<FreeTrialTeacherEmailTemplateDto, FreeTrialTeacherEmailTemplateCriteria, FreeTrialTeacherEmailTemplateService>  implements OnInit {
