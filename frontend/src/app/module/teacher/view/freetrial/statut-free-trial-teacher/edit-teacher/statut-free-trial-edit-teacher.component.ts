...
@Component({
  selector: 'app-statut-free-trial-edit-teacher',
  templateUrl: './statut-free-trial-edit-teacher.component.html'
})
export class StatutFreeTrialEditTeacherComponent extends AbstractEditController<StatutFreeTrialDto, StatutFreeTrialCriteria, StatutFreeTrialService>   implements OnInit {
