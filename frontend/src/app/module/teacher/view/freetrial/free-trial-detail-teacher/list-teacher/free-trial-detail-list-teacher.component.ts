...
@Component({
  selector: 'app-free-trial-detail-list-teacher',
  templateUrl: './free-trial-detail-list-teacher.component.html'
})
export class FreeTrialDetailListTeacherComponent extends AbstractListController<FreeTrialDetailDto, FreeTrialDetailCriteria, FreeTrialDetailService>  implements OnInit {
    ...
    constructor(freeTrialDetailService: FreeTrialDetailService, private freeTrialService: FreeTrialService, private etudiantService: EtudiantService) {
