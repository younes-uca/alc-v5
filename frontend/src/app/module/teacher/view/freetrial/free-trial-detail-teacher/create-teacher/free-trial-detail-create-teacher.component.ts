...
@Component({
  selector: 'app-free-trial-detail-create-teacher',
  templateUrl: './free-trial-detail-create-teacher.component.html'
})
export class FreeTrialDetailCreateTeacherComponent extends AbstractCreateController<FreeTrialDetailDto, FreeTrialDetailCriteria, FreeTrialDetailService>  implements OnInit {
