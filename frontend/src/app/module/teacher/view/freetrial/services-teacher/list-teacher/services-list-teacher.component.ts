...
@Component({
  selector: 'app-services-list-teacher',
  templateUrl: './services-list-teacher.component.html'
})
export class ServicesListTeacherComponent extends AbstractListController<ServicesDto, ServicesCriteria, ServicesService>  implements OnInit {
