...
@Component({
  selector: 'app-services-edit-teacher',
  templateUrl: './services-edit-teacher.component.html'
})
export class ServicesEditTeacherComponent extends AbstractEditController<ServicesDto, ServicesCriteria, ServicesService>   implements OnInit {
