...
@Component({
  selector: 'app-services-create-teacher',
  templateUrl: './services-create-teacher.component.html'
})
export class ServicesCreateTeacherComponent extends AbstractCreateController<ServicesDto, ServicesCriteria, ServicesService>  implements OnInit {
