...
@Component({
  selector: 'app-free-trial-student-whats-template-create-teacher',
  templateUrl: './free-trial-student-whats-template-create-teacher.component.html'
})
export class FreeTrialStudentWhatsTemplateCreateTeacherComponent extends AbstractCreateController<FreeTrialStudentWhatsTemplateDto, FreeTrialStudentWhatsTemplateCriteria, FreeTrialStudentWhatsTemplateService>  implements OnInit {
