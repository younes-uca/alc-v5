...
@Component({
  selector: 'app-free-trial-student-whats-template-list-teacher',
  templateUrl: './free-trial-student-whats-template-list-teacher.component.html'
})
export class FreeTrialStudentWhatsTemplateListTeacherComponent extends AbstractListController<FreeTrialStudentWhatsTemplateDto, FreeTrialStudentWhatsTemplateCriteria, FreeTrialStudentWhatsTemplateService>  implements OnInit {
