...
@Component({
  selector: 'app-type-reclamation-prof-create-teacher',
  templateUrl: './type-reclamation-prof-create-teacher.component.html'
})
export class TypeReclamationProfCreateTeacherComponent extends AbstractCreateController<TypeReclamationProfDto, TypeReclamationProfCriteria, TypeReclamationProfService>  implements OnInit {
