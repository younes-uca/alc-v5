...
@Component({
  selector: 'app-type-reclamation-prof-list-teacher',
  templateUrl: './type-reclamation-prof-list-teacher.component.html'
})
export class TypeReclamationProfListTeacherComponent extends AbstractListController<TypeReclamationProfDto, TypeReclamationProfCriteria, TypeReclamationProfService>  implements OnInit {
