...
@Component({
  selector: 'app-type-reclamation-prof-view-teacher',
  templateUrl: './type-reclamation-prof-view-teacher.component.html'
})
export class TypeReclamationProfViewTeacherComponent extends AbstractViewController<TypeReclamationProfDto, TypeReclamationProfCriteria, TypeReclamationProfService> implements OnInit {
