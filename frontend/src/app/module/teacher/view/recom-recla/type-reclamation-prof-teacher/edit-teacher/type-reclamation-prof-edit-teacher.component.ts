...
@Component({
  selector: 'app-type-reclamation-prof-edit-teacher',
  templateUrl: './type-reclamation-prof-edit-teacher.component.html'
})
export class TypeReclamationProfEditTeacherComponent extends AbstractEditController<TypeReclamationProfDto, TypeReclamationProfCriteria, TypeReclamationProfService>   implements OnInit {
