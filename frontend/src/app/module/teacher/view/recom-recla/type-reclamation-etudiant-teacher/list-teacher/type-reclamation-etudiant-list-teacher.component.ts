...
@Component({
  selector: 'app-type-reclamation-etudiant-list-teacher',
  templateUrl: './type-reclamation-etudiant-list-teacher.component.html'
})
export class TypeReclamationEtudiantListTeacherComponent extends AbstractListController<TypeReclamationEtudiantDto, TypeReclamationEtudiantCriteria, TypeReclamationEtudiantService>  implements OnInit {
