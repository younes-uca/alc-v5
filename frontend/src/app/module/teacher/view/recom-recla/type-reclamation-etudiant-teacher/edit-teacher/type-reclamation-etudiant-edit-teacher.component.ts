...
@Component({
  selector: 'app-type-reclamation-etudiant-edit-teacher',
  templateUrl: './type-reclamation-etudiant-edit-teacher.component.html'
})
export class TypeReclamationEtudiantEditTeacherComponent extends AbstractEditController<TypeReclamationEtudiantDto, TypeReclamationEtudiantCriteria, TypeReclamationEtudiantService>   implements OnInit {
