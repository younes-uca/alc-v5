...
@Component({
  selector: 'app-type-reclamation-etudiant-create-teacher',
  templateUrl: './type-reclamation-etudiant-create-teacher.component.html'
})
export class TypeReclamationEtudiantCreateTeacherComponent extends AbstractCreateController<TypeReclamationEtudiantDto, TypeReclamationEtudiantCriteria, TypeReclamationEtudiantService>  implements OnInit {
