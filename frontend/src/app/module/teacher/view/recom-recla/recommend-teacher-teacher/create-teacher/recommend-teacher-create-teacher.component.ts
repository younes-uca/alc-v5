...
@Component({
  selector: 'app-recommend-teacher-create-teacher',
  templateUrl: './recommend-teacher-create-teacher.component.html'
})
export class RecommendTeacherCreateTeacherComponent extends AbstractCreateController<RecommendTeacherDto, RecommendTeacherCriteria, RecommendTeacherService>  implements OnInit {
