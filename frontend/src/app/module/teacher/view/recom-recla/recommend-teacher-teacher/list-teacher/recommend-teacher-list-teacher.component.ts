...
@Component({
  selector: 'app-recommend-teacher-list-teacher',
  templateUrl: './recommend-teacher-list-teacher.component.html'
})
export class RecommendTeacherListTeacherComponent extends AbstractListController<RecommendTeacherDto, RecommendTeacherCriteria, RecommendTeacherService>  implements OnInit {
