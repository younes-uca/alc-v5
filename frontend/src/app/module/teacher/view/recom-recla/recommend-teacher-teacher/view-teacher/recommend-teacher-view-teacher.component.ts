...
@Component({
  selector: 'app-recommend-teacher-view-teacher',
  templateUrl: './recommend-teacher-view-teacher.component.html'
})
export class RecommendTeacherViewTeacherComponent extends AbstractViewController<RecommendTeacherDto, RecommendTeacherCriteria, RecommendTeacherService> implements OnInit {
