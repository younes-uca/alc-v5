...
@Component({
  selector: 'app-recommend-teacher-edit-teacher',
  templateUrl: './recommend-teacher-edit-teacher.component.html'
})
export class RecommendTeacherEditTeacherComponent extends AbstractEditController<RecommendTeacherDto, RecommendTeacherCriteria, RecommendTeacherService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateRecommamdation = this.recommendTeacherService.format(this.item.dateRecommamdation);
    }
