...
@Component({
  selector: 'app-reclamation-prof-create-teacher',
  templateUrl: './reclamation-prof-create-teacher.component.html'
})
export class ReclamationProfCreateTeacherComponent extends AbstractCreateController<ReclamationProfDto, ReclamationProfCriteria, ReclamationProfService>  implements OnInit {
