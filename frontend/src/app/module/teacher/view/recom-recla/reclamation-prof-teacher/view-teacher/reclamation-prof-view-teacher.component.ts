...
@Component({
  selector: 'app-reclamation-prof-view-teacher',
  templateUrl: './reclamation-prof-view-teacher.component.html'
})
export class ReclamationProfViewTeacherComponent extends AbstractViewController<ReclamationProfDto, ReclamationProfCriteria, ReclamationProfService> implements OnInit {
