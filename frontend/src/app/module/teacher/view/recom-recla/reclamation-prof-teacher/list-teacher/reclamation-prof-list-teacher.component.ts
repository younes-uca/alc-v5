...
@Component({
  selector: 'app-reclamation-prof-list-teacher',
  templateUrl: './reclamation-prof-list-teacher.component.html'
})
export class ReclamationProfListTeacherComponent extends AbstractListController<ReclamationProfDto, ReclamationProfCriteria, ReclamationProfService>  implements OnInit {
    ...
    constructor(reclamationProfService: ReclamationProfService, private adminService: AdminService, private profService: ProfService, private typeReclamationProfService: TypeReclamationProfService) {
