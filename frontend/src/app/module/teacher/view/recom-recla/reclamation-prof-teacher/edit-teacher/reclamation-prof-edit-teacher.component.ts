...
@Component({
  selector: 'app-reclamation-prof-edit-teacher',
  templateUrl: './reclamation-prof-edit-teacher.component.html'
})
export class ReclamationProfEditTeacherComponent extends AbstractEditController<ReclamationProfDto, ReclamationProfCriteria, ReclamationProfService>   implements OnInit {
