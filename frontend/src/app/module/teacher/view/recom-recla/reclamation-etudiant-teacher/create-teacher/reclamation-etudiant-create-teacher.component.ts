...
@Component({
  selector: 'app-reclamation-etudiant-create-teacher',
  templateUrl: './reclamation-etudiant-create-teacher.component.html'
})
export class ReclamationEtudiantCreateTeacherComponent extends AbstractCreateController<ReclamationEtudiantDto, ReclamationEtudiantCriteria, ReclamationEtudiantService>  implements OnInit {
