...
@Component({
  selector: 'app-reclamation-etudiant-edit-teacher',
  templateUrl: './reclamation-etudiant-edit-teacher.component.html'
})
export class ReclamationEtudiantEditTeacherComponent extends AbstractEditController<ReclamationEtudiantDto, ReclamationEtudiantCriteria, ReclamationEtudiantService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateReclamation = this.reclamationEtudiantService.format(this.item.dateReclamation);
        this.item.dateTraitement = this.reclamationEtudiantService.format(this.item.dateTraitement);
        this.item.dateReponse = this.reclamationEtudiantService.format(this.item.dateReponse);
    }
