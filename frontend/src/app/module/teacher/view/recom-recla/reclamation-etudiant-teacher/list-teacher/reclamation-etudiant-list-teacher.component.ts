...
@Component({
  selector: 'app-reclamation-etudiant-list-teacher',
  templateUrl: './reclamation-etudiant-list-teacher.component.html'
})
export class ReclamationEtudiantListTeacherComponent extends AbstractListController<ReclamationEtudiantDto, ReclamationEtudiantCriteria, ReclamationEtudiantService>  implements OnInit {
