...
@Component({
  selector: 'app-reclamation-etudiant-view-teacher',
  templateUrl: './reclamation-etudiant-view-teacher.component.html'
})
export class ReclamationEtudiantViewTeacherComponent extends AbstractViewController<ReclamationEtudiantDto, ReclamationEtudiantCriteria, ReclamationEtudiantService> implements OnInit {
