...
@Component({
  selector: 'app-type-teacher-list-teacher',
  templateUrl: './type-teacher-list-teacher.component.html'
})
export class TypeTeacherListTeacherComponent extends AbstractListController<TypeTeacherDto, TypeTeacherCriteria, TypeTeacherService>  implements OnInit {
