...
@Component({
  selector: 'app-type-teacher-edit-teacher',
  templateUrl: './type-teacher-edit-teacher.component.html'
})
export class TypeTeacherEditTeacherComponent extends AbstractEditController<TypeTeacherDto, TypeTeacherCriteria, TypeTeacherService>   implements OnInit {
