...
@Component({
  selector: 'app-type-teacher-create-teacher',
  templateUrl: './type-teacher-create-teacher.component.html'
})
export class TypeTeacherCreateTeacherComponent extends AbstractCreateController<TypeTeacherDto, TypeTeacherCriteria, TypeTeacherService>  implements OnInit {
