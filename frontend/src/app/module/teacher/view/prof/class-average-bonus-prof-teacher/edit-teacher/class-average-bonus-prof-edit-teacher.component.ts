...
@Component({
  selector: 'app-class-average-bonus-prof-edit-teacher',
  templateUrl: './class-average-bonus-prof-edit-teacher.component.html'
})
export class ClassAverageBonusProfEditTeacherComponent extends AbstractEditController<ClassAverageBonusProfDto, ClassAverageBonusProfCriteria, ClassAverageBonusProfService>   implements OnInit {
