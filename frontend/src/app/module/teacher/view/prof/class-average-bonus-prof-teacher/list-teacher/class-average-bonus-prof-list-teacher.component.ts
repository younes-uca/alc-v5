...
@Component({
  selector: 'app-class-average-bonus-prof-list-teacher',
  templateUrl: './class-average-bonus-prof-list-teacher.component.html'
})
export class ClassAverageBonusProfListTeacherComponent extends AbstractListController<ClassAverageBonusProfDto, ClassAverageBonusProfCriteria, ClassAverageBonusProfService>  implements OnInit {
