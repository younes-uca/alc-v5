...
@Component({
  selector: 'app-class-average-bonus-prof-view-teacher',
  templateUrl: './class-average-bonus-prof-view-teacher.component.html'
})
export class ClassAverageBonusProfViewTeacherComponent extends AbstractViewController<ClassAverageBonusProfDto, ClassAverageBonusProfCriteria, ClassAverageBonusProfService> implements OnInit {
