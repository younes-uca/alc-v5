...
@Component({
  selector: 'app-class-average-bonus-prof-create-teacher',
  templateUrl: './class-average-bonus-prof-create-teacher.component.html'
})
export class ClassAverageBonusProfCreateTeacherComponent extends AbstractCreateController<ClassAverageBonusProfDto, ClassAverageBonusProfCriteria, ClassAverageBonusProfService>  implements OnInit {
