...
@Component({
  selector: 'app-prof-create-teacher',
  templateUrl: './prof-create-teacher.component.html'
})
export class ProfCreateTeacherComponent extends AbstractCreateController<ProfDto, ProfCriteria, ProfService>  implements OnInit {
