...
@Component({
  selector: 'app-prof-view-teacher',
  templateUrl: './prof-view-teacher.component.html'
})
export class ProfViewTeacherComponent extends AbstractViewController<ProfDto, ProfCriteria, ProfService> implements OnInit {
