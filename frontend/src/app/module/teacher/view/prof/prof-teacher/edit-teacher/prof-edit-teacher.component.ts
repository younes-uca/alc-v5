...
@Component({
  selector: 'app-prof-edit-teacher',
  templateUrl: './prof-edit-teacher.component.html'
})
export class ProfEditTeacherComponent extends AbstractEditController<ProfDto, ProfCriteria, ProfService>   implements OnInit {
