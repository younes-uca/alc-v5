...
@Component({
  selector: 'app-prof-list-teacher',
  templateUrl: './prof-list-teacher.component.html'
})
export class ProfListTeacherComponent extends AbstractListController<ProfDto, ProfCriteria, ProfService>  implements OnInit {
