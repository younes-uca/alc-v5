...
@Component({
  selector: 'app-calendrier-prof-edit-teacher',
  templateUrl: './calendrier-prof-edit-teacher.component.html'
})
export class CalendrierProfEditTeacherComponent extends AbstractEditController<CalendrierProfDto, CalendrierProfCriteria, CalendrierProfService>   implements OnInit {
