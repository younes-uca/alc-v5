...
@Component({
  selector: 'app-calendrier-prof-view-teacher',
  templateUrl: './calendrier-prof-view-teacher.component.html'
})
export class CalendrierProfViewTeacherComponent extends AbstractViewController<CalendrierProfDto, CalendrierProfCriteria, CalendrierProfService> implements OnInit {
