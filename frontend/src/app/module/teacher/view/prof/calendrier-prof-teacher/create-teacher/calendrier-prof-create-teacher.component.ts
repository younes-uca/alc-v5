...
@Component({
  selector: 'app-calendrier-prof-create-teacher',
  templateUrl: './calendrier-prof-create-teacher.component.html'
})
export class CalendrierProfCreateTeacherComponent extends AbstractCreateController<CalendrierProfDto, CalendrierProfCriteria, CalendrierProfService>  implements OnInit {
