...
@Component({
  selector: 'app-schedule-prof-view-teacher',
  templateUrl: './schedule-prof-view-teacher.component.html'
})
export class ScheduleProfViewTeacherComponent extends AbstractViewController<ScheduleProfDto, ScheduleProfCriteria, ScheduleProfService> implements OnInit {
