...
@Component({
  selector: 'app-schedule-prof-edit-teacher',
  templateUrl: './schedule-prof-edit-teacher.component.html'
})
export class ScheduleProfEditTeacherComponent extends AbstractEditController<ScheduleProfDto, ScheduleProfCriteria, ScheduleProfService>   implements OnInit {
