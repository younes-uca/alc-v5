...
@Component({
  selector: 'app-schedule-prof-list-teacher',
  templateUrl: './schedule-prof-list-teacher.component.html'
})
export class ScheduleProfListTeacherComponent extends AbstractListController<ScheduleProfDto, ScheduleProfCriteria, ScheduleProfService>  implements OnInit {
