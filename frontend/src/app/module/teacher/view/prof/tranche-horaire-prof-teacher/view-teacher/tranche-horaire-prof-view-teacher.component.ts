...
@Component({
  selector: 'app-tranche-horaire-prof-view-teacher',
  templateUrl: './tranche-horaire-prof-view-teacher.component.html'
})
export class TrancheHoraireProfViewTeacherComponent extends AbstractViewController<TrancheHoraireProfDto, TrancheHoraireProfCriteria, TrancheHoraireProfService> implements OnInit {
