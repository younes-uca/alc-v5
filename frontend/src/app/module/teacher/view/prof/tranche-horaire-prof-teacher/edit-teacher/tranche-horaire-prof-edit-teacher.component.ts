...
@Component({
  selector: 'app-tranche-horaire-prof-edit-teacher',
  templateUrl: './tranche-horaire-prof-edit-teacher.component.html'
})
export class TrancheHoraireProfEditTeacherComponent extends AbstractEditController<TrancheHoraireProfDto, TrancheHoraireProfCriteria, TrancheHoraireProfService>   implements OnInit {
