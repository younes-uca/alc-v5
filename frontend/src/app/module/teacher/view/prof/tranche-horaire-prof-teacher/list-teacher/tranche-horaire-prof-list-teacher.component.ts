...
@Component({
  selector: 'app-tranche-horaire-prof-list-teacher',
  templateUrl: './tranche-horaire-prof-list-teacher.component.html'
})
export class TrancheHoraireProfListTeacherComponent extends AbstractListController<TrancheHoraireProfDto, TrancheHoraireProfCriteria, TrancheHoraireProfService>  implements OnInit {
