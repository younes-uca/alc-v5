...
@Component({
  selector: 'app-tranche-horaire-prof-create-teacher',
  templateUrl: './tranche-horaire-prof-create-teacher.component.html'
})
export class TrancheHoraireProfCreateTeacherComponent extends AbstractCreateController<TrancheHoraireProfDto, TrancheHoraireProfCriteria, TrancheHoraireProfService>  implements OnInit {
