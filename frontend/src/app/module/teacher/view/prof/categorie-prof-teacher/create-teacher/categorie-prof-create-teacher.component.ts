...
@Component({
  selector: 'app-categorie-prof-create-teacher',
  templateUrl: './categorie-prof-create-teacher.component.html'
})
export class CategorieProfCreateTeacherComponent extends AbstractCreateController<CategorieProfDto, CategorieProfCriteria, CategorieProfService>  implements OnInit {
