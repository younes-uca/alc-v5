...
@Component({
  selector: 'app-categorie-prof-edit-teacher',
  templateUrl: './categorie-prof-edit-teacher.component.html'
})
export class CategorieProfEditTeacherComponent extends AbstractEditController<CategorieProfDto, CategorieProfCriteria, CategorieProfService>   implements OnInit {
