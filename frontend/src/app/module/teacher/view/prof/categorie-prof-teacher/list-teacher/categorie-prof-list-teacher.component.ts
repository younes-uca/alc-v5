...
@Component({
  selector: 'app-categorie-prof-list-teacher',
  templateUrl: './categorie-prof-list-teacher.component.html'
})
export class CategorieProfListTeacherComponent extends AbstractListController<CategorieProfDto, CategorieProfCriteria, CategorieProfService>  implements OnInit {
