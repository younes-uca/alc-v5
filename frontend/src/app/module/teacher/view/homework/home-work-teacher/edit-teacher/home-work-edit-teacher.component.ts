...
@Component({
  selector: 'app-home-work-edit-teacher',
  templateUrl: './home-work-edit-teacher.component.html'
})
export class HomeWorkEditTeacherComponent extends AbstractEditController<HomeWorkDto, HomeWorkCriteria, HomeWorkService>   implements OnInit {
