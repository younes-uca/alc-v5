...
@Component({
  selector: 'app-home-work-list-teacher',
  templateUrl: './home-work-list-teacher.component.html'
})
export class HomeWorkListTeacherComponent extends AbstractListController<HomeWorkDto, HomeWorkCriteria, HomeWorkService>  implements OnInit {
    ...
    constructor(homeWorkService: HomeWorkService, private coursService: CoursService, private typeHomeWorkService: TypeHomeWorkService) {
