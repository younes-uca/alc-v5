...
@Component({
  selector: 'app-home-work-create-teacher',
  templateUrl: './home-work-create-teacher.component.html'
})
export class HomeWorkCreateTeacherComponent extends AbstractCreateController<HomeWorkDto, HomeWorkCriteria, HomeWorkService>  implements OnInit {
   ...
   private _validHomeWorkLibelle = true;
    ...
    constructor( private homeWorkService: HomeWorkService , private etudiantService: EtudiantService, private typeDeQuestionService: TypeDeQuestionService, private resultatHomeWorkService: ResultatHomeWorkService, private homeWorkQuestionService: HomeWorkQuestionService, private coursService: CoursService, private typeHomeWorkService: TypeHomeWorkService, private homeWorkEtudiantService: HomeWorkEtudiantService) {
