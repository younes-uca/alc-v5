...
@Component({
  selector: 'app-home-work-view-teacher',
  templateUrl: './home-work-view-teacher.component.html'
})
export class HomeWorkViewTeacherComponent extends AbstractViewController<HomeWorkDto, HomeWorkCriteria, HomeWorkService> implements OnInit {
