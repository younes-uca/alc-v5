...
@Component({
  selector: 'app-howe-work-q-s-t-reponse-list-teacher',
  templateUrl: './howe-work-q-s-t-reponse-list-teacher.component.html'
})
export class HoweWorkQSTReponseListTeacherComponent extends AbstractListController<HoweWorkQSTReponseDto, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseService>  implements OnInit {
    ...
    constructor(howeWorkQSTReponseService: HoweWorkQSTReponseService, private etatReponseService: EtatReponseService, private homeWorkQuestionService: HomeWorkQuestionService) {
