...
@Component({
  selector: 'app-howe-work-q-s-t-reponse-create-teacher',
  templateUrl: './howe-work-q-s-t-reponse-create-teacher.component.html'
})
export class HoweWorkQSTReponseCreateTeacherComponent extends AbstractCreateController<HoweWorkQSTReponseDto, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseService>  implements OnInit {
