...
@Component({
  selector: 'app-howe-work-q-s-t-reponse-view-teacher',
  templateUrl: './howe-work-q-s-t-reponse-view-teacher.component.html'
})
export class HoweWorkQSTReponseViewTeacherComponent extends AbstractViewController<HoweWorkQSTReponseDto, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseService> implements OnInit {
