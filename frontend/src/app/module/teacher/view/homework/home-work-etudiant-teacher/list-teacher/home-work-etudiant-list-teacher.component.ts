...
@Component({
  selector: 'app-home-work-etudiant-list-teacher',
  templateUrl: './home-work-etudiant-list-teacher.component.html'
})
export class HomeWorkEtudiantListTeacherComponent extends AbstractListController<HomeWorkEtudiantDto, HomeWorkEtudiantCriteria, HomeWorkEtudiantService>  implements OnInit {
    ...
    constructor(homeWorkEtudiantService: HomeWorkEtudiantService, private etudiantService: EtudiantService, private homeWorkService: HomeWorkService, private resultatHomeWorkService: ResultatHomeWorkService) {
