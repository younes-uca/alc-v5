...
@Component({
  selector: 'app-home-work-etudiant-create-teacher',
  templateUrl: './home-work-etudiant-create-teacher.component.html'
})
export class HomeWorkEtudiantCreateTeacherComponent extends AbstractCreateController<HomeWorkEtudiantDto, HomeWorkEtudiantCriteria, HomeWorkEtudiantService>  implements OnInit {
