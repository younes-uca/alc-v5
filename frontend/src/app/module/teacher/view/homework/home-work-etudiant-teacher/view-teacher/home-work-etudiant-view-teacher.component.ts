...
@Component({
  selector: 'app-home-work-etudiant-view-teacher',
  templateUrl: './home-work-etudiant-view-teacher.component.html'
})
export class HomeWorkEtudiantViewTeacherComponent extends AbstractViewController<HomeWorkEtudiantDto, HomeWorkEtudiantCriteria, HomeWorkEtudiantService> implements OnInit {
