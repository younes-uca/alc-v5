...
@Component({
  selector: 'app-home-work-etudiant-edit-teacher',
  templateUrl: './home-work-etudiant-edit-teacher.component.html'
})
export class HomeWorkEtudiantEditTeacherComponent extends AbstractEditController<HomeWorkEtudiantDto, HomeWorkEtudiantCriteria, HomeWorkEtudiantService>   implements OnInit {
