...
@Component({
  selector: 'app-type-home-work-create-teacher',
  templateUrl: './type-home-work-create-teacher.component.html'
})
export class TypeHomeWorkCreateTeacherComponent extends AbstractCreateController<TypeHomeWorkDto, TypeHomeWorkCriteria, TypeHomeWorkService>  implements OnInit {
