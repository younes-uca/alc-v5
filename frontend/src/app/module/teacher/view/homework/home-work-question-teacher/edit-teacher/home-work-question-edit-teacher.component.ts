...
@Component({
  selector: 'app-home-work-question-edit-teacher',
  templateUrl: './home-work-question-edit-teacher.component.html'
})
export class HomeWorkQuestionEditTeacherComponent extends AbstractEditController<HomeWorkQuestionDto, HomeWorkQuestionCriteria, HomeWorkQuestionService>   implements OnInit {
