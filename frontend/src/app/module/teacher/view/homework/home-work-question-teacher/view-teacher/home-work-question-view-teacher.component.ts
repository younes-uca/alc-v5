...
@Component({
  selector: 'app-home-work-question-view-teacher',
  templateUrl: './home-work-question-view-teacher.component.html'
})
export class HomeWorkQuestionViewTeacherComponent extends AbstractViewController<HomeWorkQuestionDto, HomeWorkQuestionCriteria, HomeWorkQuestionService> implements OnInit {
