...
@Component({
  selector: 'app-home-work-question-list-teacher',
  templateUrl: './home-work-question-list-teacher.component.html'
})
export class HomeWorkQuestionListTeacherComponent extends AbstractListController<HomeWorkQuestionDto, HomeWorkQuestionCriteria, HomeWorkQuestionService>  implements OnInit {
