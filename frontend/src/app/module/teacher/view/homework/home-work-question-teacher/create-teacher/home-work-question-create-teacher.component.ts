...
@Component({
  selector: 'app-home-work-question-create-teacher',
  templateUrl: './home-work-question-create-teacher.component.html'
})
export class HomeWorkQuestionCreateTeacherComponent extends AbstractCreateController<HomeWorkQuestionDto, HomeWorkQuestionCriteria, HomeWorkQuestionService>  implements OnInit {
   ...
   private _validHomeWorkQuestionLibelle = true;
    ...
    constructor( private homeWorkQuestionService: HomeWorkQuestionService , private typeDeQuestionService: TypeDeQuestionService, private howeWorkQSTReponseService: HoweWorkQSTReponseService, private etatReponseService: EtatReponseService, private homeWorkService: HomeWorkService) {
