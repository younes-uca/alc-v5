...
@Component({
  selector: 'app-reponse-etudiant-home-work-list-teacher',
  templateUrl: './reponse-etudiant-home-work-list-teacher.component.html'
})
export class ReponseEtudiantHomeWorkListTeacherComponent extends AbstractListController<ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkService>  implements OnInit {
