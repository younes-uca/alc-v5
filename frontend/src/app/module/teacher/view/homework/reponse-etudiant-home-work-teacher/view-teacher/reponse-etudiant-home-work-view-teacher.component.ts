...
@Component({
  selector: 'app-reponse-etudiant-home-work-view-teacher',
  templateUrl: './reponse-etudiant-home-work-view-teacher.component.html'
})
export class ReponseEtudiantHomeWorkViewTeacherComponent extends AbstractViewController<ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkService> implements OnInit {
