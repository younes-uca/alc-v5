...
@Component({
  selector: 'app-reponse-etudiant-home-work-edit-teacher',
  templateUrl: './reponse-etudiant-home-work-edit-teacher.component.html'
})
export class ReponseEtudiantHomeWorkEditTeacherComponent extends AbstractEditController<ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkService>   implements OnInit {
