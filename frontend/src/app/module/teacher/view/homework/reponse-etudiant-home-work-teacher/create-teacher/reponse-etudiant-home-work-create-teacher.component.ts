...
@Component({
  selector: 'app-reponse-etudiant-home-work-create-teacher',
  templateUrl: './reponse-etudiant-home-work-create-teacher.component.html'
})
export class ReponseEtudiantHomeWorkCreateTeacherComponent extends AbstractCreateController<ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkService>  implements OnInit {
