...
@Component({
  selector: 'app-resultat-home-work-view-teacher',
  templateUrl: './resultat-home-work-view-teacher.component.html'
})
export class ResultatHomeWorkViewTeacherComponent extends AbstractViewController<ResultatHomeWorkDto, ResultatHomeWorkCriteria, ResultatHomeWorkService> implements OnInit {
