...
@Component({
  selector: 'app-resultat-home-work-create-teacher',
  templateUrl: './resultat-home-work-create-teacher.component.html'
})
export class ResultatHomeWorkCreateTeacherComponent extends AbstractCreateController<ResultatHomeWorkDto, ResultatHomeWorkCriteria, ResultatHomeWorkService>  implements OnInit {
