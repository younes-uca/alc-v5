...
@Component({
  selector: 'app-resultat-home-work-list-teacher',
  templateUrl: './resultat-home-work-list-teacher.component.html'
})
export class ResultatHomeWorkListTeacherComponent extends AbstractListController<ResultatHomeWorkDto, ResultatHomeWorkCriteria, ResultatHomeWorkService>  implements OnInit {
