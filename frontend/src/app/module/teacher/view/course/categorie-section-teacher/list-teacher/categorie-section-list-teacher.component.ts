...
@Component({
  selector: 'app-categorie-section-list-teacher',
  templateUrl: './categorie-section-list-teacher.component.html'
})
export class CategorieSectionListTeacherComponent extends AbstractListController<CategorieSectionDto, CategorieSectionCriteria, CategorieSectionService>  implements OnInit {
