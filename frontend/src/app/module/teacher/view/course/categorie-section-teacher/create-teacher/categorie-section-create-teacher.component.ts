...
@Component({
  selector: 'app-categorie-section-create-teacher',
  templateUrl: './categorie-section-create-teacher.component.html'
})
export class CategorieSectionCreateTeacherComponent extends AbstractCreateController<CategorieSectionDto, CategorieSectionCriteria, CategorieSectionService>  implements OnInit {
