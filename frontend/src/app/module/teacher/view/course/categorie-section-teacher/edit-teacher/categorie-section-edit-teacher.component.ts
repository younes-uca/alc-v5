...
@Component({
  selector: 'app-categorie-section-edit-teacher',
  templateUrl: './categorie-section-edit-teacher.component.html'
})
export class CategorieSectionEditTeacherComponent extends AbstractEditController<CategorieSectionDto, CategorieSectionCriteria, CategorieSectionService>   implements OnInit {
