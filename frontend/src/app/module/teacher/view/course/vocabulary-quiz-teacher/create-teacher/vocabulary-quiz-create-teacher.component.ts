...
@Component({
  selector: 'app-vocabulary-quiz-create-teacher',
  templateUrl: './vocabulary-quiz-create-teacher.component.html'
})
export class VocabularyQuizCreateTeacherComponent extends AbstractCreateController<VocabularyQuizDto, VocabularyQuizCriteria, VocabularyQuizService>  implements OnInit {
