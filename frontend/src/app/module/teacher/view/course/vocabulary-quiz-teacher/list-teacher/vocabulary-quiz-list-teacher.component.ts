...
@Component({
  selector: 'app-vocabulary-quiz-list-teacher',
  templateUrl: './vocabulary-quiz-list-teacher.component.html'
})
export class VocabularyQuizListTeacherComponent extends AbstractListController<VocabularyQuizDto, VocabularyQuizCriteria, VocabularyQuizService>  implements OnInit {
