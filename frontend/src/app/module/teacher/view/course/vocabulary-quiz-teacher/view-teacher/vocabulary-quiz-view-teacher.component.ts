...
@Component({
  selector: 'app-vocabulary-quiz-view-teacher',
  templateUrl: './vocabulary-quiz-view-teacher.component.html'
})
export class VocabularyQuizViewTeacherComponent extends AbstractViewController<VocabularyQuizDto, VocabularyQuizCriteria, VocabularyQuizService> implements OnInit {
