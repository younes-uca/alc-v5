...
@Component({
  selector: 'app-vocabulary-quiz-edit-teacher',
  templateUrl: './vocabulary-quiz-edit-teacher.component.html'
})
export class VocabularyQuizEditTeacherComponent extends AbstractEditController<VocabularyQuizDto, VocabularyQuizCriteria, VocabularyQuizService>   implements OnInit {
