...
@Component({
  selector: 'app-vocabulary-create-teacher',
  templateUrl: './vocabulary-create-teacher.component.html'
})
export class VocabularyCreateTeacherComponent extends AbstractCreateController<VocabularyDto, VocabularyCriteria, VocabularyService>  implements OnInit {
