...
@Component({
  selector: 'app-vocabulary-list-teacher',
  templateUrl: './vocabulary-list-teacher.component.html'
})
export class VocabularyListTeacherComponent extends AbstractListController<VocabularyDto, VocabularyCriteria, VocabularyService>  implements OnInit {
