...
@Component({
  selector: 'app-vocabulary-view-teacher',
  templateUrl: './vocabulary-view-teacher.component.html'
})
export class VocabularyViewTeacherComponent extends AbstractViewController<VocabularyDto, VocabularyCriteria, VocabularyService> implements OnInit {
