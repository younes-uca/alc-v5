...
@Component({
  selector: 'app-vocabulary-edit-teacher',
  templateUrl: './vocabulary-edit-teacher.component.html'
})
export class VocabularyEditTeacherComponent extends AbstractEditController<VocabularyDto, VocabularyCriteria, VocabularyService>   implements OnInit {
