...
@Component({
  selector: 'app-etat-cours-edit-teacher',
  templateUrl: './etat-cours-edit-teacher.component.html'
})
export class EtatCoursEditTeacherComponent extends AbstractEditController<EtatCoursDto, EtatCoursCriteria, EtatCoursService>   implements OnInit {
