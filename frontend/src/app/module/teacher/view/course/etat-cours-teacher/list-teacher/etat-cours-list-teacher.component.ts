...
@Component({
  selector: 'app-etat-cours-list-teacher',
  templateUrl: './etat-cours-list-teacher.component.html'
})
export class EtatCoursListTeacherComponent extends AbstractListController<EtatCoursDto, EtatCoursCriteria, EtatCoursService>  implements OnInit {
