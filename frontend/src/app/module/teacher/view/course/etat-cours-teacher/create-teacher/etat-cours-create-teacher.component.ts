...
@Component({
  selector: 'app-etat-cours-create-teacher',
  templateUrl: './etat-cours-create-teacher.component.html'
})
export class EtatCoursCreateTeacherComponent extends AbstractCreateController<EtatCoursDto, EtatCoursCriteria, EtatCoursService>  implements OnInit {
