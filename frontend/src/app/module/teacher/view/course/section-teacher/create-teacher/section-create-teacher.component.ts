...
@Component({
  selector: 'app-section-create-teacher',
  templateUrl: './section-create-teacher.component.html'
})
export class SectionCreateTeacherComponent extends AbstractCreateController<SectionDto, SectionCriteria, SectionService>  implements OnInit {
