...
@Component({
  selector: 'app-section-list-teacher',
  templateUrl: './section-list-teacher.component.html'
})
export class SectionListTeacherComponent extends AbstractListController<SectionDto, SectionCriteria, SectionService>  implements OnInit {
