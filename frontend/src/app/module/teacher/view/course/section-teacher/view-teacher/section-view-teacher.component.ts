...
@Component({
  selector: 'app-section-view-teacher',
  templateUrl: './section-view-teacher.component.html'
})
export class SectionViewTeacherComponent extends AbstractViewController<SectionDto, SectionCriteria, SectionService> implements OnInit {
