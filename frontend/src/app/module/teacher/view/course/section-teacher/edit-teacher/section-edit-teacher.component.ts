...
@Component({
  selector: 'app-section-edit-teacher',
  templateUrl: './section-edit-teacher.component.html'
})
export class SectionEditTeacherComponent extends AbstractEditController<SectionDto, SectionCriteria, SectionService>   implements OnInit {
