...
@Component({
  selector: 'app-cours-edit-teacher',
  templateUrl: './cours-edit-teacher.component.html'
})
export class CoursEditTeacherComponent extends AbstractEditController<CoursDto, CoursCriteria, CoursService>   implements OnInit {
