...
@Component({
  selector: 'app-cours-create-teacher',
  templateUrl: './cours-create-teacher.component.html'
})
export class CoursCreateTeacherComponent extends AbstractCreateController<CoursDto, CoursCriteria, CoursService>  implements OnInit {
