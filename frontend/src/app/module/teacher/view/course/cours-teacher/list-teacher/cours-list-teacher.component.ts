...
@Component({
  selector: 'app-cours-list-teacher',
  templateUrl: './cours-list-teacher.component.html'
})
export class CoursListTeacherComponent extends AbstractListController<CoursDto, CoursCriteria, CoursService>  implements OnInit {
