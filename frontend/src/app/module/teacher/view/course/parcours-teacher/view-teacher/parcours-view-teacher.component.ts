...
@Component({
  selector: 'app-parcours-view-teacher',
  templateUrl: './parcours-view-teacher.component.html'
})
export class ParcoursViewTeacherComponent extends AbstractViewController<ParcoursDto, ParcoursCriteria, ParcoursService> implements OnInit {
