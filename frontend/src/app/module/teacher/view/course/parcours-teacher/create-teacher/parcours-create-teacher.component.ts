...
@Component({
  selector: 'app-parcours-create-teacher',
  templateUrl: './parcours-create-teacher.component.html'
})
export class ParcoursCreateTeacherComponent extends AbstractCreateController<ParcoursDto, ParcoursCriteria, ParcoursService>  implements OnInit {
   ...
   private _validParcoursLibelle = true;
    ...
    constructor( private parcoursService: ParcoursService , private teacherLocalityService: TeacherLocalityService, private statutSocialService: StatutSocialService, private niveauEtudeService: NiveauEtudeService, private etatCoursService: EtatCoursService, private etatEtudiantScheduleService: EtatEtudiantScheduleService, private skillService: SkillService, private etudiantService: EtudiantService, private centreService: CentreService, private groupeEtudeService: GroupeEtudeService, private groupeEtudiantService: GroupeEtudiantService, private langueService: LangueService, private coursService: CoursService, private interetEtudiantService: InteretEtudiantService, private packStudentService: PackStudentService, private fonctionService: FonctionService) {
