...
@Component({
  selector: 'app-parcours-edit-teacher',
  templateUrl: './parcours-edit-teacher.component.html'
})
export class ParcoursEditTeacherComponent extends AbstractEditController<ParcoursDto, ParcoursCriteria, ParcoursService>   implements OnInit {
