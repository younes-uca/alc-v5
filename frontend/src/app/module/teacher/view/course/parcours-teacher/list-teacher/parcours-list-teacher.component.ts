...
@Component({
  selector: 'app-parcours-list-teacher',
  templateUrl: './parcours-list-teacher.component.html'
})
export class ParcoursListTeacherComponent extends AbstractListController<ParcoursDto, ParcoursCriteria, ParcoursService>  implements OnInit {

    fileName = 'Parcours';

    centres :Array<CentreDto>;
  
    constructor(parcoursService: ParcoursService, private centreService: CentreService) {
