...
@Component({
  selector: 'app-level-test-configuration-create-teacher',
  templateUrl: './level-test-configuration-create-teacher.component.html'
})
export class LevelTestConfigurationCreateTeacherComponent extends AbstractCreateController<LevelTestConfigurationDto, LevelTestConfigurationCriteria, LevelTestConfigurationService>  implements OnInit {
