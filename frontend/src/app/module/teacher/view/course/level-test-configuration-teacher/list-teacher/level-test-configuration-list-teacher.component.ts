...
@Component({
  selector: 'app-level-test-configuration-list-teacher',
  templateUrl: './level-test-configuration-list-teacher.component.html'
})
export class LevelTestConfigurationListTeacherComponent extends AbstractListController<LevelTestConfigurationDto, LevelTestConfigurationCriteria, LevelTestConfigurationService>  implements OnInit {
