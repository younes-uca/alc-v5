...
@Component({
  selector: 'app-level-test-configuration-edit-teacher',
  templateUrl: './level-test-configuration-edit-teacher.component.html'
})
export class LevelTestConfigurationEditTeacherComponent extends AbstractEditController<LevelTestConfigurationDto, LevelTestConfigurationCriteria, LevelTestConfigurationService>   implements OnInit {
