...
@Component({
  selector: 'app-super-categorie-section-edit-teacher',
  templateUrl: './super-categorie-section-edit-teacher.component.html'
})
export class SuperCategorieSectionEditTeacherComponent extends AbstractEditController<SuperCategorieSectionDto, SuperCategorieSectionCriteria, SuperCategorieSectionService>   implements OnInit {
