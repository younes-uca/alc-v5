...
@Component({
  selector: 'app-section-item-list-teacher',
  templateUrl: './section-item-list-teacher.component.html'
})
export class SectionItemListTeacherComponent extends AbstractListController<SectionItemDto, SectionItemCriteria, SectionItemService>  implements OnInit {
