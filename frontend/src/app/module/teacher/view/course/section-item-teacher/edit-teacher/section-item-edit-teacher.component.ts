...
@Component({
  selector: 'app-section-item-edit-teacher',
  templateUrl: './section-item-edit-teacher.component.html'
})
export class SectionItemEditTeacherComponent extends AbstractEditController<SectionItemDto, SectionItemCriteria, SectionItemService>   implements OnInit {
