...
@Component({
  selector: 'app-centre-edit-teacher',
  templateUrl: './centre-edit-teacher.component.html'
})
export class CentreEditTeacherComponent extends AbstractEditController<CentreDto, CentreCriteria, CentreService>   implements OnInit {
