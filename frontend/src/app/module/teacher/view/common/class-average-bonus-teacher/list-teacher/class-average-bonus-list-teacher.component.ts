...
@Component({
  selector: 'app-class-average-bonus-list-teacher',
  templateUrl: './class-average-bonus-list-teacher.component.html'
})
export class ClassAverageBonusListTeacherComponent extends AbstractListController<ClassAverageBonusDto, ClassAverageBonusCriteria, ClassAverageBonusService>  implements OnInit {

    fileName = 'ClassAverageBonus';

  
    constructor(classAverageBonusService: ClassAverageBonusService) {
