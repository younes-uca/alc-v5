...
@Component({
  selector: 'app-class-average-bonus-view-teacher',
  templateUrl: './class-average-bonus-view-teacher.component.html'
})
export class ClassAverageBonusViewTeacherComponent extends AbstractViewController<ClassAverageBonusDto, ClassAverageBonusCriteria, ClassAverageBonusService> implements OnInit {
