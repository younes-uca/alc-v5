...
@Component({
  selector: 'app-class-average-bonus-edit-teacher',
  templateUrl: './class-average-bonus-edit-teacher.component.html'
})
export class ClassAverageBonusEditTeacherComponent extends AbstractEditController<ClassAverageBonusDto, ClassAverageBonusCriteria, ClassAverageBonusService>   implements OnInit {
