...
@Component({
  selector: 'app-class-average-bonus-create-teacher',
  templateUrl: './class-average-bonus-create-teacher.component.html'
})
export class ClassAverageBonusCreateTeacherComponent extends AbstractCreateController<ClassAverageBonusDto, ClassAverageBonusCriteria, ClassAverageBonusService>  implements OnInit {
