...
@Component({
  selector: 'app-contact-edit-teacher',
  templateUrl: './contact-edit-teacher.component.html'
})
export class ContactEditTeacherComponent extends AbstractEditController<ContactDto, ContactCriteria, ContactService>   implements OnInit {
