...
@Component({
  selector: 'app-contact-list-teacher',
  templateUrl: './contact-list-teacher.component.html'
})
export class ContactListTeacherComponent extends AbstractListController<ContactDto, ContactCriteria, ContactService>  implements OnInit {
