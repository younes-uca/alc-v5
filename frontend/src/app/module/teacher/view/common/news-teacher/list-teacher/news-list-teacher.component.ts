...
@Component({
  selector: 'app-news-list-teacher',
  templateUrl: './news-list-teacher.component.html'
})
export class NewsListTeacherComponent extends AbstractListController<NewsDto, NewsCriteria, NewsService>  implements OnInit {
