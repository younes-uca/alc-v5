...
@Component({
  selector: 'app-news-edit-teacher',
  templateUrl: './news-edit-teacher.component.html'
})
export class NewsEditTeacherComponent extends AbstractEditController<NewsDto, NewsCriteria, NewsService>   implements OnInit {
