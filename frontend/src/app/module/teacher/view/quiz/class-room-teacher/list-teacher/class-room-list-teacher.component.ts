...
@Component({
  selector: 'app-class-room-list-teacher',
  templateUrl: './class-room-list-teacher.component.html'
})
export class ClassRoomListTeacherComponent extends AbstractListController<ClassRoomDto, ClassRoomCriteria, ClassRoomService>  implements OnInit {
