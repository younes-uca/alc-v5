...
@Component({
  selector: 'app-class-room-create-teacher',
  templateUrl: './class-room-create-teacher.component.html'
})
export class ClassRoomCreateTeacherComponent extends AbstractCreateController<ClassRoomDto, ClassRoomCriteria, ClassRoomService>  implements OnInit {
