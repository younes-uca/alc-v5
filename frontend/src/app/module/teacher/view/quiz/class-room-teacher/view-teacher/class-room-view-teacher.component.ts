...
@Component({
  selector: 'app-class-room-view-teacher',
  templateUrl: './class-room-view-teacher.component.html'
})
export class ClassRoomViewTeacherComponent extends AbstractViewController<ClassRoomDto, ClassRoomCriteria, ClassRoomService> implements OnInit {
