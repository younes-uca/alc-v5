...
@Component({
  selector: 'app-class-room-edit-teacher',
  templateUrl: './class-room-edit-teacher.component.html'
})
export class ClassRoomEditTeacherComponent extends AbstractEditController<ClassRoomDto, ClassRoomCriteria, ClassRoomService>   implements OnInit {
