...
@Component({
  selector: 'app-reponse-edit-teacher',
  templateUrl: './reponse-edit-teacher.component.html'
})
export class ReponseEditTeacherComponent extends AbstractEditController<ReponseDto, ReponseCriteria, ReponseService>   implements OnInit {
