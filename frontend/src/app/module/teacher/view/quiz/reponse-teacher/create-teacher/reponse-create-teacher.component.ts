...
@Component({
  selector: 'app-reponse-create-teacher',
  templateUrl: './reponse-create-teacher.component.html'
})
export class ReponseCreateTeacherComponent extends AbstractCreateController<ReponseDto, ReponseCriteria, ReponseService>  implements OnInit {
