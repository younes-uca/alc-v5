...
@Component({
  selector: 'app-reponse-view-teacher',
  templateUrl: './reponse-view-teacher.component.html'
})
export class ReponseViewTeacherComponent extends AbstractViewController<ReponseDto, ReponseCriteria, ReponseService> implements OnInit {
