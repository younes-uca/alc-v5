...
@Component({
  selector: 'app-reponse-list-teacher',
  templateUrl: './reponse-list-teacher.component.html'
})
export class ReponseListTeacherComponent extends AbstractListController<ReponseDto, ReponseCriteria, ReponseService>  implements OnInit {
