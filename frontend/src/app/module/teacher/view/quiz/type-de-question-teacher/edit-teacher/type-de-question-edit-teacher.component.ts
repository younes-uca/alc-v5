...
@Component({
  selector: 'app-type-de-question-edit-teacher',
  templateUrl: './type-de-question-edit-teacher.component.html'
})
export class TypeDeQuestionEditTeacherComponent extends AbstractEditController<TypeDeQuestionDto, TypeDeQuestionCriteria, TypeDeQuestionService>   implements OnInit {
