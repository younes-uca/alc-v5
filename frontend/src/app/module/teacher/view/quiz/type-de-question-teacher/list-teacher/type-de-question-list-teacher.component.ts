...
@Component({
  selector: 'app-type-de-question-list-teacher',
  templateUrl: './type-de-question-list-teacher.component.html'
})
export class TypeDeQuestionListTeacherComponent extends AbstractListController<TypeDeQuestionDto, TypeDeQuestionCriteria, TypeDeQuestionService>  implements OnInit {
