...
@Component({
  selector: 'app-type-de-question-create-teacher',
  templateUrl: './type-de-question-create-teacher.component.html'
})
export class TypeDeQuestionCreateTeacherComponent extends AbstractCreateController<TypeDeQuestionDto, TypeDeQuestionCriteria, TypeDeQuestionService>  implements OnInit {
