...
@Component({
  selector: 'app-etat-reponse-view-teacher',
  templateUrl: './etat-reponse-view-teacher.component.html'
})
export class EtatReponseViewTeacherComponent extends AbstractViewController<EtatReponseDto, EtatReponseCriteria, EtatReponseService> implements OnInit {
