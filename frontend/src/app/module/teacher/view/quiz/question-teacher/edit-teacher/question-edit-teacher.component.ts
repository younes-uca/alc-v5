...
@Component({
  selector: 'app-question-edit-teacher',
  templateUrl: './question-edit-teacher.component.html'
})
export class QuestionEditTeacherComponent extends AbstractEditController<QuestionDto, QuestionCriteria, QuestionService>   implements OnInit {
