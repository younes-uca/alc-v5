...
@Component({
  selector: 'app-question-create-teacher',
  templateUrl: './question-create-teacher.component.html'
})
export class QuestionCreateTeacherComponent extends AbstractCreateController<QuestionDto, QuestionCriteria, QuestionService>  implements OnInit {
   ...
   private _validQuestionRef = true;
    ...
    constructor( private questionService: QuestionService , private typeDeQuestionService: TypeDeQuestionService, private reponseService: ReponseService, private etatReponseService: EtatReponseService, private quizService: QuizService, private homeWorkService: HomeWorkService) {
