...
@Component({
  selector: 'app-question-list-teacher',
  templateUrl: './question-list-teacher.component.html'
})
export class QuestionListTeacherComponent extends AbstractListController<QuestionDto, QuestionCriteria, QuestionService>  implements OnInit {
