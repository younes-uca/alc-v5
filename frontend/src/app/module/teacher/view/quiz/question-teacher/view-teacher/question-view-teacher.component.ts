...
@Component({
  selector: 'app-question-view-teacher',
  templateUrl: './question-view-teacher.component.html'
})
export class QuestionViewTeacherComponent extends AbstractViewController<QuestionDto, QuestionCriteria, QuestionService> implements OnInit {
