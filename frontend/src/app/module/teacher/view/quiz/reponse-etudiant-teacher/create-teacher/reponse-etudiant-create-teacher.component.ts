...
@Component({
  selector: 'app-reponse-etudiant-create-teacher',
  templateUrl: './reponse-etudiant-create-teacher.component.html'
})
export class ReponseEtudiantCreateTeacherComponent extends AbstractCreateController<ReponseEtudiantDto, ReponseEtudiantCriteria, ReponseEtudiantService>  implements OnInit {
