...
@Component({
  selector: 'app-reponse-etudiant-list-teacher',
  templateUrl: './reponse-etudiant-list-teacher.component.html'
})
export class ReponseEtudiantListTeacherComponent extends AbstractListController<ReponseEtudiantDto, ReponseEtudiantCriteria, ReponseEtudiantService>  implements OnInit {
