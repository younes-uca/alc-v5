...
@Component({
  selector: 'app-reponse-etudiant-edit-teacher',
  templateUrl: './reponse-etudiant-edit-teacher.component.html'
})
export class ReponseEtudiantEditTeacherComponent extends AbstractEditController<ReponseEtudiantDto, ReponseEtudiantCriteria, ReponseEtudiantService>   implements OnInit {
