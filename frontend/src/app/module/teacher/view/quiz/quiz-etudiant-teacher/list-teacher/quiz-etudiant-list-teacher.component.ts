...
@Component({
  selector: 'app-quiz-etudiant-list-teacher',
  templateUrl: './quiz-etudiant-list-teacher.component.html'
})
export class QuizEtudiantListTeacherComponent extends AbstractListController<QuizEtudiantDto, QuizEtudiantCriteria, QuizEtudiantService>  implements OnInit {
