...
@Component({
  selector: 'app-quiz-etudiant-view-teacher',
  templateUrl: './quiz-etudiant-view-teacher.component.html'
})
export class QuizEtudiantViewTeacherComponent extends AbstractViewController<QuizEtudiantDto, QuizEtudiantCriteria, QuizEtudiantService> implements OnInit {
