...
@Component({
  selector: 'app-quiz-etudiant-edit-teacher',
  templateUrl: './quiz-etudiant-edit-teacher.component.html'
})
export class QuizEtudiantEditTeacherComponent extends AbstractEditController<QuizEtudiantDto, QuizEtudiantCriteria, QuizEtudiantService>   implements OnInit {
