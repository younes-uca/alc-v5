...
@Component({
  selector: 'app-quiz-view-teacher',
  templateUrl: './quiz-view-teacher.component.html'
})
export class QuizViewTeacherComponent extends AbstractViewController<QuizDto, QuizCriteria, QuizService> implements OnInit {
