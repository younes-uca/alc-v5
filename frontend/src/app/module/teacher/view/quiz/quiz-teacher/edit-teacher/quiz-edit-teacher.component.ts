...
@Component({
  selector: 'app-quiz-edit-teacher',
  templateUrl: './quiz-edit-teacher.component.html'
})
export class QuizEditTeacherComponent extends AbstractEditController<QuizDto, QuizCriteria, QuizService>   implements OnInit {
