...
@Component({
  ...
  templateUrl: './quiz-list-teacher.component.html'
})
export class QuizListTeacherComponent extends AbstractListController<QuizDto, QuizCriteria, QuizService>  implements OnInit {
