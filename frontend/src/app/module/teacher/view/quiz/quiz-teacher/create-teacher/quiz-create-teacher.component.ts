...
@Component({
  selector: 'app-quiz-create-teacher',
  templateUrl: './quiz-create-teacher.component.html'
})
export class QuizCreateTeacherComponent extends AbstractCreateController<QuizDto, QuizCriteria, QuizService>  implements OnInit {
