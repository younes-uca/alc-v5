...
@Component({
  selector: 'app-faq-type-edit-teacher',
  templateUrl: './faq-type-edit-teacher.component.html'
})
export class FaqTypeEditTeacherComponent extends AbstractEditController<FaqTypeDto, FaqTypeCriteria, FaqTypeService>   implements OnInit {
