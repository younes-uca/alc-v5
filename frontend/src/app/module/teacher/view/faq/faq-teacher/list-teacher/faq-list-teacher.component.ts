...
@Component({
  selector: 'app-faq-list-teacher',
  templateUrl: './faq-list-teacher.component.html'
})
export class FaqListTeacherComponent extends AbstractListController<FaqDto, FaqCriteria, FaqService>  implements OnInit {
