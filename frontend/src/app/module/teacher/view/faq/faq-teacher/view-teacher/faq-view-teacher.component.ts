...
@Component({
  selector: 'app-faq-view-teacher',
  templateUrl: './faq-view-teacher.component.html'
})
export class FaqViewTeacherComponent extends AbstractViewController<FaqDto, FaqCriteria, FaqService> implements OnInit {
