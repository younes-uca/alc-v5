...
@Component({
  selector: 'app-faq-create-teacher',
  templateUrl: './faq-create-teacher.component.html'
})
export class FaqCreateTeacherComponent extends AbstractCreateController<FaqDto, FaqCriteria, FaqService>  implements OnInit {
