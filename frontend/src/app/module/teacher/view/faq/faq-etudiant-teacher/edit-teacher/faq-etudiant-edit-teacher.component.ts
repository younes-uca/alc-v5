...
@Component({
  selector: 'app-faq-etudiant-edit-teacher',
  templateUrl: './faq-etudiant-edit-teacher.component.html'
})
export class FaqEtudiantEditTeacherComponent extends AbstractEditController<FaqEtudiantDto, FaqEtudiantCriteria, FaqEtudiantService>   implements OnInit {
