...
@Component({
  selector: 'app-faq-etudiant-view-teacher',
  templateUrl: './faq-etudiant-view-teacher.component.html'
})
export class FaqEtudiantViewTeacherComponent extends AbstractViewController<FaqEtudiantDto, FaqEtudiantCriteria, FaqEtudiantService> implements OnInit {
