...
@Component({
  selector: 'app-faq-etudiant-create-teacher',
  templateUrl: './faq-etudiant-create-teacher.component.html'
})
export class FaqEtudiantCreateTeacherComponent extends AbstractCreateController<FaqEtudiantDto, FaqEtudiantCriteria, FaqEtudiantService>  implements OnInit {
