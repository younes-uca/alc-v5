...
@Component({
  selector: 'app-faq-etudiant-list-teacher',
  templateUrl: './faq-etudiant-list-teacher.component.html'
})
export class FaqEtudiantListTeacherComponent extends AbstractListController<FaqEtudiantDto, FaqEtudiantCriteria, FaqEtudiantService>  implements OnInit {
