...
@Component({
  selector: 'app-faq-prof-create-teacher',
  templateUrl: './faq-prof-create-teacher.component.html'
})
export class FaqProfCreateTeacherComponent extends AbstractCreateController<FaqProfDto, FaqProfCriteria, FaqProfService>  implements OnInit {
