...
@Component({
  selector: 'app-faq-prof-view-teacher',
  templateUrl: './faq-prof-view-teacher.component.html'
})
export class FaqProfViewTeacherComponent extends AbstractViewController<FaqProfDto, FaqProfCriteria, FaqProfService> implements OnInit {
