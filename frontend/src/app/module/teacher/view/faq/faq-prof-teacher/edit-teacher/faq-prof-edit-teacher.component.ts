...
@Component({
  selector: 'app-faq-prof-edit-teacher',
  templateUrl: './faq-prof-edit-teacher.component.html'
})
export class FaqProfEditTeacherComponent extends AbstractEditController<FaqProfDto, FaqProfCriteria, FaqProfService>   implements OnInit {
