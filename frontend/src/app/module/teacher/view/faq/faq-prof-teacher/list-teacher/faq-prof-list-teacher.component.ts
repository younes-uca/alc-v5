...
@Component({
  selector: 'app-faq-prof-list-teacher',
  templateUrl: './faq-prof-list-teacher.component.html'
})
export class FaqProfListTeacherComponent extends AbstractListController<FaqProfDto, FaqProfCriteria, FaqProfService>  implements OnInit {
