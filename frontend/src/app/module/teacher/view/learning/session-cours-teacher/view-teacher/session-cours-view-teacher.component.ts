...
@Component({
  selector: 'app-session-cours-view-teacher',
  templateUrl: './session-cours-view-teacher.component.html'
})
export class SessionCoursViewTeacherComponent extends AbstractViewController<SessionCoursDto, SessionCoursCriteria, SessionCoursService> implements OnInit {
