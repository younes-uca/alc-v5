...
@Component({
  selector: 'app-session-cours-create-teacher',
  templateUrl: './session-cours-create-teacher.component.html'
})
export class SessionCoursCreateTeacherComponent extends AbstractCreateController<SessionCoursDto, SessionCoursCriteria, SessionCoursService>  implements OnInit {
