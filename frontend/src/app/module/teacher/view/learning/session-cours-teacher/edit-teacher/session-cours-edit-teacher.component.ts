...
@Component({
  selector: 'app-session-cours-edit-teacher',
  templateUrl: './session-cours-edit-teacher.component.html'
})
export class SessionCoursEditTeacherComponent extends AbstractEditController<SessionCoursDto, SessionCoursCriteria, SessionCoursService>   implements OnInit {
