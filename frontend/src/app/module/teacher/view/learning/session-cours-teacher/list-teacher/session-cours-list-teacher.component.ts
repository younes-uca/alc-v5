...
@Component({
  selector: 'app-session-cours-list-teacher',
  templateUrl: './session-cours-list-teacher.component.html'
})
export class SessionCoursListTeacherComponent extends AbstractListController<SessionCoursDto, SessionCoursCriteria, SessionCoursService>  implements OnInit {
