...
@Component({
  selector: 'app-confirmation-token-edit-teacher',
  templateUrl: './confirmation-token-edit-teacher.component.html'
})
export class ConfirmationTokenEditTeacherComponent extends AbstractEditController<ConfirmationTokenDto, ConfirmationTokenCriteria, ConfirmationTokenService>   implements OnInit {
