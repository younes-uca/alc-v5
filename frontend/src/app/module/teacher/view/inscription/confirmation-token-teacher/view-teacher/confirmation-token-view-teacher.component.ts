...
@Component({
  selector: 'app-confirmation-token-view-teacher',
  templateUrl: './confirmation-token-view-teacher.component.html'
})
export class ConfirmationTokenViewTeacherComponent extends AbstractViewController<ConfirmationTokenDto, ConfirmationTokenCriteria, ConfirmationTokenService> implements OnInit {
