...
@Component({
  selector: 'app-confirmation-token-create-teacher',
  templateUrl: './confirmation-token-create-teacher.component.html'
})
export class ConfirmationTokenCreateTeacherComponent extends AbstractCreateController<ConfirmationTokenDto, ConfirmationTokenCriteria, ConfirmationTokenService>  implements OnInit {
