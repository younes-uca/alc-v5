...
@Component({
  selector: 'app-teacher-locality-create-teacher',
  templateUrl: './teacher-locality-create-teacher.component.html'
})
export class TeacherLocalityCreateTeacherComponent extends AbstractCreateController<TeacherLocalityDto, TeacherLocalityCriteria, TeacherLocalityService>  implements OnInit {
