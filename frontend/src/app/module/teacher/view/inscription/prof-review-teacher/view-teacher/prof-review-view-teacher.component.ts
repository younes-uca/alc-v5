...
@Component({
  selector: 'app-prof-review-view-teacher',
  templateUrl: './prof-review-view-teacher.component.html'
})
export class ProfReviewViewTeacherComponent extends AbstractViewController<ProfReviewDto, ProfReviewCriteria, ProfReviewService> implements OnInit {
