...
@Component({
  selector: 'app-prof-review-list-teacher',
  templateUrl: './prof-review-list-teacher.component.html'
})
export class ProfReviewListTeacherComponent extends AbstractListController<ProfReviewDto, ProfReviewCriteria, ProfReviewService>  implements OnInit {
