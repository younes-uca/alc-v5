...
@Component({
  selector: 'app-prof-review-edit-teacher',
  templateUrl: './prof-review-edit-teacher.component.html'
})
export class ProfReviewEditTeacherComponent extends AbstractEditController<ProfReviewDto, ProfReviewCriteria, ProfReviewService>   implements OnInit {
