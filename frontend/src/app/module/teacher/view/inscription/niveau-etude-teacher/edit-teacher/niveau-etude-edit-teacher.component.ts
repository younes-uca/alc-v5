...
@Component({
  selector: 'app-niveau-etude-edit-teacher',
  templateUrl: './niveau-etude-edit-teacher.component.html'
})
export class NiveauEtudeEditTeacherComponent extends AbstractEditController<NiveauEtudeDto, NiveauEtudeCriteria, NiveauEtudeService>   implements OnInit {
