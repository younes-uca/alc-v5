...
@Component({
  selector: 'app-niveau-etude-list-teacher',
  templateUrl: './niveau-etude-list-teacher.component.html'
})
export class NiveauEtudeListTeacherComponent extends AbstractListController<NiveauEtudeDto, NiveauEtudeCriteria, NiveauEtudeService>  implements OnInit {
