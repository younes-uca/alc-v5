...
@Component({
  selector: 'app-niveau-etude-create-teacher',
  templateUrl: './niveau-etude-create-teacher.component.html'
})
export class NiveauEtudeCreateTeacherComponent extends AbstractCreateController<NiveauEtudeDto, NiveauEtudeCriteria, NiveauEtudeService>  implements OnInit {
