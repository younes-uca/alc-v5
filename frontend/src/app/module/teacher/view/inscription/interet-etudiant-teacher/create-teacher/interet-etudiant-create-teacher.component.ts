...
@Component({
  selector: 'app-interet-etudiant-create-teacher',
  templateUrl: './interet-etudiant-create-teacher.component.html'
})
export class InteretEtudiantCreateTeacherComponent extends AbstractCreateController<InteretEtudiantDto, InteretEtudiantCriteria, InteretEtudiantService>  implements OnInit {
