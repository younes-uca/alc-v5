...
@Component({
  selector: 'app-interet-etudiant-edit-teacher',
  templateUrl: './interet-etudiant-edit-teacher.component.html'
})
export class InteretEtudiantEditTeacherComponent extends AbstractEditController<InteretEtudiantDto, InteretEtudiantCriteria, InteretEtudiantService>   implements OnInit {
