...
@Component({
  selector: 'app-interet-etudiant-list-teacher',
  templateUrl: './interet-etudiant-list-teacher.component.html'
})
export class InteretEtudiantListTeacherComponent extends AbstractListController<InteretEtudiantDto, InteretEtudiantCriteria, InteretEtudiantService>  implements OnInit {
