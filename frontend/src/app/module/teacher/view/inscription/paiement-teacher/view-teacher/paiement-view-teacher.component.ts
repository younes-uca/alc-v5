...
@Component({
  selector: 'app-paiement-view-teacher',
  templateUrl: './paiement-view-teacher.component.html'
})
export class PaiementViewTeacherComponent extends AbstractViewController<PaiementDto, PaiementCriteria, PaiementService> implements OnInit {
