...
@Component({
  selector: 'app-paiement-list-teacher',
  templateUrl: './paiement-list-teacher.component.html'
})
export class PaiementListTeacherComponent extends AbstractListController<PaiementDto, PaiementCriteria, PaiementService>  implements OnInit {
