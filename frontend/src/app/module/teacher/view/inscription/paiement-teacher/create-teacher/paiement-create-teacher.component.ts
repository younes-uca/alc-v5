...
@Component({
  selector: 'app-paiement-create-teacher',
  templateUrl: './paiement-create-teacher.component.html'
})
export class PaiementCreateTeacherComponent extends AbstractCreateController<PaiementDto, PaiementCriteria, PaiementService>  implements OnInit {
