...
@Component({
  selector: 'app-paiement-edit-teacher',
  templateUrl: './paiement-edit-teacher.component.html'
})
export class PaiementEditTeacherComponent extends AbstractEditController<PaiementDto, PaiementCriteria, PaiementService>   implements OnInit {
