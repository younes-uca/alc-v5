...
@Component({
  selector: 'app-groupe-etude-create-teacher',
  templateUrl: './groupe-etude-create-teacher.component.html'
})
export class GroupeEtudeCreateTeacherComponent extends AbstractCreateController<GroupeEtudeDto, GroupeEtudeCriteria, GroupeEtudeService>  implements OnInit {
