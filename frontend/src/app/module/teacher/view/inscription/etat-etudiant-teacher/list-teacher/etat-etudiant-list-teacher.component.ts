...
@Component({
  selector: 'app-etat-etudiant-list-teacher',
  templateUrl: './etat-etudiant-list-teacher.component.html'
})
export class EtatEtudiantListTeacherComponent extends AbstractListController<EtatEtudiantDto, EtatEtudiantCriteria, EtatEtudiantService>  implements OnInit {
