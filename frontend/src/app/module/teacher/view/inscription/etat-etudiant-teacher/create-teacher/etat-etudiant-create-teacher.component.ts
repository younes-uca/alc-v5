...
@Component({
  selector: 'app-etat-etudiant-create-teacher',
  templateUrl: './etat-etudiant-create-teacher.component.html'
})
export class EtatEtudiantCreateTeacherComponent extends AbstractCreateController<EtatEtudiantDto, EtatEtudiantCriteria, EtatEtudiantService>  implements OnInit {
