...
@Component({
  selector: 'app-etat-etudiant-edit-teacher',
  templateUrl: './etat-etudiant-edit-teacher.component.html'
})
export class EtatEtudiantEditTeacherComponent extends AbstractEditController<EtatEtudiantDto, EtatEtudiantCriteria, EtatEtudiantService>   implements OnInit {
