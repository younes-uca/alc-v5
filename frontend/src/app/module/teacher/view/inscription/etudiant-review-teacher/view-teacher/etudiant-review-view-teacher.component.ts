...
@Component({
  selector: 'app-etudiant-review-view-teacher',
  templateUrl: './etudiant-review-view-teacher.component.html'
})
export class EtudiantReviewViewTeacherComponent extends AbstractViewController<EtudiantReviewDto, EtudiantReviewCriteria, EtudiantReviewService> implements OnInit {
