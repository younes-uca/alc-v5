...
@Component({
  selector: 'app-etudiant-review-edit-teacher',
  templateUrl: './etudiant-review-edit-teacher.component.html'
})
export class EtudiantReviewEditTeacherComponent extends AbstractEditController<EtudiantReviewDto, EtudiantReviewCriteria, EtudiantReviewService>   implements OnInit {
