...
@Component({
  selector: 'app-etudiant-review-create-teacher',
  templateUrl: './etudiant-review-create-teacher.component.html'
})
export class EtudiantReviewCreateTeacherComponent extends AbstractCreateController<EtudiantReviewDto, EtudiantReviewCriteria, EtudiantReviewService>  implements OnInit {
