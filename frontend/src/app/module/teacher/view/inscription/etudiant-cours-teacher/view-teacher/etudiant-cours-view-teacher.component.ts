...
@Component({
  selector: 'app-etudiant-cours-view-teacher',
  templateUrl: './etudiant-cours-view-teacher.component.html'
})
export class EtudiantCoursViewTeacherComponent extends AbstractViewController<EtudiantCoursDto, EtudiantCoursCriteria, EtudiantCoursService> implements OnInit {
