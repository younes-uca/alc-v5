...
@Component({
  selector: 'app-etudiant-cours-create-teacher',
  templateUrl: './etudiant-cours-create-teacher.component.html'
})
export class EtudiantCoursCreateTeacherComponent extends AbstractCreateController<EtudiantCoursDto, EtudiantCoursCriteria, EtudiantCoursService>  implements OnInit {
