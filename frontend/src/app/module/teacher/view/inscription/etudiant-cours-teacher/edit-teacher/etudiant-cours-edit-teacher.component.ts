...
@Component({
  selector: 'app-etudiant-cours-edit-teacher',
  templateUrl: './etudiant-cours-edit-teacher.component.html'
})
export class EtudiantCoursEditTeacherComponent extends AbstractEditController<EtudiantCoursDto, EtudiantCoursCriteria, EtudiantCoursService>   implements OnInit {
