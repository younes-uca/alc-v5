...
@Component({
  selector: 'app-etudiant-cours-list-teacher',
  templateUrl: './etudiant-cours-list-teacher.component.html'
})
export class EtudiantCoursListTeacherComponent extends AbstractListController<EtudiantCoursDto, EtudiantCoursCriteria, EtudiantCoursService>  implements OnInit {
