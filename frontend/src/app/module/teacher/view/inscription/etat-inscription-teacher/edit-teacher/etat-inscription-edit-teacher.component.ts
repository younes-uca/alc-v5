...
@Component({
  selector: 'app-etat-inscription-edit-teacher',
  templateUrl: './etat-inscription-edit-teacher.component.html'
})
export class EtatInscriptionEditTeacherComponent extends AbstractEditController<EtatInscriptionDto, EtatInscriptionCriteria, EtatInscriptionService>   implements OnInit {
