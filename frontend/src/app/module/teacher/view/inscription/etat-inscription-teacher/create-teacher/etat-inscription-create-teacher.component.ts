...
@Component({
  selector: 'app-etat-inscription-create-teacher',
  templateUrl: './etat-inscription-create-teacher.component.html'
})
export class EtatInscriptionCreateTeacherComponent extends AbstractCreateController<EtatInscriptionDto, EtatInscriptionCriteria, EtatInscriptionService>  implements OnInit {
