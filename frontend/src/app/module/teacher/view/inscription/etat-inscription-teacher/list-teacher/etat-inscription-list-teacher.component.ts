...
@Component({
  selector: 'app-etat-inscription-list-teacher',
  templateUrl: './etat-inscription-list-teacher.component.html'
})
export class EtatInscriptionListTeacherComponent extends AbstractListController<EtatInscriptionDto, EtatInscriptionCriteria, EtatInscriptionService>  implements OnInit {
