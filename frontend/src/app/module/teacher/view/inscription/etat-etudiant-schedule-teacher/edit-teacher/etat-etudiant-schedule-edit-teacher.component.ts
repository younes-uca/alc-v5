...
@Component({
  selector: 'app-etat-etudiant-schedule-edit-teacher',
  templateUrl: './etat-etudiant-schedule-edit-teacher.component.html'
})
export class EtatEtudiantScheduleEditTeacherComponent extends AbstractEditController<EtatEtudiantScheduleDto, EtatEtudiantScheduleCriteria, EtatEtudiantScheduleService>   implements OnInit {
