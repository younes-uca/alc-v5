...
@Component({
  selector: 'app-etat-etudiant-schedule-create-teacher',
  templateUrl: './etat-etudiant-schedule-create-teacher.component.html'
})
export class EtatEtudiantScheduleCreateTeacherComponent extends AbstractCreateController<EtatEtudiantScheduleDto, EtatEtudiantScheduleCriteria, EtatEtudiantScheduleService>  implements OnInit {
