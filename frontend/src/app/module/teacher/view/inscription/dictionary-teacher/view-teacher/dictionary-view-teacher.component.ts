...
@Component({
  selector: 'app-dictionary-view-teacher',
  templateUrl: './dictionary-view-teacher.component.html'
})
export class DictionaryViewTeacherComponent extends AbstractViewController<DictionaryDto, DictionaryCriteria, DictionaryService> implements OnInit {
