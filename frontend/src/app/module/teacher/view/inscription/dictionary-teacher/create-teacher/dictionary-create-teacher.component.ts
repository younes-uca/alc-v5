...
@Component({
  selector: 'app-dictionary-create-teacher',
  templateUrl: './dictionary-create-teacher.component.html'
})
export class DictionaryCreateTeacherComponent extends AbstractCreateController<DictionaryDto, DictionaryCriteria, DictionaryService>  implements OnInit {
