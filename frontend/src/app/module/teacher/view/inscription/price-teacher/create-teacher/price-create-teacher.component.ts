...
@Component({
  selector: 'app-price-create-teacher',
  templateUrl: './price-create-teacher.component.html'
})
export class PriceCreateTeacherComponent extends AbstractCreateController<PriceDto, PriceCriteria, PriceService>  implements OnInit {
