...
@Component({
  selector: 'app-price-edit-teacher',
  templateUrl: './price-edit-teacher.component.html'
})
export class PriceEditTeacherComponent extends AbstractEditController<PriceDto, PriceCriteria, PriceService>   implements OnInit {
