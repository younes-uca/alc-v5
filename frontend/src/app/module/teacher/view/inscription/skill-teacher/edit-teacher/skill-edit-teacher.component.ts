...
@Component({
  selector: 'app-skill-edit-teacher',
  templateUrl: './skill-edit-teacher.component.html'
})
export class SkillEditTeacherComponent extends AbstractEditController<SkillDto, SkillCriteria, SkillService>   implements OnInit {
