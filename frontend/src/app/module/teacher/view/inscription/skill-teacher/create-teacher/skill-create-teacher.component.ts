...
@Component({
  selector: 'app-skill-create-teacher',
  templateUrl: './skill-create-teacher.component.html'
})
export class SkillCreateTeacherComponent extends AbstractCreateController<SkillDto, SkillCriteria, SkillService>  implements OnInit {
