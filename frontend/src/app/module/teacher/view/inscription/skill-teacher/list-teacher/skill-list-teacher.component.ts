...
@Component({
  selector: 'app-skill-list-teacher',
  templateUrl: './skill-list-teacher.component.html'
})
export class SkillListTeacherComponent extends AbstractListController<SkillDto, SkillCriteria, SkillService>  implements OnInit {
