...
@Component({
  selector: 'app-pack-student-view-teacher',
  templateUrl: './pack-student-view-teacher.component.html'
})
export class PackStudentViewTeacherComponent extends AbstractViewController<PackStudentDto, PackStudentCriteria, PackStudentService> implements OnInit {
