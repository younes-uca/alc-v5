...
@Component({
  selector: 'app-pack-student-list-teacher',
  templateUrl: './pack-student-list-teacher.component.html'
})
export class PackStudentListTeacherComponent extends AbstractListController<PackStudentDto, PackStudentCriteria, PackStudentService>  implements OnInit {
    ...
    constructor(packStudentService: PackStudentService, private parcoursService: ParcoursService, private priceService: PriceService) {
