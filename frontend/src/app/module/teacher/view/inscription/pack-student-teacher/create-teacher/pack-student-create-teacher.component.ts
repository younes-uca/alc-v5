...
@Component({
  selector: 'app-pack-student-create-teacher',
  templateUrl: './pack-student-create-teacher.component.html'
})
export class PackStudentCreateTeacherComponent extends AbstractCreateController<PackStudentDto, PackStudentCriteria, PackStudentService>  implements OnInit {
