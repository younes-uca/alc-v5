...
@Component({
  selector: 'app-pack-student-edit-teacher',
  templateUrl: './pack-student-edit-teacher.component.html'
})
export class PackStudentEditTeacherComponent extends AbstractEditController<PackStudentDto, PackStudentCriteria, PackStudentService>   implements OnInit {
