...
@Component({
  selector: 'app-fonction-view-teacher',
  templateUrl: './fonction-view-teacher.component.html'
})
export class FonctionViewTeacherComponent extends AbstractViewController<FonctionDto, FonctionCriteria, FonctionService> implements OnInit {
