...
@Component({
  selector: 'app-fonction-edit-teacher',
  templateUrl: './fonction-edit-teacher.component.html'
})
export class FonctionEditTeacherComponent extends AbstractEditController<FonctionDto, FonctionCriteria, FonctionService>   implements OnInit {
