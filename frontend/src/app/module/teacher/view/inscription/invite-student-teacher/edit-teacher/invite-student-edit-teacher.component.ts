...
@Component({
  selector: 'app-invite-student-edit-teacher',
  templateUrl: './invite-student-edit-teacher.component.html'
})
export class InviteStudentEditTeacherComponent extends AbstractEditController<InviteStudentDto, InviteStudentCriteria, InviteStudentService>   implements OnInit {
