...
@Component({
  selector: 'app-invite-student-list-teacher',
  templateUrl: './invite-student-list-teacher.component.html'
})
export class InviteStudentListTeacherComponent extends AbstractListController<InviteStudentDto, InviteStudentCriteria, InviteStudentService>  implements OnInit {
