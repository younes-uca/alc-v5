...
@Component({
  selector: 'app-statut-social-edit-teacher',
  templateUrl: './statut-social-edit-teacher.component.html'
})
export class StatutSocialEditTeacherComponent extends AbstractEditController<StatutSocialDto, StatutSocialCriteria, StatutSocialService>   implements OnInit {
