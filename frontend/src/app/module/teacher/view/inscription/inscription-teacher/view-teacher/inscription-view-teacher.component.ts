...
@Component({
  selector: 'app-inscription-view-teacher',
  templateUrl: './inscription-view-teacher.component.html'
})
export class InscriptionViewTeacherComponent extends AbstractViewController<InscriptionDto, InscriptionCriteria, InscriptionService> implements OnInit {
