...
@Component({
  selector: 'app-inscription-list-teacher',
  templateUrl: './inscription-list-teacher.component.html'
})
export class InscriptionListTeacherComponent extends AbstractListController<InscriptionDto, InscriptionCriteria, InscriptionService>  implements OnInit {
