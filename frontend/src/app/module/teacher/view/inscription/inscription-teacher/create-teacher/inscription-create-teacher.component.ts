...
@Component({
  selector: 'app-inscription-create-teacher',
  templateUrl: './inscription-create-teacher.component.html'
})
export class InscriptionCreateTeacherComponent extends AbstractCreateController<InscriptionDto, InscriptionCriteria, InscriptionService>  implements OnInit {
