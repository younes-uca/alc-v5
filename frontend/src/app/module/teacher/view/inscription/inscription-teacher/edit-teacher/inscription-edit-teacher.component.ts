...
@Component({
  selector: 'app-inscription-edit-teacher',
  templateUrl: './inscription-edit-teacher.component.html'
})
export class InscriptionEditTeacherComponent extends AbstractEditController<InscriptionDto, InscriptionCriteria, InscriptionService>   implements OnInit {
