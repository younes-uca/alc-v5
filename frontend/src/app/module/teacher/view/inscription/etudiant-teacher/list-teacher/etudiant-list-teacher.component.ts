...
@Component({
  selector: 'app-etudiant-list-teacher',
  templateUrl: './etudiant-list-teacher.component.html'
})
export class EtudiantListTeacherComponent extends AbstractListController<EtudiantDto, EtudiantCriteria, EtudiantService>  implements OnInit {
