...
@Component({
  selector: 'app-etudiant-create-teacher',
  templateUrl: './etudiant-create-teacher.component.html'
})
export class EtudiantCreateTeacherComponent extends AbstractCreateController<EtudiantDto, EtudiantCriteria, EtudiantService>  implements OnInit {
   ...
   private _validEtudiantRef = true;
    ...
    constructor( private etudiantService: EtudiantService , private groupeEtudiantDetailService: GroupeEtudiantDetailService, private teacherLocalityService: TeacherLocalityService, private parcoursService: ParcoursService, private statutSocialService: StatutSocialService, private niveauEtudeService: NiveauEtudeService, private etatEtudiantScheduleService: EtatEtudiantScheduleService, private quizService: QuizService, private skillService: SkillService, private quizEtudiantService: QuizEtudiantService, private groupeEtudeService: GroupeEtudeService, private groupeEtudiantService: GroupeEtudiantService, private langueService: LangueService, private interetEtudiantService: InteretEtudiantService, private packStudentService: PackStudentService, private fonctionService: FonctionService) {
