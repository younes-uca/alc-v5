...
@Component({
  selector: 'app-etudiant-view-teacher',
  templateUrl: './etudiant-view-teacher.component.html'
})
export class EtudiantViewTeacherComponent extends AbstractViewController<EtudiantDto, EtudiantCriteria, EtudiantService> implements OnInit {
