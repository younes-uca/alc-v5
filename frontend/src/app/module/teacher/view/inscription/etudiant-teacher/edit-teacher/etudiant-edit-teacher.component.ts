...
@Component({
  selector: 'app-etudiant-edit-teacher',
  templateUrl: './etudiant-edit-teacher.component.html'
})
export class EtudiantEditTeacherComponent extends AbstractEditController<EtudiantDto, EtudiantCriteria, EtudiantService>   implements OnInit {
