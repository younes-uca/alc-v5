...
@Component({
  selector: 'app-groupe-etudiant-create-teacher',
  templateUrl: './groupe-etudiant-create-teacher.component.html'
})
export class GroupeEtudiantCreateTeacherComponent extends AbstractCreateController<GroupeEtudiantDto, GroupeEtudiantCriteria, GroupeEtudiantService>  implements OnInit {
