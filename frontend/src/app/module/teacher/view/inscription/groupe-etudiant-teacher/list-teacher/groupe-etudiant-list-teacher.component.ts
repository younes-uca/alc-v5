...
@Component({
  selector: 'app-groupe-etudiant-list-teacher',
  templateUrl: './groupe-etudiant-list-teacher.component.html'
})
export class GroupeEtudiantListTeacherComponent extends AbstractListController<GroupeEtudiantDto, GroupeEtudiantCriteria, GroupeEtudiantService>  implements OnInit {
