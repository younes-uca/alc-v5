...
@Component({
  selector: 'app-groupe-etudiant-edit-teacher',
  templateUrl: './groupe-etudiant-edit-teacher.component.html'
})
export class GroupeEtudiantEditTeacherComponent extends AbstractEditController<GroupeEtudiantDto, GroupeEtudiantCriteria, GroupeEtudiantService>   implements OnInit {
