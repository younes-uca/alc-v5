...
@Component({
  selector: 'app-groupe-etudiant-view-teacher',
  templateUrl: './groupe-etudiant-view-teacher.component.html'
})
export class GroupeEtudiantViewTeacherComponent extends AbstractViewController<GroupeEtudiantDto, GroupeEtudiantCriteria, GroupeEtudiantService> implements OnInit {
