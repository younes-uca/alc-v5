...
@Component({
  selector: 'app-langue-create-teacher',
  templateUrl: './langue-create-teacher.component.html'
})
export class LangueCreateTeacherComponent extends AbstractCreateController<LangueDto, LangueCriteria, LangueService>  implements OnInit {
