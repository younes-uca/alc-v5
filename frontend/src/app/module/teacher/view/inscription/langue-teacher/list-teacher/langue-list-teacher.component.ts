...
@Component({
  selector: 'app-langue-list-teacher',
  templateUrl: './langue-list-teacher.component.html'
})
export class LangueListTeacherComponent extends AbstractListController<LangueDto, LangueCriteria, LangueService>  implements OnInit {
