...
@Component({
  selector: 'app-langue-edit-teacher',
  templateUrl: './langue-edit-teacher.component.html'
})
export class LangueEditTeacherComponent extends AbstractEditController<LangueDto, LangueCriteria, LangueService>   implements OnInit {
