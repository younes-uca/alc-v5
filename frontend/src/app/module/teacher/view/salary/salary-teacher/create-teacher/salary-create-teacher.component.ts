...
@Component({
  selector: 'app-salary-create-teacher',
  templateUrl: './salary-create-teacher.component.html'
})
export class SalaryCreateTeacherComponent extends AbstractCreateController<SalaryDto, SalaryCriteria, SalaryService>  implements OnInit {
