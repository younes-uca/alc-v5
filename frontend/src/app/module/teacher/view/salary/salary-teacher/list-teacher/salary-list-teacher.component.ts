...
@Component({
  selector: 'app-salary-list-teacher',
  templateUrl: './salary-list-teacher.component.html'
})
export class SalaryListTeacherComponent extends AbstractListController<SalaryDto, SalaryCriteria, SalaryService>  implements OnInit {
    ...
    constructor(salaryService: SalaryService, private profService: ProfService) {
        super(salaryService);
    }
