...
@Component({
  selector: 'app-workload-bonus-prof-create-teacher',
  templateUrl: './workload-bonus-prof-create-teacher.component.html'
})
export class WorkloadBonusProfCreateTeacherComponent extends AbstractCreateController<WorkloadBonusProfDto, WorkloadBonusProfCriteria, WorkloadBonusProfService>  implements OnInit {
