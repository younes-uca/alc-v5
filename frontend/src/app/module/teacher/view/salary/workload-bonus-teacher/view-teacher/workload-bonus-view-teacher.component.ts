...
@Component({
  selector: 'app-workload-bonus-view-teacher',
  templateUrl: './workload-bonus-view-teacher.component.html'
})
export class WorkloadBonusViewTeacherComponent extends AbstractViewController<WorkloadBonusDto, WorkloadBonusCriteria, WorkloadBonusService> implements OnInit {
