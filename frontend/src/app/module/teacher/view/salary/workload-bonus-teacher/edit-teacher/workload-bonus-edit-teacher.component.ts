...
@Component({
  selector: 'app-workload-bonus-edit-teacher',
  templateUrl: './workload-bonus-edit-teacher.component.html'
})
export class WorkloadBonusEditTeacherComponent extends AbstractEditController<WorkloadBonusDto, WorkloadBonusCriteria, WorkloadBonusService>   implements OnInit {
