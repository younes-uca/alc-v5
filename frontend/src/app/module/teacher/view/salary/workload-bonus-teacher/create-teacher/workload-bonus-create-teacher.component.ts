...
@Component({
  selector: 'app-workload-bonus-create-teacher',
  templateUrl: './workload-bonus-create-teacher.component.html'
})
export class WorkloadBonusCreateTeacherComponent extends AbstractCreateController<WorkloadBonusDto, WorkloadBonusCriteria, WorkloadBonusService>  implements OnInit {
