...
@Component({
  selector: 'app-parcours-list-student',
  templateUrl: './parcours-list-student.component.html'
})
export class ParcoursListStudentComponent extends AbstractListController<ParcoursDto, ParcoursCriteria, ParcoursService>  implements OnInit {
