...
@Component({
  selector: 'app-parcours-view-student',
  templateUrl: './parcours-view-student.component.html'
})
export class ParcoursViewStudentComponent extends AbstractViewController<ParcoursDto, ParcoursCriteria, ParcoursService> implements OnInit {
