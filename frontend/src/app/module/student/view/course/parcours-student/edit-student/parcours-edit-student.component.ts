...
@Component({
  selector: 'app-parcours-edit-student',
  templateUrl: './parcours-edit-student.component.html'
})
export class ParcoursEditStudentComponent extends AbstractEditController<ParcoursDto, ParcoursCriteria, ParcoursService>   implements OnInit {
