...
@Component({
  selector: 'app-parcours-create-student',
  templateUrl: './parcours-create-student.component.html'
})
export class ParcoursCreateStudentComponent extends AbstractCreateController<ParcoursDto, ParcoursCriteria, ParcoursService>  implements OnInit {
