...
@Component({
  selector: 'app-cours-list-student',
  templateUrl: './cours-list-student.component.html'
})
export class CoursListStudentComponent extends AbstractListController<CoursDto, CoursCriteria, CoursService>  implements OnInit {
