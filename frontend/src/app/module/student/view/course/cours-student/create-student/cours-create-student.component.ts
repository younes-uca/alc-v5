...
@Component({
  selector: 'app-cours-create-student',
  templateUrl: './cours-create-student.component.html'
})
export class CoursCreateStudentComponent extends AbstractCreateController<CoursDto, CoursCriteria, CoursService>  implements OnInit {
