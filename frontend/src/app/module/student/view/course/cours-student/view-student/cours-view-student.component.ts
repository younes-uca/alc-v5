...
@Component({
  selector: 'app-cours-view-student',
  templateUrl: './cours-view-student.component.html'
})
export class CoursViewStudentComponent extends AbstractViewController<CoursDto, CoursCriteria, CoursService> implements OnInit {
