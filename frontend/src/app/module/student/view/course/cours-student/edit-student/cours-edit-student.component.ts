...
@Component({
  selector: 'app-cours-edit-student',
  templateUrl: './cours-edit-student.component.html'
})
export class CoursEditStudentComponent extends AbstractEditController<CoursDto, CoursCriteria, CoursService>   implements OnInit {
