...
@Component({
  selector: 'app-super-categorie-section-list-student',
  templateUrl: './super-categorie-section-list-student.component.html'
})
export class SuperCategorieSectionListStudentComponent extends AbstractListController<SuperCategorieSectionDto, SuperCategorieSectionCriteria, SuperCategorieSectionService>  implements OnInit {
