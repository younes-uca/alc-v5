...
@Component({
  selector: 'app-super-categorie-section-view-student',
  templateUrl: './super-categorie-section-view-student.component.html'
})
export class SuperCategorieSectionViewStudentComponent extends AbstractViewController<SuperCategorieSectionDto, SuperCategorieSectionCriteria, SuperCategorieSectionService> implements OnInit {
