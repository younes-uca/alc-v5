...
@Component({
  selector: 'app-super-categorie-section-edit-student',
  templateUrl: './super-categorie-section-edit-student.component.html'
})
export class SuperCategorieSectionEditStudentComponent extends AbstractEditController<SuperCategorieSectionDto, SuperCategorieSectionCriteria, SuperCategorieSectionService>   implements OnInit {
