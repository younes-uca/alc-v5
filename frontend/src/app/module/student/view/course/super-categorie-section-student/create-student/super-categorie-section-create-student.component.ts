...
@Component({
  selector: 'app-super-categorie-section-create-student',
  templateUrl: './super-categorie-section-create-student.component.html'
})
export class SuperCategorieSectionCreateStudentComponent extends AbstractCreateController<SuperCategorieSectionDto, SuperCategorieSectionCriteria, SuperCategorieSectionService>  implements OnInit {
