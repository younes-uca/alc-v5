...
@Component({
  selector: 'app-centre-edit-student',
  templateUrl: './centre-edit-student.component.html'
})
export class CentreEditStudentComponent extends AbstractEditController<CentreDto, CentreCriteria, CentreService>   implements OnInit {
