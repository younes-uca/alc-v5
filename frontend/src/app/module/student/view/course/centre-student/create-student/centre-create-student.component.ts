...
@Component({
  selector: 'app-centre-create-student',
  templateUrl: './centre-create-student.component.html'
})
export class CentreCreateStudentComponent extends AbstractCreateController<CentreDto, CentreCriteria, CentreService>  implements OnInit {
