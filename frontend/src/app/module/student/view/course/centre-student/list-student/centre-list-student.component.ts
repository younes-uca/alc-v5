...
@Component({
  selector: 'app-centre-list-student',
  templateUrl: './centre-list-student.component.html'
})
export class CentreListStudentComponent extends AbstractListController<CentreDto, CentreCriteria, CentreService>  implements OnInit {
