...
@Component({
  selector: 'app-centre-view-student',
  templateUrl: './centre-view-student.component.html'
})
export class CentreViewStudentComponent extends AbstractViewController<CentreDto, CentreCriteria, CentreService> implements OnInit {
