...
@Component({
  selector: 'app-vocabulary-quiz-list-student',
  templateUrl: './vocabulary-quiz-list-student.component.html'
})
export class VocabularyQuizListStudentComponent extends AbstractListController<VocabularyQuizDto, VocabularyQuizCriteria, VocabularyQuizService>  implements OnInit {
