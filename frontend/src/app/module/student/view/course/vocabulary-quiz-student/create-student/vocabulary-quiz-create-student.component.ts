...
@Component({
  selector: 'app-vocabulary-quiz-create-student',
  templateUrl: './vocabulary-quiz-create-student.component.html'
})
export class VocabularyQuizCreateStudentComponent extends AbstractCreateController<VocabularyQuizDto, VocabularyQuizCriteria, VocabularyQuizService>  implements OnInit {
