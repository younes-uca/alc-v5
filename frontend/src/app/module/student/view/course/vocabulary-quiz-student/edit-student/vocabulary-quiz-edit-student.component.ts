...
@Component({
  selector: 'app-vocabulary-quiz-edit-student',
  templateUrl: './vocabulary-quiz-edit-student.component.html'
})
export class VocabularyQuizEditStudentComponent extends AbstractEditController<VocabularyQuizDto, VocabularyQuizCriteria, VocabularyQuizService>   implements OnInit {
