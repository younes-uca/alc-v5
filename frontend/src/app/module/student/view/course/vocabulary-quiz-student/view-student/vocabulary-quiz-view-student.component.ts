...
@Component({
  selector: 'app-vocabulary-quiz-view-student',
  templateUrl: './vocabulary-quiz-view-student.component.html'
})
export class VocabularyQuizViewStudentComponent extends AbstractViewController<VocabularyQuizDto, VocabularyQuizCriteria, VocabularyQuizService> implements OnInit {
