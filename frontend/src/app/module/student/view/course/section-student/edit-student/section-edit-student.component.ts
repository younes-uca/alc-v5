...
@Component({
  selector: 'app-section-edit-student',
  templateUrl: './section-edit-student.component.html'
})
export class SectionEditStudentComponent extends AbstractEditController<SectionDto, SectionCriteria, SectionService>   implements OnInit {
