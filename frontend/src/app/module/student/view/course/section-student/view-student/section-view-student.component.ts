...
@Component({
  selector: 'app-section-view-student',
  templateUrl: './section-view-student.component.html'
})
export class SectionViewStudentComponent extends AbstractViewController<SectionDto, SectionCriteria, SectionService> implements OnInit {
