...
@Component({
  selector: 'app-section-create-student',
  templateUrl: './section-create-student.component.html'
})
export class SectionCreateStudentComponent extends AbstractCreateController<SectionDto, SectionCriteria, SectionService>  implements OnInit {
