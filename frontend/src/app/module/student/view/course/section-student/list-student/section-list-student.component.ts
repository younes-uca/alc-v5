...
@Component({
  selector: 'app-section-list-student',
  templateUrl: './section-list-student.component.html'
})
export class SectionListStudentComponent extends AbstractListController<SectionDto, SectionCriteria, SectionService>  implements OnInit {
