...
@Component({
  selector: 'app-etat-cours-create-student',
  templateUrl: './etat-cours-create-student.component.html'
})
export class EtatCoursCreateStudentComponent extends AbstractCreateController<EtatCoursDto, EtatCoursCriteria, EtatCoursService>  implements OnInit {
