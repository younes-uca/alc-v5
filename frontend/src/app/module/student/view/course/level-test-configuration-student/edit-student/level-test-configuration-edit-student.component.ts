...
@Component({
  selector: 'app-level-test-configuration-edit-student',
  templateUrl: './level-test-configuration-edit-student.component.html'
})
export class LevelTestConfigurationEditStudentComponent extends AbstractEditController<LevelTestConfigurationDto, LevelTestConfigurationCriteria, LevelTestConfigurationService>   implements OnInit {
