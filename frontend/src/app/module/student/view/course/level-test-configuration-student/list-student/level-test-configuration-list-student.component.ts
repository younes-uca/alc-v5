...
@Component({
  selector: 'app-level-test-configuration-list-student',
  templateUrl: './level-test-configuration-list-student.component.html'
})
export class LevelTestConfigurationListStudentComponent extends AbstractListController<LevelTestConfigurationDto, LevelTestConfigurationCriteria, LevelTestConfigurationService>  implements OnInit {

    fileName = 'LevelTestConfiguration';

    parcourss :Array<ParcoursDto>;
  
    constructor(levelTestConfigurationService: LevelTestConfigurationService, private parcoursService: ParcoursService) {
