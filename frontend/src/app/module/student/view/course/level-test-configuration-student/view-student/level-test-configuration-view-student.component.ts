...
@Component({
  selector: 'app-level-test-configuration-view-student',
  templateUrl: './level-test-configuration-view-student.component.html'
})
export class LevelTestConfigurationViewStudentComponent extends AbstractViewController<LevelTestConfigurationDto, LevelTestConfigurationCriteria, LevelTestConfigurationService> implements OnInit {
