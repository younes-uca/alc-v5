...
@Component({
  selector: 'app-level-test-configuration-create-student',
  templateUrl: './level-test-configuration-create-student.component.html'
})
export class LevelTestConfigurationCreateStudentComponent extends AbstractCreateController<LevelTestConfigurationDto, LevelTestConfigurationCriteria, LevelTestConfigurationService>  implements OnInit {
