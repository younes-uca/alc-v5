...
@Component({
  selector: 'app-section-item-edit-student',
  templateUrl: './section-item-edit-student.component.html'
})
export class SectionItemEditStudentComponent extends AbstractEditController<SectionItemDto, SectionItemCriteria, SectionItemService>   implements OnInit {
