...
@Component({
  selector: 'app-section-item-list-student',
  templateUrl: './section-item-list-student.component.html'
})
export class SectionItemListStudentComponent extends AbstractListController<SectionItemDto, SectionItemCriteria, SectionItemService>  implements OnInit {

    fileName = 'SectionItem';

    sections :Array<SectionDto>;
  
    constructor(sectionItemService: SectionItemService, private sectionService: SectionService) {
