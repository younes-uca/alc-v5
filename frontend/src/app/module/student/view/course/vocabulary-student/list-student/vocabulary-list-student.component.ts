...
@Component({
  selector: 'app-vocabulary-list-student',
  templateUrl: './vocabulary-list-student.component.html'
})
export class VocabularyListStudentComponent extends AbstractListController<VocabularyDto, VocabularyCriteria, VocabularyService>  implements OnInit {
