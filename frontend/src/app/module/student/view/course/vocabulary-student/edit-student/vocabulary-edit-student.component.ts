...
@Component({
  selector: 'app-vocabulary-edit-student',
  templateUrl: './vocabulary-edit-student.component.html'
})
export class VocabularyEditStudentComponent extends AbstractEditController<VocabularyDto, VocabularyCriteria, VocabularyService>   implements OnInit {
