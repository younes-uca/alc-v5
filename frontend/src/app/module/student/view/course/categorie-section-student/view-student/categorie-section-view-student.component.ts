...
@Component({
  selector: 'app-categorie-section-view-student',
  templateUrl: './categorie-section-view-student.component.html'
})
export class CategorieSectionViewStudentComponent extends AbstractViewController<CategorieSectionDto, CategorieSectionCriteria, CategorieSectionService> implements OnInit {
