...
@Component({
  selector: 'app-categorie-section-edit-student',
  templateUrl: './categorie-section-edit-student.component.html'
})
export class CategorieSectionEditStudentComponent extends AbstractEditController<CategorieSectionDto, CategorieSectionCriteria, CategorieSectionService>   implements OnInit {
