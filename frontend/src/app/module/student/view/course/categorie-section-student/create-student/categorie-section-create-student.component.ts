...
@Component({
  selector: 'app-categorie-section-create-student',
  templateUrl: './categorie-section-create-student.component.html'
})
export class CategorieSectionCreateStudentComponent extends AbstractCreateController<CategorieSectionDto, CategorieSectionCriteria, CategorieSectionService>  implements OnInit {
