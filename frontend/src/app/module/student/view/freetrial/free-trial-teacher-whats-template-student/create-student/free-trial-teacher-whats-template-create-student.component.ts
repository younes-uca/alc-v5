...
@Component({
  selector: 'app-free-trial-teacher-whats-template-create-student',
  templateUrl: './free-trial-teacher-whats-template-create-student.component.html'
})
export class FreeTrialTeacherWhatsTemplateCreateStudentComponent extends AbstractCreateController<FreeTrialTeacherWhatsTemplateDto, FreeTrialTeacherWhatsTemplateCriteria, FreeTrialTeacherWhatsTemplateService>  implements OnInit {
