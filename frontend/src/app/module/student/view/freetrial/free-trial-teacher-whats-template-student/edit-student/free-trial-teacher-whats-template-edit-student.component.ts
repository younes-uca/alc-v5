...
@Component({
  selector: 'app-free-trial-teacher-whats-template-edit-student',
  templateUrl: './free-trial-teacher-whats-template-edit-student.component.html'
})
export class FreeTrialTeacherWhatsTemplateEditStudentComponent extends AbstractEditController<FreeTrialTeacherWhatsTemplateDto, FreeTrialTeacherWhatsTemplateCriteria, FreeTrialTeacherWhatsTemplateService>   implements OnInit {
