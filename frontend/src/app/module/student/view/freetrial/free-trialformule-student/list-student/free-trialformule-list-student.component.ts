...
@Component({
  selector: 'app-free-trialformule-list-student',
  templateUrl: './free-trialformule-list-student.component.html'
})
export class FreeTrialformuleListStudentComponent extends AbstractListController<FreeTrialformuleDto, FreeTrialformuleCriteria, FreeTrialformuleService>  implements OnInit {
