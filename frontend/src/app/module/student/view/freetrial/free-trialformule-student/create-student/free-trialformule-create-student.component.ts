...
@Component({
  selector: 'app-free-trialformule-create-student',
  templateUrl: './free-trialformule-create-student.component.html'
})
export class FreeTrialformuleCreateStudentComponent extends AbstractCreateController<FreeTrialformuleDto, FreeTrialformuleCriteria, FreeTrialformuleService>  implements OnInit {
