...
@Component({
  selector: 'app-services-create-student',
  templateUrl: './services-create-student.component.html'
})
export class ServicesCreateStudentComponent extends AbstractCreateController<ServicesDto, ServicesCriteria, ServicesService>  implements OnInit {
