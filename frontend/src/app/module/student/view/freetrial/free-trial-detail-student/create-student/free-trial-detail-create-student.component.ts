...
@Component({
  selector: 'app-free-trial-detail-create-student',
  templateUrl: './free-trial-detail-create-student.component.html'
})
export class FreeTrialDetailCreateStudentComponent extends AbstractCreateController<FreeTrialDetailDto, FreeTrialDetailCriteria, FreeTrialDetailService>  implements OnInit {
