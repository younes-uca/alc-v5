...
@Component({
  selector: 'app-free-trial-detail-list-student',
  templateUrl: './free-trial-detail-list-student.component.html'
})
export class FreeTrialDetailListStudentComponent extends AbstractListController<FreeTrialDetailDto, FreeTrialDetailCriteria, FreeTrialDetailService>  implements OnInit {
