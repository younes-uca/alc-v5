...
@Component({
  selector: 'app-free-trial-detail-view-student',
  templateUrl: './free-trial-detail-view-student.component.html'
})
export class FreeTrialDetailViewStudentComponent extends AbstractViewController<FreeTrialDetailDto, FreeTrialDetailCriteria, FreeTrialDetailService> implements OnInit {
