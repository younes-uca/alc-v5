...
@Component({
  selector: 'app-free-trial-detail-edit-student',
  templateUrl: './free-trial-detail-edit-student.component.html'
})
export class FreeTrialDetailEditStudentComponent extends AbstractEditController<FreeTrialDetailDto, FreeTrialDetailCriteria, FreeTrialDetailService>   implements OnInit {
