...
@Component({
  selector: 'app-statut-free-trial-create-student',
  templateUrl: './statut-free-trial-create-student.component.html'
})
export class StatutFreeTrialCreateStudentComponent extends AbstractCreateController<StatutFreeTrialDto, StatutFreeTrialCriteria, StatutFreeTrialService>  implements OnInit {
