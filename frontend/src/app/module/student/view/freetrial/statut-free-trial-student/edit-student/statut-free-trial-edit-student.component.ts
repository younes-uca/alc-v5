...
@Component({
  selector: 'app-statut-free-trial-edit-student',
  templateUrl: './statut-free-trial-edit-student.component.html'
})
export class StatutFreeTrialEditStudentComponent extends AbstractEditController<StatutFreeTrialDto, StatutFreeTrialCriteria, StatutFreeTrialService>   implements OnInit {
