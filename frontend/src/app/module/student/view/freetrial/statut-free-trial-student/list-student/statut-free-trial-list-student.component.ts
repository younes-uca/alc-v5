...
@Component({
  selector: 'app-statut-free-trial-list-student',
  templateUrl: './statut-free-trial-list-student.component.html'
})
export class StatutFreeTrialListStudentComponent extends AbstractListController<StatutFreeTrialDto, StatutFreeTrialCriteria, StatutFreeTrialService>  implements OnInit {
