...
@Component({
  selector: 'app-free-trial-student-email-template-edit-student',
  templateUrl: './free-trial-student-email-template-edit-student.component.html'
})
export class FreeTrialStudentEmailTemplateEditStudentComponent extends AbstractEditController<FreeTrialStudentEmailTemplateDto, FreeTrialStudentEmailTemplateCriteria, FreeTrialStudentEmailTemplateService>   implements OnInit {
