...
@Component({
  selector: 'app-free-trial-student-email-template-create-student',
  templateUrl: './free-trial-student-email-template-create-student.component.html'
})
export class FreeTrialStudentEmailTemplateCreateStudentComponent extends AbstractCreateController<FreeTrialStudentEmailTemplateDto, FreeTrialStudentEmailTemplateCriteria, FreeTrialStudentEmailTemplateService>  implements OnInit {
