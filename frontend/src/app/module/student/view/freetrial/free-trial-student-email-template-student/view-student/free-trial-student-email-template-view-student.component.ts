...
@Component({
  selector: 'app-free-trial-student-email-template-view-student',
  templateUrl: './free-trial-student-email-template-view-student.component.html'
})
export class FreeTrialStudentEmailTemplateViewStudentComponent extends AbstractViewController<FreeTrialStudentEmailTemplateDto, FreeTrialStudentEmailTemplateCriteria, FreeTrialStudentEmailTemplateService> implements OnInit {
