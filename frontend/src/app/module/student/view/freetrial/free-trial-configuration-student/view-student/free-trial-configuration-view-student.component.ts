...
@Component({
  selector: 'app-free-trial-configuration-view-student',
  templateUrl: './free-trial-configuration-view-student.component.html'
})
export class FreeTrialConfigurationViewStudentComponent extends AbstractViewController<FreeTrialConfigurationDto, FreeTrialConfigurationCriteria, FreeTrialConfigurationService> implements OnInit {
