...
@Component({
  selector: 'app-free-trial-teacher-email-template-list-student',
  templateUrl: './free-trial-teacher-email-template-list-student.component.html'
})
export class FreeTrialTeacherEmailTemplateListStudentComponent extends AbstractListController<FreeTrialTeacherEmailTemplateDto, FreeTrialTeacherEmailTemplateCriteria, FreeTrialTeacherEmailTemplateService>  implements OnInit {
