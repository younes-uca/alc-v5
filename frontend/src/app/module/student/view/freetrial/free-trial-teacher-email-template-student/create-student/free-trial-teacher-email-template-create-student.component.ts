...
@Component({
  selector: 'app-free-trial-teacher-email-template-create-student',
  templateUrl: './free-trial-teacher-email-template-create-student.component.html'
})
export class FreeTrialTeacherEmailTemplateCreateStudentComponent extends AbstractCreateController<FreeTrialTeacherEmailTemplateDto, FreeTrialTeacherEmailTemplateCriteria, FreeTrialTeacherEmailTemplateService>  implements OnInit {
