...
@Component({
  selector: 'app-free-trial-student-whats-template-edit-student',
  templateUrl: './free-trial-student-whats-template-edit-student.component.html'
})
export class FreeTrialStudentWhatsTemplateEditStudentComponent extends AbstractEditController<FreeTrialStudentWhatsTemplateDto, FreeTrialStudentWhatsTemplateCriteria, FreeTrialStudentWhatsTemplateService>   implements OnInit {
