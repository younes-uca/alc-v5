...
@Component({
  selector: 'app-free-trial-view-student',
  templateUrl: './free-trial-view-student.component.html'
})
export class FreeTrialViewStudentComponent extends AbstractViewController<FreeTrialDto, FreeTrialCriteria, FreeTrialService> implements OnInit {
