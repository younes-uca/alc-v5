...
@Component({
  selector: 'app-free-trial-edit-student',
  templateUrl: './free-trial-edit-student.component.html'
})
export class FreeTrialEditStudentComponent extends AbstractEditController<FreeTrialDto, FreeTrialCriteria, FreeTrialService>   implements OnInit {
