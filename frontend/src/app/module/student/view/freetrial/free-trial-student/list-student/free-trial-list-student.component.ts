...
@Component({
  selector: 'app-free-trial-list-student',
  templateUrl: './free-trial-list-student.component.html'
})
export class FreeTrialListStudentComponent extends AbstractListController<FreeTrialDto, FreeTrialCriteria, FreeTrialService>  implements OnInit {
