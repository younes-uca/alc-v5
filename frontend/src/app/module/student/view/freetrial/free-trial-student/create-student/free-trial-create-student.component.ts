...
@Component({
  selector: 'app-free-trial-create-student',
  templateUrl: './free-trial-create-student.component.html'
})
export class FreeTrialCreateStudentComponent extends AbstractCreateController<FreeTrialDto, FreeTrialCriteria, FreeTrialService>  implements OnInit {
   ...
   private _validFreeTrialReference = true;
    ...
    constructor( private freeTrialService: FreeTrialService , private etudiantService: EtudiantService, private freeTrialStudentEmailTemplateService: FreeTrialStudentEmailTemplateService, private niveauEtudeService: NiveauEtudeService, private freeTrialDetailService: FreeTrialDetailService, private statutFreeTrialService: StatutFreeTrialService, private freeTrialTeacherEmailTemplateService: FreeTrialTeacherEmailTemplateService, private freeTrialConfigurationService: FreeTrialConfigurationService, private freeTrialTeacherWhatsTemplateService: FreeTrialTeacherWhatsTemplateService, private profService: ProfService, private freeTrialStudentWhatsTemplateService: FreeTrialStudentWhatsTemplateService) {
