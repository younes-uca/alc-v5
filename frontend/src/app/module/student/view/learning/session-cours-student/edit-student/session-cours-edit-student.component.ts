...
@Component({
  selector: 'app-session-cours-edit-student',
  templateUrl: './session-cours-edit-student.component.html'
})
export class SessionCoursEditStudentComponent extends AbstractEditController<SessionCoursDto, SessionCoursCriteria, SessionCoursService>   implements OnInit {
