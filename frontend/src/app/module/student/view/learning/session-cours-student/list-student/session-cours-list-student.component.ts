...
@Component({
  selector: 'app-session-cours-list-student',
  templateUrl: './session-cours-list-student.component.html'
})
export class SessionCoursListStudentComponent extends AbstractListController<SessionCoursDto, SessionCoursCriteria, SessionCoursService>  implements OnInit {
