...
@Component({
  selector: 'app-faq-type-create-student',
  templateUrl: './faq-type-create-student.component.html'
})
export class FaqTypeCreateStudentComponent extends AbstractCreateController<FaqTypeDto, FaqTypeCriteria, FaqTypeService>  implements OnInit {
