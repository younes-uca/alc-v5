...
@Component({
  selector: 'app-faq-type-edit-student',
  templateUrl: './faq-type-edit-student.component.html'
})
export class FaqTypeEditStudentComponent extends AbstractEditController<FaqTypeDto, FaqTypeCriteria, FaqTypeService>   implements OnInit {
