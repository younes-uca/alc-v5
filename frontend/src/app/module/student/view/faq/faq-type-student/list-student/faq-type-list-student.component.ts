...
@Component({
  selector: 'app-faq-type-list-student',
  templateUrl: './faq-type-list-student.component.html'
})
export class FaqTypeListStudentComponent extends AbstractListController<FaqTypeDto, FaqTypeCriteria, FaqTypeService>  implements OnInit {
