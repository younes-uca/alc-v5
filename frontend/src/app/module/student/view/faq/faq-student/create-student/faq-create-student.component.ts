...
@Component({
  selector: 'app-faq-create-student',
  templateUrl: './faq-create-student.component.html'
})
export class FaqCreateStudentComponent extends AbstractCreateController<FaqDto, FaqCriteria, FaqService>  implements OnInit {
