...
@Component({
  selector: 'app-faq-edit-student',
  templateUrl: './faq-edit-student.component.html'
})
export class FaqEditStudentComponent extends AbstractEditController<FaqDto, FaqCriteria, FaqService>   implements OnInit {
