...
@Component({
  selector: 'app-faq-prof-edit-student',
  templateUrl: './faq-prof-edit-student.component.html'
})
export class FaqProfEditStudentComponent extends AbstractEditController<FaqProfDto, FaqProfCriteria, FaqProfService>   implements OnInit {
