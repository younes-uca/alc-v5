...
@Component({
  selector: 'app-faq-prof-view-student',
  templateUrl: './faq-prof-view-student.component.html'
})
export class FaqProfViewStudentComponent extends AbstractViewController<FaqProfDto, FaqProfCriteria, FaqProfService> implements OnInit {
