...
@Component({
  selector: 'app-faq-prof-create-student',
  templateUrl: './faq-prof-create-student.component.html'
})
export class FaqProfCreateStudentComponent extends AbstractCreateController<FaqProfDto, FaqProfCriteria, FaqProfService>  implements OnInit {
   ...
   private _validFaqProfLibelle = true;
    ...
    constructor( private faqProfService: FaqProfService , private faqTypeService: FaqTypeService, private adminService: AdminService, private profService: ProfService) {
