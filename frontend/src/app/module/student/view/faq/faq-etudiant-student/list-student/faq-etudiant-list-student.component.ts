...
@Component({
  selector: 'app-faq-etudiant-list-student',
  templateUrl: './faq-etudiant-list-student.component.html'
})
export class FaqEtudiantListStudentComponent extends AbstractListController<FaqEtudiantDto, FaqEtudiantCriteria, FaqEtudiantService>  implements OnInit {
