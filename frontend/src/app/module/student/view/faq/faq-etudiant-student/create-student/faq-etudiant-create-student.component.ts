...
@Component({
  selector: 'app-faq-etudiant-create-student',
  templateUrl: './faq-etudiant-create-student.component.html'
})
export class FaqEtudiantCreateStudentComponent extends AbstractCreateController<FaqEtudiantDto, FaqEtudiantCriteria, FaqEtudiantService>  implements OnInit {
