...
@Component({
  selector: 'app-quiz-etudiant-view-student',
  templateUrl: './quiz-etudiant-view-student.component.html'
})
export class QuizEtudiantViewStudentComponent extends AbstractViewController<QuizEtudiantDto, QuizEtudiantCriteria, QuizEtudiantService> implements OnInit {
