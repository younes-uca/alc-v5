...
@Component({
  selector: 'app-quiz-etudiant-edit-student',
  templateUrl: './quiz-etudiant-edit-student.component.html'
})
export class QuizEtudiantEditStudentComponent extends AbstractEditController<QuizEtudiantDto, QuizEtudiantCriteria, QuizEtudiantService>   implements OnInit {
