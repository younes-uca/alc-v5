...
@Component({
  selector: 'app-quiz-etudiant-create-student',
  templateUrl: './quiz-etudiant-create-student.component.html'
})
export class QuizEtudiantCreateStudentComponent extends AbstractCreateController<QuizEtudiantDto, QuizEtudiantCriteria, QuizEtudiantService>  implements OnInit {
