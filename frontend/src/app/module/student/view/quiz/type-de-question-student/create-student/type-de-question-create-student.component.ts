...
@Component({
  selector: 'app-type-de-question-create-student',
  templateUrl: './type-de-question-create-student.component.html'
})
export class TypeDeQuestionCreateStudentComponent extends AbstractCreateController<TypeDeQuestionDto, TypeDeQuestionCriteria, TypeDeQuestionService>  implements OnInit {
