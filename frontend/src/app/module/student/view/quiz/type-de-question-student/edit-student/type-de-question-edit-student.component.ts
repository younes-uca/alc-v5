...
@Component({
  selector: 'app-type-de-question-edit-student',
  templateUrl: './type-de-question-edit-student.component.html'
})
export class TypeDeQuestionEditStudentComponent extends AbstractEditController<TypeDeQuestionDto, TypeDeQuestionCriteria, TypeDeQuestionService>   implements OnInit {
