...
@Component({
  selector: 'app-reponse-list-student',
  templateUrl: './reponse-list-student.component.html'
})
export class ReponseListStudentComponent extends AbstractListController<ReponseDto, ReponseCriteria, ReponseService>  implements OnInit {
    ...
    constructor(reponseService: ReponseService, private etatReponseService: EtatReponseService, private questionService: QuestionService) {
