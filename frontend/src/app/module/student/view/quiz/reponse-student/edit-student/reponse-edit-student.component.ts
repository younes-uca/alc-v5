...
@Component({
  selector: 'app-reponse-edit-student',
  templateUrl: './reponse-edit-student.component.html'
})
export class ReponseEditStudentComponent extends AbstractEditController<ReponseDto, ReponseCriteria, ReponseService>   implements OnInit {
