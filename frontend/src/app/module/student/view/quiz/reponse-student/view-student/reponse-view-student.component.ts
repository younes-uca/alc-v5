...
@Component({
  selector: 'app-reponse-view-student',
  templateUrl: './reponse-view-student.component.html'
})
export class ReponseViewStudentComponent extends AbstractViewController<ReponseDto, ReponseCriteria, ReponseService> implements OnInit {
