...
@Component({
  selector: 'app-class-room-create-student',
  templateUrl: './class-room-create-student.component.html'
})
export class ClassRoomCreateStudentComponent extends AbstractCreateController<ClassRoomDto, ClassRoomCriteria, ClassRoomService>  implements OnInit {
