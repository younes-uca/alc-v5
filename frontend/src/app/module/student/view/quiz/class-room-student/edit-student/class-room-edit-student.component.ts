...
@Component({
  selector: 'app-class-room-edit-student',
  templateUrl: './class-room-edit-student.component.html'
})
export class ClassRoomEditStudentComponent extends AbstractEditController<ClassRoomDto, ClassRoomCriteria, ClassRoomService>   implements OnInit {
