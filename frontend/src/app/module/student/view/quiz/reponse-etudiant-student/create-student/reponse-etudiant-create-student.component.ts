...
@Component({
  selector: 'app-reponse-etudiant-create-student',
  templateUrl: './reponse-etudiant-create-student.component.html'
})
export class ReponseEtudiantCreateStudentComponent extends AbstractCreateController<ReponseEtudiantDto, ReponseEtudiantCriteria, ReponseEtudiantService>  implements OnInit {
