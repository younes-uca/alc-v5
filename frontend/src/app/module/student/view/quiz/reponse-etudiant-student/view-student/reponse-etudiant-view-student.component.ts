...
@Component({
  selector: 'app-reponse-etudiant-view-student',
  templateUrl: './reponse-etudiant-view-student.component.html'
})
export class ReponseEtudiantViewStudentComponent extends AbstractViewController<ReponseEtudiantDto, ReponseEtudiantCriteria, ReponseEtudiantService> implements OnInit {
