...
@Component({
  selector: 'app-reponse-etudiant-edit-student',
  templateUrl: './reponse-etudiant-edit-student.component.html'
})
export class ReponseEtudiantEditStudentComponent extends AbstractEditController<ReponseEtudiantDto, ReponseEtudiantCriteria, ReponseEtudiantService>   implements OnInit {
