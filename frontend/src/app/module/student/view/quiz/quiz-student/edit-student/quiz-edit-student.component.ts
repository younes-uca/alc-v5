...
@Component({
  selector: 'app-quiz-edit-student',
  templateUrl: './quiz-edit-student.component.html'
})
export class QuizEditStudentComponent extends AbstractEditController<QuizDto, QuizCriteria, QuizService>   implements OnInit {
