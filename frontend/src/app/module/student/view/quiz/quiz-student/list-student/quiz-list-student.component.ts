...
@Component({
  ...
  templateUrl: './quiz-list-student.component.html'
})
export class QuizListStudentComponent extends AbstractListController<QuizDto, QuizCriteria, QuizService>  implements OnInit {
