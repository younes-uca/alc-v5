...
@Component({
  selector: 'app-quiz-create-student',
  templateUrl: './quiz-create-student.component.html'
})
export class QuizCreateStudentComponent extends AbstractCreateController<QuizDto, QuizCriteria, QuizService>  implements OnInit {
