...
@Component({
  selector: 'app-question-edit-student',
  templateUrl: './question-edit-student.component.html'
})
export class QuestionEditStudentComponent extends AbstractEditController<QuestionDto, QuestionCriteria, QuestionService>   implements OnInit {
