...
@Component({
  selector: 'app-question-create-student',
  templateUrl: './question-create-student.component.html'
})
export class QuestionCreateStudentComponent extends AbstractCreateController<QuestionDto, QuestionCriteria, QuestionService>  implements OnInit {
