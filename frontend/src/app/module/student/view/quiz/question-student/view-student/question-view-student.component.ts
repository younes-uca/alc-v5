...
@Component({
  selector: 'app-question-view-student',
  templateUrl: './question-view-student.component.html'
})
export class QuestionViewStudentComponent extends AbstractViewController<QuestionDto, QuestionCriteria, QuestionService> implements OnInit {
