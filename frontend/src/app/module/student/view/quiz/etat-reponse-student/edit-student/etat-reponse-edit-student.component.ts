...
@Component({
  selector: 'app-etat-reponse-edit-student',
  templateUrl: './etat-reponse-edit-student.component.html'
})
export class EtatReponseEditStudentComponent extends AbstractEditController<EtatReponseDto, EtatReponseCriteria, EtatReponseService>   implements OnInit {
