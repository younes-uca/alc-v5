...
@Component({
  selector: 'app-etat-reponse-create-student',
  templateUrl: './etat-reponse-create-student.component.html'
})
export class EtatReponseCreateStudentComponent extends AbstractCreateController<EtatReponseDto, EtatReponseCriteria, EtatReponseService>  implements OnInit {
