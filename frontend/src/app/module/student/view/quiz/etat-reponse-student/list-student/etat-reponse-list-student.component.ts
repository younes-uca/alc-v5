...
@Component({
  selector: 'app-etat-reponse-list-student',
  templateUrl: './etat-reponse-list-student.component.html'
})
export class EtatReponseListStudentComponent extends AbstractListController<EtatReponseDto, EtatReponseCriteria, EtatReponseService>  implements OnInit {
