...
@Component({
  selector: 'app-type-reclamation-etudiant-list-student',
  templateUrl: './type-reclamation-etudiant-list-student.component.html'
})
export class TypeReclamationEtudiantListStudentComponent extends AbstractListController<TypeReclamationEtudiantDto, TypeReclamationEtudiantCriteria, TypeReclamationEtudiantService>  implements OnInit {
