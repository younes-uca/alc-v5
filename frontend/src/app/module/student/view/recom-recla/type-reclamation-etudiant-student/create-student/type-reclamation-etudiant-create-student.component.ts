...
@Component({
  selector: 'app-type-reclamation-etudiant-create-student',
  templateUrl: './type-reclamation-etudiant-create-student.component.html'
})
export class TypeReclamationEtudiantCreateStudentComponent extends AbstractCreateController<TypeReclamationEtudiantDto, TypeReclamationEtudiantCriteria, TypeReclamationEtudiantService>  implements OnInit {
