...
@Component({
  selector: 'app-recommend-teacher-edit-student',
  templateUrl: './recommend-teacher-edit-student.component.html'
})
export class RecommendTeacherEditStudentComponent extends AbstractEditController<RecommendTeacherDto, RecommendTeacherCriteria, RecommendTeacherService>   implements OnInit {
