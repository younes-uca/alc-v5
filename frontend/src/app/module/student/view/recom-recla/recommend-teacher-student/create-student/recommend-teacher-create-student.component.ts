...
@Component({
  selector: 'app-recommend-teacher-create-student',
  templateUrl: './recommend-teacher-create-student.component.html'
})
export class RecommendTeacherCreateStudentComponent extends AbstractCreateController<RecommendTeacherDto, RecommendTeacherCriteria, RecommendTeacherService>  implements OnInit {
