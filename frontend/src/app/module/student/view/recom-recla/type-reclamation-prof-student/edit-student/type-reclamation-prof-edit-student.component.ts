...
@Component({
  selector: 'app-type-reclamation-prof-edit-student',
  templateUrl: './type-reclamation-prof-edit-student.component.html'
})
export class TypeReclamationProfEditStudentComponent extends AbstractEditController<TypeReclamationProfDto, TypeReclamationProfCriteria, TypeReclamationProfService>   implements OnInit {
