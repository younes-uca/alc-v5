...
@Component({
  selector: 'app-reclamation-etudiant-create-student',
  templateUrl: './reclamation-etudiant-create-student.component.html'
})
export class ReclamationEtudiantCreateStudentComponent extends AbstractCreateController<ReclamationEtudiantDto, ReclamationEtudiantCriteria, ReclamationEtudiantService>  implements OnInit {
