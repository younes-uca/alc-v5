...
@Component({
  selector: 'app-reclamation-etudiant-edit-student',
  templateUrl: './reclamation-etudiant-edit-student.component.html'
})
export class ReclamationEtudiantEditStudentComponent extends AbstractEditController<ReclamationEtudiantDto, ReclamationEtudiantCriteria, ReclamationEtudiantService>   implements OnInit {
