...
@Component({
  selector: 'app-reclamation-prof-edit-student',
  templateUrl: './reclamation-prof-edit-student.component.html'
})
export class ReclamationProfEditStudentComponent extends AbstractEditController<ReclamationProfDto, ReclamationProfCriteria, ReclamationProfService>   implements OnInit {
