...
@Component({
  selector: 'app-reclamation-prof-view-student',
  templateUrl: './reclamation-prof-view-student.component.html'
})
export class ReclamationProfViewStudentComponent extends AbstractViewController<ReclamationProfDto, ReclamationProfCriteria, ReclamationProfService> implements OnInit {
