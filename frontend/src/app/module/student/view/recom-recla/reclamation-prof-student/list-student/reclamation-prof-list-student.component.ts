...
@Component({
  selector: 'app-reclamation-prof-list-student',
  templateUrl: './reclamation-prof-list-student.component.html'
})
export class ReclamationProfListStudentComponent extends AbstractListController<ReclamationProfDto, ReclamationProfCriteria, ReclamationProfService>  implements OnInit {
