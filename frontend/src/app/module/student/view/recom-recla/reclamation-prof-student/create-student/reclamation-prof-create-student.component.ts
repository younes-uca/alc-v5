...
@Component({
  selector: 'app-reclamation-prof-create-student',
  templateUrl: './reclamation-prof-create-student.component.html'
})
export class ReclamationProfCreateStudentComponent extends AbstractCreateController<ReclamationProfDto, ReclamationProfCriteria, ReclamationProfService>  implements OnInit {
   ...
   private _validReclamationProfReference = true;
    ...
    constructor( private reclamationProfService: ReclamationProfService , private typeReclamationProfService: TypeReclamationProfService, private adminService: AdminService, private profService: ProfService) {
