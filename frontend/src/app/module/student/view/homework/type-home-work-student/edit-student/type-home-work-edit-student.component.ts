...
@Component({
  selector: 'app-type-home-work-edit-student',
  templateUrl: './type-home-work-edit-student.component.html'
})
export class TypeHomeWorkEditStudentComponent extends AbstractEditController<TypeHomeWorkDto, TypeHomeWorkCriteria, TypeHomeWorkService>   implements OnInit {
