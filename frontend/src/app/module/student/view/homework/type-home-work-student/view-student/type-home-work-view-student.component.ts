...
@Component({
  selector: 'app-type-home-work-view-student',
  templateUrl: './type-home-work-view-student.component.html'
})
export class TypeHomeWorkViewStudentComponent extends AbstractViewController<TypeHomeWorkDto, TypeHomeWorkCriteria, TypeHomeWorkService> implements OnInit {
