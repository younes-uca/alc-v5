...
@Component({
  selector: 'app-type-home-work-create-student',
  templateUrl: './type-home-work-create-student.component.html'
})
export class TypeHomeWorkCreateStudentComponent extends AbstractCreateController<TypeHomeWorkDto, TypeHomeWorkCriteria, TypeHomeWorkService>  implements OnInit {
