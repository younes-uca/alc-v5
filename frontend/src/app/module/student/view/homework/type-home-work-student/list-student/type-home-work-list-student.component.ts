...
@Component({
  selector: 'app-type-home-work-list-student',
  templateUrl: './type-home-work-list-student.component.html'
})
export class TypeHomeWorkListStudentComponent extends AbstractListController<TypeHomeWorkDto, TypeHomeWorkCriteria, TypeHomeWorkService>  implements OnInit {
