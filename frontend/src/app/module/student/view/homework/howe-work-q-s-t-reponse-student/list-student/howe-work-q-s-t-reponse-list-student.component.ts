...
@Component({
  selector: 'app-howe-work-q-s-t-reponse-list-student',
  templateUrl: './howe-work-q-s-t-reponse-list-student.component.html'
})
export class HoweWorkQSTReponseListStudentComponent extends AbstractListController<HoweWorkQSTReponseDto, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseService>  implements OnInit {
