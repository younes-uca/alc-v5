...
@Component({
  selector: 'app-howe-work-q-s-t-reponse-view-student',
  templateUrl: './howe-work-q-s-t-reponse-view-student.component.html'
})
export class HoweWorkQSTReponseViewStudentComponent extends AbstractViewController<HoweWorkQSTReponseDto, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseService> implements OnInit {
