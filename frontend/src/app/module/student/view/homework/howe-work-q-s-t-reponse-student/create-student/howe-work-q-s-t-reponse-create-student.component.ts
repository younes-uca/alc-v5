...
@Component({
  selector: 'app-howe-work-q-s-t-reponse-create-student',
  templateUrl: './howe-work-q-s-t-reponse-create-student.component.html'
})
export class HoweWorkQSTReponseCreateStudentComponent extends AbstractCreateController<HoweWorkQSTReponseDto, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseService>  implements OnInit {
