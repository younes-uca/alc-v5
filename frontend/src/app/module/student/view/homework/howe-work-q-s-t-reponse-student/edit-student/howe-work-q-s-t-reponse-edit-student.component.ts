...
@Component({
  selector: 'app-howe-work-q-s-t-reponse-edit-student',
  templateUrl: './howe-work-q-s-t-reponse-edit-student.component.html'
})
export class HoweWorkQSTReponseEditStudentComponent extends AbstractEditController<HoweWorkQSTReponseDto, HoweWorkQSTReponseCriteria, HoweWorkQSTReponseService>   implements OnInit {
