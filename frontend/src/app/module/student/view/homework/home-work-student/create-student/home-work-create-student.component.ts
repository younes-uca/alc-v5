...
@Component({
  selector: 'app-home-work-create-student',
  templateUrl: './home-work-create-student.component.html'
})
export class HomeWorkCreateStudentComponent extends AbstractCreateController<HomeWorkDto, HomeWorkCriteria, HomeWorkService>  implements OnInit {
