...
@Component({
  selector: 'app-home-work-list-student',
  templateUrl: './home-work-list-student.component.html'
})
export class HomeWorkListStudentComponent extends AbstractListController<HomeWorkDto, HomeWorkCriteria, HomeWorkService>  implements OnInit {
