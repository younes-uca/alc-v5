...
@Component({
  selector: 'app-home-work-view-student',
  templateUrl: './home-work-view-student.component.html'
})
export class HomeWorkViewStudentComponent extends AbstractViewController<HomeWorkDto, HomeWorkCriteria, HomeWorkService> implements OnInit {
