...
@Component({
  selector: 'app-home-work-edit-student',
  templateUrl: './home-work-edit-student.component.html'
})
export class HomeWorkEditStudentComponent extends AbstractEditController<HomeWorkDto, HomeWorkCriteria, HomeWorkService>   implements OnInit {
