...
@Component({
  selector: 'app-home-work-question-list-student',
  templateUrl: './home-work-question-list-student.component.html'
})
export class HomeWorkQuestionListStudentComponent extends AbstractListController<HomeWorkQuestionDto, HomeWorkQuestionCriteria, HomeWorkQuestionService>  implements OnInit {
    ...
    constructor(homeWorkQuestionService: HomeWorkQuestionService, private typeDeQuestionService: TypeDeQuestionService, private homeWorkService: HomeWorkService) {
