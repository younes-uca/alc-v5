...
@Component({
  selector: 'app-home-work-question-view-student',
  templateUrl: './home-work-question-view-student.component.html'
})
export class HomeWorkQuestionViewStudentComponent extends AbstractViewController<HomeWorkQuestionDto, HomeWorkQuestionCriteria, HomeWorkQuestionService> implements OnInit {
