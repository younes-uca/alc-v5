...
@Component({
  selector: 'app-home-work-question-edit-student',
  templateUrl: './home-work-question-edit-student.component.html'
})
export class HomeWorkQuestionEditStudentComponent extends AbstractEditController<HomeWorkQuestionDto, HomeWorkQuestionCriteria, HomeWorkQuestionService>   implements OnInit {
