...
@Component({
  selector: 'app-home-work-question-create-student',
  templateUrl: './home-work-question-create-student.component.html'
})
export class HomeWorkQuestionCreateStudentComponent extends AbstractCreateController<HomeWorkQuestionDto, HomeWorkQuestionCriteria, HomeWorkQuestionService>  implements OnInit {
