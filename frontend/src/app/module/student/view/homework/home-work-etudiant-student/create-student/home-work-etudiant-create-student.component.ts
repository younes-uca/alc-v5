...
@Component({
  selector: 'app-home-work-etudiant-create-student',
  templateUrl: './home-work-etudiant-create-student.component.html'
})
export class HomeWorkEtudiantCreateStudentComponent extends AbstractCreateController<HomeWorkEtudiantDto, HomeWorkEtudiantCriteria, HomeWorkEtudiantService>  implements OnInit {
    ...
    constructor( private homeWorkEtudiantService: HomeWorkEtudiantService , private etudiantService: EtudiantService, private resultatHomeWorkService: ResultatHomeWorkService, private howeWorkQSTReponseService: HoweWorkQSTReponseService, private homeWorkQuestionService: HomeWorkQuestionService, private homeWorkService: HomeWorkService, private reponseEtudiantHomeWorkService: ReponseEtudiantHomeWorkService) {
