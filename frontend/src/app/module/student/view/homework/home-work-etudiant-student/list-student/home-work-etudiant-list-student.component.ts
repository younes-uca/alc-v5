...
@Component({
  selector: 'app-home-work-etudiant-list-student',
  templateUrl: './home-work-etudiant-list-student.component.html'
})
export class HomeWorkEtudiantListStudentComponent extends AbstractListController<HomeWorkEtudiantDto, HomeWorkEtudiantCriteria, HomeWorkEtudiantService>  implements OnInit {
