...
@Component({
  selector: 'app-home-work-etudiant-edit-student',
  templateUrl: './home-work-etudiant-edit-student.component.html'
})
export class HomeWorkEtudiantEditStudentComponent extends AbstractEditController<HomeWorkEtudiantDto, HomeWorkEtudiantCriteria, HomeWorkEtudiantService>   implements OnInit {
