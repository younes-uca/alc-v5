...
@Component({
  selector: 'app-home-work-etudiant-view-student',
  templateUrl: './home-work-etudiant-view-student.component.html'
})
export class HomeWorkEtudiantViewStudentComponent extends AbstractViewController<HomeWorkEtudiantDto, HomeWorkEtudiantCriteria, HomeWorkEtudiantService> implements OnInit {
