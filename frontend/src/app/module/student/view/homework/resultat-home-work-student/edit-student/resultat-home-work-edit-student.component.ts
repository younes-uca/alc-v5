...
@Component({
  selector: 'app-resultat-home-work-edit-student',
  templateUrl: './resultat-home-work-edit-student.component.html'
})
export class ResultatHomeWorkEditStudentComponent extends AbstractEditController<ResultatHomeWorkDto, ResultatHomeWorkCriteria, ResultatHomeWorkService>   implements OnInit {
