...
@Component({
  selector: 'app-resultat-home-work-list-student',
  templateUrl: './resultat-home-work-list-student.component.html'
})
export class ResultatHomeWorkListStudentComponent extends AbstractListController<ResultatHomeWorkDto, ResultatHomeWorkCriteria, ResultatHomeWorkService>  implements OnInit {
