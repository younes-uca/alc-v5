...
@Component({
  selector: 'app-resultat-home-work-create-student',
  templateUrl: './resultat-home-work-create-student.component.html'
})
export class ResultatHomeWorkCreateStudentComponent extends AbstractCreateController<ResultatHomeWorkDto, ResultatHomeWorkCriteria, ResultatHomeWorkService>  implements OnInit {
