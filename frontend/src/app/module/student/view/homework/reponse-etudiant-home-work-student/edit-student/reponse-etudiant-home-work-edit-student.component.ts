...
@Component({
  selector: 'app-reponse-etudiant-home-work-edit-student',
  templateUrl: './reponse-etudiant-home-work-edit-student.component.html'
})
export class ReponseEtudiantHomeWorkEditStudentComponent extends AbstractEditController<ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkService>   implements OnInit {
