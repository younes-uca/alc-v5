...
@Component({
  selector: 'app-reponse-etudiant-home-work-list-student',
  templateUrl: './reponse-etudiant-home-work-list-student.component.html'
})
export class ReponseEtudiantHomeWorkListStudentComponent extends AbstractListController<ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkService>  implements OnInit {
    ...
    constructor(reponseEtudiantHomeWorkService: ReponseEtudiantHomeWorkService, private howeWorkQSTReponseService: HoweWorkQSTReponseService, private homeWorkEtudiantService: HomeWorkEtudiantService, private homeWorkQuestionService: HomeWorkQuestionService) {
