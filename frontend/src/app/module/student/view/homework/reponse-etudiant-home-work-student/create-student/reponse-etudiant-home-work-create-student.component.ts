...
@Component({
  selector: 'app-reponse-etudiant-home-work-create-student',
  templateUrl: './reponse-etudiant-home-work-create-student.component.html'
})
export class ReponseEtudiantHomeWorkCreateStudentComponent extends AbstractCreateController<ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkService>  implements OnInit {
