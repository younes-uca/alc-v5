...
@Component({
  selector: 'app-reponse-etudiant-home-work-view-student',
  templateUrl: './reponse-etudiant-home-work-view-student.component.html'
})
export class ReponseEtudiantHomeWorkViewStudentComponent extends AbstractViewController<ReponseEtudiantHomeWorkDto, ReponseEtudiantHomeWorkCriteria, ReponseEtudiantHomeWorkService> implements OnInit {
