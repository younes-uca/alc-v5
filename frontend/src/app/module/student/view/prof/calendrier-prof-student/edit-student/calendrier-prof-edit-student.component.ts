...
@Component({
  selector: 'app-calendrier-prof-edit-student',
  templateUrl: './calendrier-prof-edit-student.component.html'
})
export class CalendrierProfEditStudentComponent extends AbstractEditController<CalendrierProfDto, CalendrierProfCriteria, CalendrierProfService>   implements OnInit {
