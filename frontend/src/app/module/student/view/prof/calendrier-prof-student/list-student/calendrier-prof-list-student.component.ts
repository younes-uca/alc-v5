...
@Component({
  selector: 'app-calendrier-prof-list-student',
  templateUrl: './calendrier-prof-list-student.component.html'
})
export class CalendrierProfListStudentComponent extends AbstractListController<CalendrierProfDto, CalendrierProfCriteria, CalendrierProfService>  implements OnInit {
