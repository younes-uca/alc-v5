...
@Component({
  selector: 'app-calendrier-prof-view-student',
  templateUrl: './calendrier-prof-view-student.component.html'
})
export class CalendrierProfViewStudentComponent extends AbstractViewController<CalendrierProfDto, CalendrierProfCriteria, CalendrierProfService> implements OnInit {
