...
@Component({
  selector: 'app-calendrier-prof-create-student',
  templateUrl: './calendrier-prof-create-student.component.html'
})
export class CalendrierProfCreateStudentComponent extends AbstractCreateController<CalendrierProfDto, CalendrierProfCriteria, CalendrierProfService>  implements OnInit {
