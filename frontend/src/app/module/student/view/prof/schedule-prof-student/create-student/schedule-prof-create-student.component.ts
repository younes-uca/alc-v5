...
@Component({
  selector: 'app-schedule-prof-create-student',
  templateUrl: './schedule-prof-create-student.component.html'
})
export class ScheduleProfCreateStudentComponent extends AbstractCreateController<ScheduleProfDto, ScheduleProfCriteria, ScheduleProfService>  implements OnInit {
