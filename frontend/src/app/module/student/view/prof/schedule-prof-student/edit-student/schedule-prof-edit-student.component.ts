...
@Component({
  selector: 'app-schedule-prof-edit-student',
  templateUrl: './schedule-prof-edit-student.component.html'
})
export class ScheduleProfEditStudentComponent extends AbstractEditController<ScheduleProfDto, ScheduleProfCriteria, ScheduleProfService>   implements OnInit {
