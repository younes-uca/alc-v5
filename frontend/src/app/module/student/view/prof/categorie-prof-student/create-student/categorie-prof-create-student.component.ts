...
@Component({
  selector: 'app-categorie-prof-create-student',
  templateUrl: './categorie-prof-create-student.component.html'
})
export class CategorieProfCreateStudentComponent extends AbstractCreateController<CategorieProfDto, CategorieProfCriteria, CategorieProfService>  implements OnInit {
