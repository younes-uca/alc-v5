...
@Component({
  selector: 'app-categorie-prof-view-student',
  templateUrl: './categorie-prof-view-student.component.html'
})
export class CategorieProfViewStudentComponent extends AbstractViewController<CategorieProfDto, CategorieProfCriteria, CategorieProfService> implements OnInit {
