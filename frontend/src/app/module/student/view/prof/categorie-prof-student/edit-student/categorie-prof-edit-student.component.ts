...
@Component({
  selector: 'app-categorie-prof-edit-student',
  templateUrl: './categorie-prof-edit-student.component.html'
})
export class CategorieProfEditStudentComponent extends AbstractEditController<CategorieProfDto, CategorieProfCriteria, CategorieProfService>   implements OnInit {
