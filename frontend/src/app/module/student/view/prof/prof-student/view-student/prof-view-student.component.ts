...
@Component({
  selector: 'app-prof-view-student',
  templateUrl: './prof-view-student.component.html'
})
export class ProfViewStudentComponent extends AbstractViewController<ProfDto, ProfCriteria, ProfService> implements OnInit {
