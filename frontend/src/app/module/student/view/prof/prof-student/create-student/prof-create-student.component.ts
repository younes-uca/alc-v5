...
@Component({
  selector: 'app-prof-create-student',
  templateUrl: './prof-create-student.component.html'
})
export class ProfCreateStudentComponent extends AbstractCreateController<ProfDto, ProfCriteria, ProfService>  implements OnInit {
