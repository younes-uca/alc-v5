...
@Component({
  selector: 'app-prof-list-student',
  templateUrl: './prof-list-student.component.html'
})
export class ProfListStudentComponent extends AbstractListController<ProfDto, ProfCriteria, ProfService>  implements OnInit {
