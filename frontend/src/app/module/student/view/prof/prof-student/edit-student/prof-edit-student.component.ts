...
@Component({
  selector: 'app-prof-edit-student',
  templateUrl: './prof-edit-student.component.html'
})
export class ProfEditStudentComponent extends AbstractEditController<ProfDto, ProfCriteria, ProfService>   implements OnInit {
