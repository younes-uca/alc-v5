...
@Component({
  selector: 'app-class-average-bonus-prof-edit-student',
  templateUrl: './class-average-bonus-prof-edit-student.component.html'
})
export class ClassAverageBonusProfEditStudentComponent extends AbstractEditController<ClassAverageBonusProfDto, ClassAverageBonusProfCriteria, ClassAverageBonusProfService>   implements OnInit {
