...
@Component({
  selector: 'app-class-average-bonus-prof-create-student',
  templateUrl: './class-average-bonus-prof-create-student.component.html'
})
export class ClassAverageBonusProfCreateStudentComponent extends AbstractCreateController<ClassAverageBonusProfDto, ClassAverageBonusProfCriteria, ClassAverageBonusProfService>  implements OnInit {
