...
@Component({
  selector: 'app-type-teacher-create-student',
  templateUrl: './type-teacher-create-student.component.html'
})
export class TypeTeacherCreateStudentComponent extends AbstractCreateController<TypeTeacherDto, TypeTeacherCriteria, TypeTeacherService>  implements OnInit {
