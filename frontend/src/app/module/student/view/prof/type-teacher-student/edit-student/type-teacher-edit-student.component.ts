...
@Component({
  selector: 'app-type-teacher-edit-student',
  templateUrl: './type-teacher-edit-student.component.html'
})
export class TypeTeacherEditStudentComponent extends AbstractEditController<TypeTeacherDto, TypeTeacherCriteria, TypeTeacherService>   implements OnInit {
