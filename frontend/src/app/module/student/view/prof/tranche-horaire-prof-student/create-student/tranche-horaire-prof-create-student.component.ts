...
@Component({
  selector: 'app-tranche-horaire-prof-create-student',
  templateUrl: './tranche-horaire-prof-create-student.component.html'
})
export class TrancheHoraireProfCreateStudentComponent extends AbstractCreateController<TrancheHoraireProfDto, TrancheHoraireProfCriteria, TrancheHoraireProfService>  implements OnInit {
