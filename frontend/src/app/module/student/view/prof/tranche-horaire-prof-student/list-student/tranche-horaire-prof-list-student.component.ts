...
@Component({
  selector: 'app-tranche-horaire-prof-list-student',
  templateUrl: './tranche-horaire-prof-list-student.component.html'
})
export class TrancheHoraireProfListStudentComponent extends AbstractListController<TrancheHoraireProfDto, TrancheHoraireProfCriteria, TrancheHoraireProfService>  implements OnInit {

    fileName = 'TrancheHoraireProf';

    profs :Array<ProfDto>;
  
    constructor(trancheHoraireProfService: TrancheHoraireProfService, private profService: ProfService) {
