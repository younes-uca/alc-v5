...
@Component({
  selector: 'app-tranche-horaire-prof-edit-student',
  templateUrl: './tranche-horaire-prof-edit-student.component.html'
})
export class TrancheHoraireProfEditStudentComponent extends AbstractEditController<TrancheHoraireProfDto, TrancheHoraireProfCriteria, TrancheHoraireProfService>   implements OnInit {
