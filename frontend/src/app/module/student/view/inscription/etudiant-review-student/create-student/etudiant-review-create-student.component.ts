...
@Component({
  selector: 'app-etudiant-review-create-student',
  templateUrl: './etudiant-review-create-student.component.html'
})
export class EtudiantReviewCreateStudentComponent extends AbstractCreateController<EtudiantReviewDto, EtudiantReviewCriteria, EtudiantReviewService>  implements OnInit {
    ...
    constructor( private etudiantReviewService: EtudiantReviewService , private etudiantService: EtudiantService, private coursService: CoursService, private profService: ProfService) {
