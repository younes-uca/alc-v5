...
@Component({
  selector: 'app-etudiant-review-view-student',
  templateUrl: './etudiant-review-view-student.component.html'
})
export class EtudiantReviewViewStudentComponent extends AbstractViewController<EtudiantReviewDto, EtudiantReviewCriteria, EtudiantReviewService> implements OnInit {
