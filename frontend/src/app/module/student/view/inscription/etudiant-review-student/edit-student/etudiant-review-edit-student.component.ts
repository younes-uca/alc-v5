...
@Component({
  selector: 'app-etudiant-review-edit-student',
  templateUrl: './etudiant-review-edit-student.component.html'
})
export class EtudiantReviewEditStudentComponent extends AbstractEditController<EtudiantReviewDto, EtudiantReviewCriteria, EtudiantReviewService>   implements OnInit {
