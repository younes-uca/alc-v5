...
@Component({
  selector: 'app-etudiant-review-list-student',
  templateUrl: './etudiant-review-list-student.component.html'
})
export class EtudiantReviewListStudentComponent extends AbstractListController<EtudiantReviewDto, EtudiantReviewCriteria, EtudiantReviewService>  implements OnInit {
