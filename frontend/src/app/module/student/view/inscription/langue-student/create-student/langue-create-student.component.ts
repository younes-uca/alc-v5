...
@Component({
  selector: 'app-langue-create-student',
  templateUrl: './langue-create-student.component.html'
})
export class LangueCreateStudentComponent extends AbstractCreateController<LangueDto, LangueCriteria, LangueService>  implements OnInit {
