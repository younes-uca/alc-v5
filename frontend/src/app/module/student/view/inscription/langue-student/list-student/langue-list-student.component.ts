...
@Component({
  selector: 'app-langue-list-student',
  templateUrl: './langue-list-student.component.html'
})
export class LangueListStudentComponent extends AbstractListController<LangueDto, LangueCriteria, LangueService>  implements OnInit {
