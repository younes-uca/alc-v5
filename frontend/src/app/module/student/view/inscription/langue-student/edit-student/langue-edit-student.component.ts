...
@Component({
  selector: 'app-langue-edit-student',
  templateUrl: './langue-edit-student.component.html'
})
export class LangueEditStudentComponent extends AbstractEditController<LangueDto, LangueCriteria, LangueService>   implements OnInit {
