...
@Component({
  selector: 'app-skill-list-student',
  templateUrl: './skill-list-student.component.html'
})
export class SkillListStudentComponent extends AbstractListController<SkillDto, SkillCriteria, SkillService>  implements OnInit {
