...
@Component({
  selector: 'app-skill-create-student',
  templateUrl: './skill-create-student.component.html'
})
export class SkillCreateStudentComponent extends AbstractCreateController<SkillDto, SkillCriteria, SkillService>  implements OnInit {
