...
@Component({
  selector: 'app-fonction-list-student',
  templateUrl: './fonction-list-student.component.html'
})
export class FonctionListStudentComponent extends AbstractListController<FonctionDto, FonctionCriteria, FonctionService>  implements OnInit {
