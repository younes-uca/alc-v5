...
@Component({
  selector: 'app-fonction-edit-student',
  templateUrl: './fonction-edit-student.component.html'
})
export class FonctionEditStudentComponent extends AbstractEditController<FonctionDto, FonctionCriteria, FonctionService>   implements OnInit {
