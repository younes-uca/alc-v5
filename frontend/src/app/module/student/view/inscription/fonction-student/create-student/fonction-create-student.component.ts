...
@Component({
  selector: 'app-fonction-create-student',
  templateUrl: './fonction-create-student.component.html'
})
export class FonctionCreateStudentComponent extends AbstractCreateController<FonctionDto, FonctionCriteria, FonctionService>  implements OnInit {
