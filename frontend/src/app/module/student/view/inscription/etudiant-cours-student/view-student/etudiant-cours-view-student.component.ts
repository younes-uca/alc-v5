...
@Component({
  selector: 'app-etudiant-cours-view-student',
  templateUrl: './etudiant-cours-view-student.component.html'
})
export class EtudiantCoursViewStudentComponent extends AbstractViewController<EtudiantCoursDto, EtudiantCoursCriteria, EtudiantCoursService> implements OnInit {
