...
@Component({
  selector: 'app-etudiant-cours-edit-student',
  templateUrl: './etudiant-cours-edit-student.component.html'
})
export class EtudiantCoursEditStudentComponent extends AbstractEditController<EtudiantCoursDto, EtudiantCoursCriteria, EtudiantCoursService>   implements OnInit {
