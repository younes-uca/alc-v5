...
@Component({
  selector: 'app-etudiant-cours-create-student',
  templateUrl: './etudiant-cours-create-student.component.html'
})
export class EtudiantCoursCreateStudentComponent extends AbstractCreateController<EtudiantCoursDto, EtudiantCoursCriteria, EtudiantCoursService>  implements OnInit {
    ...
    constructor( private etudiantCoursService: EtudiantCoursService , private etudiantService: EtudiantService, private coursService: CoursService, private profService: ProfService) {
