...
@Component({
  selector: 'app-groupe-etude-create-student',
  templateUrl: './groupe-etude-create-student.component.html'
})
export class GroupeEtudeCreateStudentComponent extends AbstractCreateController<GroupeEtudeDto, GroupeEtudeCriteria, GroupeEtudeService>  implements OnInit {
