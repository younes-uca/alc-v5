...
@Component({
  selector: 'app-groupe-etude-list-student',
  templateUrl: './groupe-etude-list-student.component.html'
})
export class GroupeEtudeListStudentComponent extends AbstractListController<GroupeEtudeDto, GroupeEtudeCriteria, GroupeEtudeService>  implements OnInit {
