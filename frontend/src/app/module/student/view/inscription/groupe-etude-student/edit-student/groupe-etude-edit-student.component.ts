...
@Component({
  selector: 'app-groupe-etude-edit-student',
  templateUrl: './groupe-etude-edit-student.component.html'
})
export class GroupeEtudeEditStudentComponent extends AbstractEditController<GroupeEtudeDto, GroupeEtudeCriteria, GroupeEtudeService>   implements OnInit {
