...
@Component({
  selector: 'app-inscription-list-student',
  templateUrl: './inscription-list-student.component.html'
})
export class InscriptionListStudentComponent extends AbstractListController<InscriptionDto, InscriptionCriteria, InscriptionService>  implements OnInit {
