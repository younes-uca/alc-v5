...
@Component({
  selector: 'app-inscription-create-student',
  templateUrl: './inscription-create-student.component.html'
})
export class InscriptionCreateStudentComponent extends AbstractCreateController<InscriptionDto, InscriptionCriteria, InscriptionService>  implements OnInit {
