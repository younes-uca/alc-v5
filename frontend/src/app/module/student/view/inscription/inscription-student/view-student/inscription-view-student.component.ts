...
@Component({
  selector: 'app-inscription-view-student',
  templateUrl: './inscription-view-student.component.html'
})
export class InscriptionViewStudentComponent extends AbstractViewController<InscriptionDto, InscriptionCriteria, InscriptionService> implements OnInit {
