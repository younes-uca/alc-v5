...
@Component({
  selector: 'app-niveau-etude-list-student',
  templateUrl: './niveau-etude-list-student.component.html'
})
export class NiveauEtudeListStudentComponent extends AbstractListController<NiveauEtudeDto, NiveauEtudeCriteria, NiveauEtudeService>  implements OnInit {
