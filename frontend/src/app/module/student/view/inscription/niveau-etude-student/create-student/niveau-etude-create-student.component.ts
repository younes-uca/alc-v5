...
@Component({
  selector: 'app-niveau-etude-create-student',
  templateUrl: './niveau-etude-create-student.component.html'
})
export class NiveauEtudeCreateStudentComponent extends AbstractCreateController<NiveauEtudeDto, NiveauEtudeCriteria, NiveauEtudeService>  implements OnInit {
