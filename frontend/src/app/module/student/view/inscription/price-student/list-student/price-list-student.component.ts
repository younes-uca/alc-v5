...
@Component({
  selector: 'app-price-list-student',
  templateUrl: './price-list-student.component.html'
})
export class PriceListStudentComponent extends AbstractListController<PriceDto, PriceCriteria, PriceService>  implements OnInit {
