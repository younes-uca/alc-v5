...
@Component({
  selector: 'app-etat-etudiant-schedule-list-student',
  templateUrl: './etat-etudiant-schedule-list-student.component.html'
})
export class EtatEtudiantScheduleListStudentComponent extends AbstractListController<EtatEtudiantScheduleDto, EtatEtudiantScheduleCriteria, EtatEtudiantScheduleService>  implements OnInit {
