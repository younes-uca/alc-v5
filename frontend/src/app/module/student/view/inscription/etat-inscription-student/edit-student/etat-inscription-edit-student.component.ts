...
@Component({
  selector: 'app-etat-inscription-edit-student',
  templateUrl: './etat-inscription-edit-student.component.html'
})
export class EtatInscriptionEditStudentComponent extends AbstractEditController<EtatInscriptionDto, EtatInscriptionCriteria, EtatInscriptionService>   implements OnInit {
