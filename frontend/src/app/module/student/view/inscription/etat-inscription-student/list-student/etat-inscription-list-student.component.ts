...
@Component({
  selector: 'app-etat-inscription-list-student',
  templateUrl: './etat-inscription-list-student.component.html'
})
export class EtatInscriptionListStudentComponent extends AbstractListController<EtatInscriptionDto, EtatInscriptionCriteria, EtatInscriptionService>  implements OnInit {
