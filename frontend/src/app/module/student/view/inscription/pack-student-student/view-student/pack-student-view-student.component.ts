...
@Component({
  selector: 'app-pack-student-view-student',
  templateUrl: './pack-student-view-student.component.html'
})
export class PackStudentViewStudentComponent extends AbstractViewController<PackStudentDto, PackStudentCriteria, PackStudentService> implements OnInit {
