...
@Component({
  selector: 'app-pack-student-edit-student',
  templateUrl: './pack-student-edit-student.component.html'
})
export class PackStudentEditStudentComponent extends AbstractEditController<PackStudentDto, PackStudentCriteria, PackStudentService>   implements OnInit {
