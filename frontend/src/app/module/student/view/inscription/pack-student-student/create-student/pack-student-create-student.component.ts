...
@Component({
  selector: 'app-pack-student-create-student',
  templateUrl: './pack-student-create-student.component.html'
})
export class PackStudentCreateStudentComponent extends AbstractCreateController<PackStudentDto, PackStudentCriteria, PackStudentService>  implements OnInit {
   ...
   private _validPackStudentLibelle = true;
    ...
    const isPermistted = await this.roleService.isPermitted('Price', 'add');
    if(isPermistted) {
         this.price = new PriceDto();
