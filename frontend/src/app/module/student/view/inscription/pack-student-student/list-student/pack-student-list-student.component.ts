...
@Component({
  selector: 'app-pack-student-list-student',
  templateUrl: './pack-student-list-student.component.html'
})
export class PackStudentListStudentComponent extends AbstractListController<PackStudentDto, PackStudentCriteria, PackStudentService>  implements OnInit {
