...
@Component({
  selector: 'app-statut-social-create-student',
  templateUrl: './statut-social-create-student.component.html'
})
export class StatutSocialCreateStudentComponent extends AbstractCreateController<StatutSocialDto, StatutSocialCriteria, StatutSocialService>  implements OnInit {
