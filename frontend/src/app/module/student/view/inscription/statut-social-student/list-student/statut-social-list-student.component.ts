...
@Component({
  selector: 'app-statut-social-list-student',
  templateUrl: './statut-social-list-student.component.html'
})
export class StatutSocialListStudentComponent extends AbstractListController<StatutSocialDto, StatutSocialCriteria, StatutSocialService>  implements OnInit {
