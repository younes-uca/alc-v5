...
@Component({
  selector: 'app-statut-social-view-student',
  templateUrl: './statut-social-view-student.component.html'
})
export class StatutSocialViewStudentComponent extends AbstractViewController<StatutSocialDto, StatutSocialCriteria, StatutSocialService> implements OnInit {
