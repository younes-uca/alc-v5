...
@Component({
  selector: 'app-teacher-locality-edit-student',
  templateUrl: './teacher-locality-edit-student.component.html'
})
export class TeacherLocalityEditStudentComponent extends AbstractEditController<TeacherLocalityDto, TeacherLocalityCriteria, TeacherLocalityService>   implements OnInit {
