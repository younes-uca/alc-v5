...
@Component({
  selector: 'app-teacher-locality-list-student',
  templateUrl: './teacher-locality-list-student.component.html'
})
export class TeacherLocalityListStudentComponent extends AbstractListController<TeacherLocalityDto, TeacherLocalityCriteria, TeacherLocalityService>  implements OnInit {
