...
@Component({
  selector: 'app-prof-review-view-student',
  templateUrl: './prof-review-view-student.component.html'
})
export class ProfReviewViewStudentComponent extends AbstractViewController<ProfReviewDto, ProfReviewCriteria, ProfReviewService> implements OnInit {
