...
@Component({
  selector: 'app-prof-review-list-student',
  templateUrl: './prof-review-list-student.component.html'
})
export class ProfReviewListStudentComponent extends AbstractListController<ProfReviewDto, ProfReviewCriteria, ProfReviewService>  implements OnInit {
    ...
    constructor(profReviewService: ProfReviewService, private etudiantService: EtudiantService, private profService: ProfService, private coursService: CoursService) {
