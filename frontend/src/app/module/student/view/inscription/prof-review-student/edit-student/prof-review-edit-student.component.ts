...
@Component({
  selector: 'app-prof-review-edit-student',
  templateUrl: './prof-review-edit-student.component.html'
})
export class ProfReviewEditStudentComponent extends AbstractEditController<ProfReviewDto, ProfReviewCriteria, ProfReviewService>   implements OnInit {
