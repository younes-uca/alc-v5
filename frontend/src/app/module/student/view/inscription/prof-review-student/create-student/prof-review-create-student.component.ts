...
@Component({
  selector: 'app-prof-review-create-student',
  templateUrl: './prof-review-create-student.component.html'
})
export class ProfReviewCreateStudentComponent extends AbstractCreateController<ProfReviewDto, ProfReviewCriteria, ProfReviewService>  implements OnInit {
