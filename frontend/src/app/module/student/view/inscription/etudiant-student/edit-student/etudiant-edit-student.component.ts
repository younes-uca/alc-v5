...
@Component({
  selector: 'app-etudiant-edit-student',
  templateUrl: './etudiant-edit-student.component.html'
})
export class EtudiantEditStudentComponent extends AbstractEditController<EtudiantDto, EtudiantCriteria, EtudiantService>   implements OnInit {
