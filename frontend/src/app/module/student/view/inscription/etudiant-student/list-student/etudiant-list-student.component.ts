...
@Component({
  selector: 'app-etudiant-list-student',
  templateUrl: './etudiant-list-student.component.html'
})
export class EtudiantListStudentComponent extends AbstractListController<EtudiantDto, EtudiantCriteria, EtudiantService>  implements OnInit {
