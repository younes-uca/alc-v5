...
@Component({
  selector: 'app-etudiant-create-student',
  templateUrl: './etudiant-create-student.component.html'
})
export class EtudiantCreateStudentComponent extends AbstractCreateController<EtudiantDto, EtudiantCriteria, EtudiantService>  implements OnInit {
