...
@Component({
  selector: 'app-etudiant-view-student',
  templateUrl: './etudiant-view-student.component.html'
})
export class EtudiantViewStudentComponent extends AbstractViewController<EtudiantDto, EtudiantCriteria, EtudiantService> implements OnInit {
