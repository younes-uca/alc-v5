...
@Component({
  selector: 'app-etat-etudiant-edit-student',
  templateUrl: './etat-etudiant-edit-student.component.html'
})
export class EtatEtudiantEditStudentComponent extends AbstractEditController<EtatEtudiantDto, EtatEtudiantCriteria, EtatEtudiantService>   implements OnInit {
