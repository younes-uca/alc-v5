...
@Component({
  selector: 'app-etat-etudiant-list-student',
  templateUrl: './etat-etudiant-list-student.component.html'
})
export class EtatEtudiantListStudentComponent extends AbstractListController<EtatEtudiantDto, EtatEtudiantCriteria, EtatEtudiantService>  implements OnInit {

    fileName = 'EtatEtudiant';

  
    constructor(etatEtudiantService: EtatEtudiantService) {
