...
@Component({
  selector: 'app-invite-student-create-student',
  templateUrl: './invite-student-create-student.component.html'
})
export class InviteStudentCreateStudentComponent extends AbstractCreateController<InviteStudentDto, InviteStudentCriteria, InviteStudentService>  implements OnInit {
