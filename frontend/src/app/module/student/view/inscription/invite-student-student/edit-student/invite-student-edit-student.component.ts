...
@Component({
  selector: 'app-invite-student-edit-student',
  templateUrl: './invite-student-edit-student.component.html'
})
export class InviteStudentEditStudentComponent extends AbstractEditController<InviteStudentDto, InviteStudentCriteria, InviteStudentService>   implements OnInit {
