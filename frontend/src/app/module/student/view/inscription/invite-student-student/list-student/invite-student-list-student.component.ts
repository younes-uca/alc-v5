...
@Component({
  selector: 'app-invite-student-list-student',
  templateUrl: './invite-student-list-student.component.html'
})
export class InviteStudentListStudentComponent extends AbstractListController<InviteStudentDto, InviteStudentCriteria, InviteStudentService>  implements OnInit {
    ...
    constructor(inviteStudentService: InviteStudentService, private etudiantService: EtudiantService) {
