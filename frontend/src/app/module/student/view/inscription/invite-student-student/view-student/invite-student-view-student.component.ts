...
@Component({
  selector: 'app-invite-student-view-student',
  templateUrl: './invite-student-view-student.component.html'
})
export class InviteStudentViewStudentComponent extends AbstractViewController<InviteStudentDto, InviteStudentCriteria, InviteStudentService> implements OnInit {
