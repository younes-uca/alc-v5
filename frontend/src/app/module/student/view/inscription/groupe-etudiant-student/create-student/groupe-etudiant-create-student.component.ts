...
@Component({
  selector: 'app-groupe-etudiant-create-student',
  templateUrl: './groupe-etudiant-create-student.component.html'
})
export class GroupeEtudiantCreateStudentComponent extends AbstractCreateController<GroupeEtudiantDto, GroupeEtudiantCriteria, GroupeEtudiantService>  implements OnInit {
