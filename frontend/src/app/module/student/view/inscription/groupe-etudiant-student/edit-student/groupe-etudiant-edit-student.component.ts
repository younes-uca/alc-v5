...
@Component({
  selector: 'app-groupe-etudiant-edit-student',
  templateUrl: './groupe-etudiant-edit-student.component.html'
})
export class GroupeEtudiantEditStudentComponent extends AbstractEditController<GroupeEtudiantDto, GroupeEtudiantCriteria, GroupeEtudiantService>   implements OnInit {
