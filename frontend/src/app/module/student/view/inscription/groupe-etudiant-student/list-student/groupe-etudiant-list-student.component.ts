...
@Component({
  selector: 'app-groupe-etudiant-list-student',
  templateUrl: './groupe-etudiant-list-student.component.html'
})
export class GroupeEtudiantListStudentComponent extends AbstractListController<GroupeEtudiantDto, GroupeEtudiantCriteria, GroupeEtudiantService>  implements OnInit {
    ...
    constructor(groupeEtudiantService: GroupeEtudiantService, private groupeEtudeService: GroupeEtudeService, private parcoursService: ParcoursService, private profService: ProfService) {
