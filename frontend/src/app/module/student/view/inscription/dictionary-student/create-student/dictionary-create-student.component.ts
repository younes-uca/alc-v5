...
@Component({
  selector: 'app-dictionary-create-student',
  templateUrl: './dictionary-create-student.component.html'
})
export class DictionaryCreateStudentComponent extends AbstractCreateController<DictionaryDto, DictionaryCriteria, DictionaryService>  implements OnInit {
