...
@Component({
  selector: 'app-dictionary-list-student',
  templateUrl: './dictionary-list-student.component.html'
})
export class DictionaryListStudentComponent extends AbstractListController<DictionaryDto, DictionaryCriteria, DictionaryService>  implements OnInit {
