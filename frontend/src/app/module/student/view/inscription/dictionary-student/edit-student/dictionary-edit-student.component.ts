...
@Component({
  selector: 'app-dictionary-edit-student',
  templateUrl: './dictionary-edit-student.component.html'
})
export class DictionaryEditStudentComponent extends AbstractEditController<DictionaryDto, DictionaryCriteria, DictionaryService>   implements OnInit {
