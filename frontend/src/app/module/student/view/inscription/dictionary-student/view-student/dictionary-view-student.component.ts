...
@Component({
  selector: 'app-dictionary-view-student',
  templateUrl: './dictionary-view-student.component.html'
})
export class DictionaryViewStudentComponent extends AbstractViewController<DictionaryDto, DictionaryCriteria, DictionaryService> implements OnInit {
