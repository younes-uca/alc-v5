...
@Component({
  selector: 'app-interet-etudiant-list-student',
  templateUrl: './interet-etudiant-list-student.component.html'
})
export class InteretEtudiantListStudentComponent extends AbstractListController<InteretEtudiantDto, InteretEtudiantCriteria, InteretEtudiantService>  implements OnInit {
