...
@Component({
  selector: 'app-confirmation-token-view-student',
  templateUrl: './confirmation-token-view-student.component.html'
})
export class ConfirmationTokenViewStudentComponent extends AbstractViewController<ConfirmationTokenDto, ConfirmationTokenCriteria, ConfirmationTokenService> implements OnInit {
