...
@Component({
  selector: 'app-confirmation-token-list-student',
  templateUrl: './confirmation-token-list-student.component.html'
})
export class ConfirmationTokenListStudentComponent extends AbstractListController<ConfirmationTokenDto, ConfirmationTokenCriteria, ConfirmationTokenService>  implements OnInit {
