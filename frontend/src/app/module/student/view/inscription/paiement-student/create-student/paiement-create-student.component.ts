...
@Component({
  selector: 'app-paiement-create-student',
  templateUrl: './paiement-create-student.component.html'
})
export class PaiementCreateStudentComponent extends AbstractCreateController<PaiementDto, PaiementCriteria, PaiementService>  implements OnInit {
