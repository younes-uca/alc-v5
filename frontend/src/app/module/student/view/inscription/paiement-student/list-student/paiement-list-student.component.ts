...
@Component({
  selector: 'app-paiement-list-student',
  templateUrl: './paiement-list-student.component.html'
})
export class PaiementListStudentComponent extends AbstractListController<PaiementDto, PaiementCriteria, PaiementService>  implements OnInit {
    ...
    constructor(paiementService: PaiementService, private profService: ProfService, private groupeEtudiantService: GroupeEtudiantService) {
