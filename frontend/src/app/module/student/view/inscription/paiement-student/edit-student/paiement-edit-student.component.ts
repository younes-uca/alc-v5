...
@Component({
  selector: 'app-paiement-edit-student',
  templateUrl: './paiement-edit-student.component.html'
})
export class PaiementEditStudentComponent extends AbstractEditController<PaiementDto, PaiementCriteria, PaiementService>   implements OnInit {
