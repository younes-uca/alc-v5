...
@Component({
  selector: 'app-salary-list-student',
  templateUrl: './salary-list-student.component.html'
})
export class SalaryListStudentComponent extends AbstractListController<SalaryDto, SalaryCriteria, SalaryService>  implements OnInit {
