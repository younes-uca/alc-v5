...
@Component({
  selector: 'app-salary-create-student',
  templateUrl: './salary-create-student.component.html'
})
export class SalaryCreateStudentComponent extends AbstractCreateController<SalaryDto, SalaryCriteria, SalaryService>  implements OnInit {
