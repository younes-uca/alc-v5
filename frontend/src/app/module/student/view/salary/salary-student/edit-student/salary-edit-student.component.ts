...
@Component({
  selector: 'app-salary-edit-student',
  templateUrl: './salary-edit-student.component.html'
})
export class SalaryEditStudentComponent extends AbstractEditController<SalaryDto, SalaryCriteria, SalaryService>   implements OnInit {
