...
@Component({
  selector: 'app-salary-view-student',
  templateUrl: './salary-view-student.component.html'
})
export class SalaryViewStudentComponent extends AbstractViewController<SalaryDto, SalaryCriteria, SalaryService> implements OnInit {
