...
@Component({
  selector: 'app-workload-bonus-prof-edit-student',
  templateUrl: './workload-bonus-prof-edit-student.component.html'
})
export class WorkloadBonusProfEditStudentComponent extends AbstractEditController<WorkloadBonusProfDto, WorkloadBonusProfCriteria, WorkloadBonusProfService>   implements OnInit {
