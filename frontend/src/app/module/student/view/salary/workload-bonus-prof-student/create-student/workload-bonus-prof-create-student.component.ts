...
@Component({
  selector: 'app-workload-bonus-prof-create-student',
  templateUrl: './workload-bonus-prof-create-student.component.html'
})
export class WorkloadBonusProfCreateStudentComponent extends AbstractCreateController<WorkloadBonusProfDto, WorkloadBonusProfCriteria, WorkloadBonusProfService>  implements OnInit {
