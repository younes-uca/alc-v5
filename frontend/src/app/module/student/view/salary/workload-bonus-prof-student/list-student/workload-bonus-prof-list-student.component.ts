...
@Component({
  selector: 'app-workload-bonus-prof-list-student',
  templateUrl: './workload-bonus-prof-list-student.component.html'
})
export class WorkloadBonusProfListStudentComponent extends AbstractListController<WorkloadBonusProfDto, WorkloadBonusProfCriteria, WorkloadBonusProfService>  implements OnInit {
