...
@Component({
  selector: 'app-workload-bonus-prof-view-student',
  templateUrl: './workload-bonus-prof-view-student.component.html'
})
export class WorkloadBonusProfViewStudentComponent extends AbstractViewController<WorkloadBonusProfDto, WorkloadBonusProfCriteria, WorkloadBonusProfService> implements OnInit {
