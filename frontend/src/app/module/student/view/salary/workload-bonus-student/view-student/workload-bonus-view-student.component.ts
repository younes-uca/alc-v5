...
@Component({
  selector: 'app-workload-bonus-view-student',
  templateUrl: './workload-bonus-view-student.component.html'
})
export class WorkloadBonusViewStudentComponent extends AbstractViewController<WorkloadBonusDto, WorkloadBonusCriteria, WorkloadBonusService> implements OnInit {
