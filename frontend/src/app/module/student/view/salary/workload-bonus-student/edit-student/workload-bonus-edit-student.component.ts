...
@Component({
  selector: 'app-workload-bonus-edit-student',
  templateUrl: './workload-bonus-edit-student.component.html'
})
export class WorkloadBonusEditStudentComponent extends AbstractEditController<WorkloadBonusDto, WorkloadBonusCriteria, WorkloadBonusService>   implements OnInit {
