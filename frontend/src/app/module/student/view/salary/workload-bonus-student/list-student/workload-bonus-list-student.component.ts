...
@Component({
  selector: 'app-workload-bonus-list-student',
  templateUrl: './workload-bonus-list-student.component.html'
})
export class WorkloadBonusListStudentComponent extends AbstractListController<WorkloadBonusDto, WorkloadBonusCriteria, WorkloadBonusService>  implements OnInit {
