...
@Component({
  selector: 'app-class-average-bonus-edit-student',
  templateUrl: './class-average-bonus-edit-student.component.html'
})
export class ClassAverageBonusEditStudentComponent extends AbstractEditController<ClassAverageBonusDto, ClassAverageBonusCriteria, ClassAverageBonusService>   implements OnInit {
