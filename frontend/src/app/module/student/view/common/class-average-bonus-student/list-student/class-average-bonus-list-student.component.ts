...
@Component({
  selector: 'app-class-average-bonus-list-student',
  templateUrl: './class-average-bonus-list-student.component.html'
})
export class ClassAverageBonusListStudentComponent extends AbstractListController<ClassAverageBonusDto, ClassAverageBonusCriteria, ClassAverageBonusService>  implements OnInit {
