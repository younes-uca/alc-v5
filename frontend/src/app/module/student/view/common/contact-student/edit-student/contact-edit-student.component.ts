...
@Component({
  selector: 'app-contact-edit-student',
  templateUrl: './contact-edit-student.component.html'
})
export class ContactEditStudentComponent extends AbstractEditController<ContactDto, ContactCriteria, ContactService>   implements OnInit {
