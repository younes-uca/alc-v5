...
@Component({
  selector: 'app-contact-list-student',
  templateUrl: './contact-list-student.component.html'
})
export class ContactListStudentComponent extends AbstractListController<ContactDto, ContactCriteria, ContactService>  implements OnInit {
