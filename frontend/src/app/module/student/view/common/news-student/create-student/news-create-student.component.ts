...
@Component({
  selector: 'app-news-create-student',
  templateUrl: './news-create-student.component.html'
})
export class NewsCreateStudentComponent extends AbstractCreateController<NewsDto, NewsCriteria, NewsService>  implements OnInit {
