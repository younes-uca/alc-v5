...
@Component({
  selector: 'app-news-list-student',
  templateUrl: './news-list-student.component.html'
})
export class NewsListStudentComponent extends AbstractListController<NewsDto, NewsCriteria, NewsService>  implements OnInit {
