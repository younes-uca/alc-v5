...
@Component({
  selector: 'app-news-edit-student',
  templateUrl: './news-edit-student.component.html'
})
export class NewsEditStudentComponent extends AbstractEditController<NewsDto, NewsCriteria, NewsService>   implements OnInit {
